...
public class Sample085{
    ...
    String retNullSample085() {
        return null;
    }

    public BufferedInputStream getInputStreamSample085() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample085() {

        String x = retNullSample085();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample085() throws IOException {
        BufferedInputStream i = getInputStreamSample085();
    ...
    public void test_finalizeSample085() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample085() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample085() {
        try {
    ...
    public native void testJNISample085();

    public boolean equals(Sample085 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample085() {
    ...
    public void testRule2Sample085() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample085(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample085 other = (Sample085) o;
        return (other.name.equals(""));
    }

    public void process_controlSample085() {
    ...
    public int test_return_finallySample085(File file) {
        try {
            file.delete();
    ...
    public void assignSample085() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample085() {
    ...
    public void missing_defaultSample085(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample085() {
        return a;
    }

    public void weakSample085() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
