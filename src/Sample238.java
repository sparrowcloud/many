...
public class Sample238 extends HttpServlet {
...
String retNullSample238() {
    return null;
}

public BufferedInputStream getInputStreamSample238() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample238() {
    
    String x = retNullSample238();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample238() throws IOException {
BufferedInputStream i = getInputStreamSample238();
...
public void test_finalizeSample238() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample238() {
System.gc();
}

public void test_direct_management_of_connectionsSample238() {
try {
...
public native void testJNISample238();

public boolean equals(Sample238 obj) { /* BUG */
return true;
}
...
public void test_arraySample238() {
...
public void testRule2Sample238() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample238(Collection<Object> c) {
...
Sample238 other = (Sample238) o;
return (other.name.equals(""));
}

public void process_controlSample238() {
...
public int test_return_finallySample238(File file) {
try {
file.delete();
...
public void assignSample238() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample238() {
...
public void missing_defaultSample238(int x) {
switch (x) {
case 0:
...
public List<String> getASample238() {
return a;
}

public void weakSample238() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
