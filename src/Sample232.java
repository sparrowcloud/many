...
public class Sample232 extends HttpServlet {
...
String retNullSample232() {
    return null;
}

public BufferedInputStream getInputStreamSample232() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample232() {
    
    String x = retNullSample232();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample232() throws IOException {
BufferedInputStream i = getInputStreamSample232();
...
public void test_finalizeSample232() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample232() {
System.gc();
}

public void test_direct_management_of_connectionsSample232() {
try {
...
public native void testJNISample232();

public boolean equals(Sample232 obj) { /* BUG */
return true;
}
...
public void test_arraySample232() {
...
public void testRule2Sample232() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample232(Collection<Object> c) {
...
Sample232 other = (Sample232) o;
return (other.name.equals(""));
}

public void process_controlSample232() {
...
public int test_return_finallySample232(File file) {
try {
file.delete();
...
public void assignSample232() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample232() {
...
public void missing_defaultSample232(int x) {
switch (x) {
case 0:
...
public List<String> getASample232() {
return a;
}

public void weakSample232() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
