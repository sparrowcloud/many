...
public class Sample298 extends HttpServlet {
...
String retNullSample298() {
    return null;
}

public BufferedInputStream getInputStreamSample298() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample298() {
    
    String x = retNullSample298();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample298() throws IOException {
BufferedInputStream i = getInputStreamSample298();
...
public void test_finalizeSample298() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample298() {
System.gc();
}

public void test_direct_management_of_connectionsSample298() {
try {
...
public native void testJNISample298();

public boolean equals(Sample298 obj) { /* BUG */
return true;
}
...
public void test_arraySample298() {
...
public void testRule2Sample298() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample298(Collection<Object> c) {
...
Sample298 other = (Sample298) o;
return (other.name.equals(""));
}

public void process_controlSample298() {
...
public int test_return_finallySample298(File file) {
try {
file.delete();
...
public void assignSample298() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample298() {
...
public void missing_defaultSample298(int x) {
switch (x) {
case 0:
...
public List<String> getASample298() {
return a;
}

public void weakSample298() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
