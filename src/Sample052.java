...
public class Sample052 extends HttpServlet {
...
String retNullSample052() {
    return null;
}

public BufferedInputStream getInputStreamSample052() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample052() {
    
    String x = retNullSample052();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample052() throws IOException {
BufferedInputStream i = getInputStreamSample052();
...
public void test_finalizeSample052() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample052() {
System.gc();
}

public void test_direct_management_of_connectionsSample052() {
try {
...
public native void testJNISample052();

public boolean equals(Sample052 obj) { /* BUG */
return true;
}
...
public void test_arraySample052() {
...
public void testRule2Sample052() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample052(Collection<Object> c) {
...
Sample052 other = (Sample052) o;
return (other.name.equals(""));
}

public void process_controlSample052() {
...
public int test_return_finallySample052(File file) {
try {
file.delete();
...
public void assignSample052() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample052() {
...
public void missing_defaultSample052(int x) {
switch (x) {
case 0:
...
public List<String> getASample052() {
return a;
}

public void weakSample052() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
