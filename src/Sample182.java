...
public class Sample182 extends HttpServlet {
...
String retNullSample182() {
    return null;
}

public BufferedInputStream getInputStreamSample182() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample182() {
    
    String x = retNullSample182();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample182() throws IOException {
BufferedInputStream i = getInputStreamSample182();
...
public void test_finalizeSample182() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample182() {
System.gc();
}

public void test_direct_management_of_connectionsSample182() {
try {
...
public native void testJNISample182();

public boolean equals(Sample182 obj) { /* BUG */
return true;
}
...
public void test_arraySample182() {
...
public void testRule2Sample182() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample182(Collection<Object> c) {
...
Sample182 other = (Sample182) o;
return (other.name.equals(""));
}

public void process_controlSample182() {
...
public int test_return_finallySample182(File file) {
try {
file.delete();
...
public void assignSample182() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample182() {
...
public void missing_defaultSample182(int x) {
switch (x) {
case 0:
...
public List<String> getASample182() {
return a;
}

public void weakSample182() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
