...
public class Sample051 extends HttpServlet {
...
String retNullSample051() {
    return null;
}

public BufferedInputStream getInputStreamSample051() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample051() {
    
    String x = retNullSample051();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample051() throws IOException {
BufferedInputStream i = getInputStreamSample051();
...
public void test_finalizeSample051() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample051() {
System.gc();
}

public void test_direct_management_of_connectionsSample051() {
try {
...
public native void testJNISample051();

public boolean equals(Sample051 obj) { /* BUG */
return true;
}
...
public void test_arraySample051() {
...
public void testRule2Sample051() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample051(Collection<Object> c) {
...
Sample051 other = (Sample051) o;
return (other.name.equals(""));
}

public void process_controlSample051() {
...
public int test_return_finallySample051(File file) {
try {
file.delete();
...
public void assignSample051() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample051() {
...
public void missing_defaultSample051(int x) {
switch (x) {
case 0:
...
public List<String> getASample051() {
return a;
}

public void weakSample051() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
