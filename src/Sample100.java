...
String retNullSample100() {
    return null;
}

public BufferedInputStream getInputStreamSample100() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample100() {
    
    String x = retNullSample100();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample100() throws IOException {
BufferedInputStream i = getInputStreamSample100();
...
public void test_finalizeSample100() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample100() {
System.gc();
}

public void test_direct_management_of_connectionsSample100() {
try {
...
public native void testJNISample100();

public boolean equals(Sample100 obj) { /* BUG */
return true;
}
...
public void test_arraySample100() {
...
public void testRule2Sample100() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample100(Collection<Object> c) {
...
Sample100 other = (Sample100) o;
return (other.name.equals(""));
}

public void process_controlSample100() {
...
public int test_return_finallySample100(File file) {
try {
file.delete();
...
public void assignSample100() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample100() {
...
public void missing_defaultSample100(int x) {
switch (x) {
case 0:
...
public List<String> getASample100() {
return a;
}

public void weakSample100() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
