...
public class Sample158 extends HttpServlet {
...
String retNullSample158() {
    return null;
}

public BufferedInputStream getInputStreamSample158() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample158() {
    
    String x = retNullSample158();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample158() throws IOException {
BufferedInputStream i = getInputStreamSample158();
...
public void test_finalizeSample158() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample158() {
System.gc();
}

public void test_direct_management_of_connectionsSample158() {
try {
...
public native void testJNISample158();

public boolean equals(Sample158 obj) { /* BUG */
return true;
}
...
public void test_arraySample158() {
...
public void testRule2Sample158() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample158(Collection<Object> c) {
...
Sample158 other = (Sample158) o;
return (other.name.equals(""));
}

public void process_controlSample158() {
...
public int test_return_finallySample158(File file) {
try {
file.delete();
...
public void assignSample158() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample158() {
...
public void missing_defaultSample158(int x) {
switch (x) {
case 0:
...
public List<String> getASample158() {
return a;
}

public void weakSample158() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
