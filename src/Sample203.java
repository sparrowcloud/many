...
public class Sample203 extends HttpServlet {
...
String retNullSample203() {
    return null;
}

public BufferedInputStream getInputStreamSample203() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample203() {
    
    String x = retNullSample203();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample203() throws IOException {
BufferedInputStream i = getInputStreamSample203();
...
public void test_finalizeSample203() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample203() {
System.gc();
}

public void test_direct_management_of_connectionsSample203() {
try {
...
public native void testJNISample203();

public boolean equals(Sample203 obj) { /* BUG */
return true;
}
...
public void test_arraySample203() {
...
public void testRule2Sample203() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample203(Collection<Object> c) {
...
Sample203 other = (Sample203) o;
return (other.name.equals(""));
}

public void process_controlSample203() {
...
public int test_return_finallySample203(File file) {
try {
file.delete();
...
public void assignSample203() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample203() {
...
public void missing_defaultSample203(int x) {
switch (x) {
case 0:
...
public List<String> getASample203() {
return a;
}

public void weakSample203() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
