...
public class Sample231 extends HttpServlet {
...
String retNullSample231() {
    return null;
}

public BufferedInputStream getInputStreamSample231() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample231() {
    
    String x = retNullSample231();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample231() throws IOException {
BufferedInputStream i = getInputStreamSample231();
...
public void test_finalizeSample231() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample231() {
System.gc();
}

public void test_direct_management_of_connectionsSample231() {
try {
...
public native void testJNISample231();

public boolean equals(Sample231 obj) { /* BUG */
return true;
}
...
public void test_arraySample231() {
...
public void testRule2Sample231() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample231(Collection<Object> c) {
...
Sample231 other = (Sample231) o;
return (other.name.equals(""));
}

public void process_controlSample231() {
...
public int test_return_finallySample231(File file) {
try {
file.delete();
...
public void assignSample231() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample231() {
...
public void missing_defaultSample231(int x) {
switch (x) {
case 0:
...
public List<String> getASample231() {
return a;
}

public void weakSample231() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
