...
String retNullSample128() {
    return null;
}

public BufferedInputStream getInputStreamSample128() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample128() {
    
    String x = retNullSample128();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample128() throws IOException {
BufferedInputStream i = getInputStreamSample128();
...
public void test_finalizeSample128() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample128() {
System.gc();
}

public void test_direct_management_of_connectionsSample128() {
try {
...
public native void testJNISample128();

public boolean equals(Sample128 obj) { /* BUG */
return true;
}
...
public void test_arraySample128() {
...
public void testRule2Sample128() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample128(Collection<Object> c) {
...
Sample128 other = (Sample128) o;
return (other.name.equals(""));
}

public void process_controlSample128() {
...
public int test_return_finallySample128(File file) {
try {
file.delete();
...
public void assignSample128() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample128() {
...
public void missing_defaultSample128(int x) {
switch (x) {
case 0:
...
public List<String> getASample128() {
return a;
}

public void weakSample128() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
