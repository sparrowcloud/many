...
String retNullSample064() {
    return null;
}

public BufferedInputStream getInputStreamSample064() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample064() {
    
    String x = retNullSample064();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample064() throws IOException {
BufferedInputStream i = getInputStreamSample064();
...
public void test_finalizeSample064() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample064() {
System.gc();
}

public void test_direct_management_of_connectionsSample064() {
try {
...
public native void testJNISample064();

public boolean equals(Sample064 obj) { /* BUG */
return true;
}
...
public void test_arraySample064() {
...
public void testRule2Sample064() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample064(Collection<Object> c) {
...
Sample064 other = (Sample064) o;
return (other.name.equals(""));
}

public void process_controlSample064() {
...
public int test_return_finallySample064(File file) {
try {
file.delete();
...
public void assignSample064() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample064() {
...
public void missing_defaultSample064(int x) {
switch (x) {
case 0:
...
public List<String> getASample064() {
return a;
}

public void weakSample064() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
