...
public class Sample230 extends HttpServlet {
...
String retNullSample230() {
    return null;
}

public BufferedInputStream getInputStreamSample230() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample230() {
    
    String x = retNullSample230();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample230() throws IOException {
BufferedInputStream i = getInputStreamSample230();
...
public void test_finalizeSample230() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample230() {
System.gc();
}

public void test_direct_management_of_connectionsSample230() {
try {
...
public native void testJNISample230();

public boolean equals(Sample230 obj) { /* BUG */
return true;
}
...
public void test_arraySample230() {
...
public void testRule2Sample230() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample230(Collection<Object> c) {
...
Sample230 other = (Sample230) o;
return (other.name.equals(""));
}

public void process_controlSample230() {
...
public int test_return_finallySample230(File file) {
try {
file.delete();
...
public void assignSample230() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample230() {
...
public void missing_defaultSample230(int x) {
switch (x) {
case 0:
...
public List<String> getASample230() {
return a;
}

public void weakSample230() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
