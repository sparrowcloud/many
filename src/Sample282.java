...
public class Sample282 extends HttpServlet {
...
String retNullSample282() {
    return null;
}

public BufferedInputStream getInputStreamSample282() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample282() {
    
    String x = retNullSample282();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample282() throws IOException {
BufferedInputStream i = getInputStreamSample282();
...
public void test_finalizeSample282() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample282() {
System.gc();
}

public void test_direct_management_of_connectionsSample282() {
try {
...
public native void testJNISample282();

public boolean equals(Sample282 obj) { /* BUG */
return true;
}
...
public void test_arraySample282() {
...
public void testRule2Sample282() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample282(Collection<Object> c) {
...
Sample282 other = (Sample282) o;
return (other.name.equals(""));
}

public void process_controlSample282() {
...
public int test_return_finallySample282(File file) {
try {
file.delete();
...
public void assignSample282() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample282() {
...
public void missing_defaultSample282(int x) {
switch (x) {
case 0:
...
public List<String> getASample282() {
return a;
}

public void weakSample282() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
