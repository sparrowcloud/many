...
public class Sample050 extends HttpServlet {
...
String retNullSample050() {
    return null;
}

public BufferedInputStream getInputStreamSample050() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample050() {
    
    String x = retNullSample050();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample050() throws IOException {
BufferedInputStream i = getInputStreamSample050();
...
public void test_finalizeSample050() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample050() {
System.gc();
}

public void test_direct_management_of_connectionsSample050() {
try {
...
public native void testJNISample050();

public boolean equals(Sample050 obj) { /* BUG */
return true;
}
...
public void test_arraySample050() {
...
public void testRule2Sample050() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample050(Collection<Object> c) {
...
Sample050 other = (Sample050) o;
return (other.name.equals(""));
}

public void process_controlSample050() {
...
public int test_return_finallySample050(File file) {
try {
file.delete();
...
public void assignSample050() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample050() {
...
public void missing_defaultSample050(int x) {
switch (x) {
case 0:
...
public List<String> getASample050() {
return a;
}

public void weakSample050() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
