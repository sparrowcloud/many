...
String retNullSample057() {
    return null;
}

public BufferedInputStream getInputStreamSample057() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample057() {
    
    String x = retNullSample057();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample057() throws IOException {
BufferedInputStream i = getInputStreamSample057();
...
public void test_finalizeSample057() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample057() {
System.gc();
}

public void test_direct_management_of_connectionsSample057() {
try {
...
public native void testJNISample057();

public boolean equals(Sample057 obj) { /* BUG */
return true;
}
...
public void test_arraySample057() {
...
public void testRule2Sample057() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample057(Collection<Object> c) {
...
Sample057 other = (Sample057) o;
return (other.name.equals(""));
}

public void process_controlSample057() {
...
public int test_return_finallySample057(File file) {
try {
file.delete();
...
public void assignSample057() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample057() {
...
public void missing_defaultSample057(int x) {
switch (x) {
case 0:
...
public List<String> getASample057() {
return a;
}

public void weakSample057() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
