...
public class Sample005{
    ...
    String retNullSample005() {
        return null;
    }

    public BufferedInputStream getInputStreamSample005() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample005() {

        String x = retNullSample005();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample005() throws IOException {
        BufferedInputStream i = getInputStreamSample005();
    ...
    public void test_finalizeSample005() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample005() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample005() {
        try {
    ...
    public native void testJNISample005();

    public boolean equals(Sample005 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample005() {
    ...
    public void testRule2Sample005() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample005(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample005 other = (Sample005) o;
        return (other.name.equals(""));
    }

    public void process_controlSample005() {
    ...
    public int test_return_finallySample005(File file) {
        try {
            file.delete();
    ...
    public void assignSample005() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample005() {
    ...
    public void missing_defaultSample005(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample005() {
        return a;
    }

    public void weakSample005() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
