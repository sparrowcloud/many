...
public class Sample160 extends HttpServlet {
...
String retNullSample160() {
    return null;
}

public BufferedInputStream getInputStreamSample160() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample160() {
    
    String x = retNullSample160();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample160() throws IOException {
BufferedInputStream i = getInputStreamSample160();
...
public void test_finalizeSample160() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample160() {
System.gc();
}

public void test_direct_management_of_connectionsSample160() {
try {
...
public native void testJNISample160();

public boolean equals(Sample160 obj) { /* BUG */
return true;
}
...
public void test_arraySample160() {
...
public void testRule2Sample160() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample160(Collection<Object> c) {
...
Sample160 other = (Sample160) o;
return (other.name.equals(""));
}

public void process_controlSample160() {
...
public int test_return_finallySample160(File file) {
try {
file.delete();
...
public void assignSample160() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample160() {
...
public void missing_defaultSample160(int x) {
switch (x) {
case 0:
...
public List<String> getASample160() {
return a;
}

public void weakSample160() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
