...
public class Sample098 extends HttpServlet {
...
String retNullSample098() {
    return null;
}

public BufferedInputStream getInputStreamSample098() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample098() {
    
    String x = retNullSample098();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample098() throws IOException {
BufferedInputStream i = getInputStreamSample098();
...
public void test_finalizeSample098() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample098() {
System.gc();
}

public void test_direct_management_of_connectionsSample098() {
try {
...
public native void testJNISample098();

public boolean equals(Sample098 obj) { /* BUG */
return true;
}
...
public void test_arraySample098() {
...
public void testRule2Sample098() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample098(Collection<Object> c) {
...
Sample098 other = (Sample098) o;
return (other.name.equals(""));
}

public void process_controlSample098() {
...
public int test_return_finallySample098(File file) {
try {
file.delete();
...
public void assignSample098() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample098() {
...
public void missing_defaultSample098(int x) {
switch (x) {
case 0:
...
public List<String> getASample098() {
return a;
}

public void weakSample098() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
