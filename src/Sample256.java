...
public class Sample256 extends HttpServlet {
...
String retNullSample256() {
    return null;
}

public BufferedInputStream getInputStreamSample256() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample256() {
    
    String x = retNullSample256();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample256() throws IOException {
BufferedInputStream i = getInputStreamSample256();
...
public void test_finalizeSample256() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample256() {
System.gc();
}

public void test_direct_management_of_connectionsSample256() {
try {
...
public native void testJNISample256();

public boolean equals(Sample256 obj) { /* BUG */
return true;
}
...
public void test_arraySample256() {
...
public void testRule2Sample256() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample256(Collection<Object> c) {
...
Sample256 other = (Sample256) o;
return (other.name.equals(""));
}

public void process_controlSample256() {
...
public int test_return_finallySample256(File file) {
try {
file.delete();
...
public void assignSample256() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample256() {
...
public void missing_defaultSample256(int x) {
switch (x) {
case 0:
...
public List<String> getASample256() {
return a;
}

public void weakSample256() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
