...
public class Sample038 extends HttpServlet {
...
String retNullSample038() {
    return null;
}

public BufferedInputStream getInputStreamSample038() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample038() {
    
    String x = retNullSample038();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample038() throws IOException {
BufferedInputStream i = getInputStreamSample038();
...
public void test_finalizeSample038() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample038() {
System.gc();
}

public void test_direct_management_of_connectionsSample038() {
try {
...
public native void testJNISample038();

public boolean equals(Sample038 obj) { /* BUG */
return true;
}
...
public void test_arraySample038() {
...
public void testRule2Sample038() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample038(Collection<Object> c) {
...
Sample038 other = (Sample038) o;
return (other.name.equals(""));
}

public void process_controlSample038() {
...
public int test_return_finallySample038(File file) {
try {
file.delete();
...
public void assignSample038() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample038() {
...
public void missing_defaultSample038(int x) {
switch (x) {
case 0:
...
public List<String> getASample038() {
return a;
}

public void weakSample038() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
