...
public class Sample292 extends HttpServlet {
...
String retNullSample292() {
    return null;
}

public BufferedInputStream getInputStreamSample292() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample292() {
    
    String x = retNullSample292();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample292() throws IOException {
BufferedInputStream i = getInputStreamSample292();
...
public void test_finalizeSample292() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample292() {
System.gc();
}

public void test_direct_management_of_connectionsSample292() {
try {
...
public native void testJNISample292();

public boolean equals(Sample292 obj) { /* BUG */
return true;
}
...
public void test_arraySample292() {
...
public void testRule2Sample292() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample292(Collection<Object> c) {
...
Sample292 other = (Sample292) o;
return (other.name.equals(""));
}

public void process_controlSample292() {
...
public int test_return_finallySample292(File file) {
try {
file.delete();
...
public void assignSample292() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample292() {
...
public void missing_defaultSample292(int x) {
switch (x) {
case 0:
...
public List<String> getASample292() {
return a;
}

public void weakSample292() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
