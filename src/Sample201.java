...
public class Sample201 extends HttpServlet {
...
String retNullSample201() {
    return null;
}

public BufferedInputStream getInputStreamSample201() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample201() {
    
    String x = retNullSample201();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample201() throws IOException {
BufferedInputStream i = getInputStreamSample201();
...
public void test_finalizeSample201() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample201() {
System.gc();
}

public void test_direct_management_of_connectionsSample201() {
try {
...
public native void testJNISample201();

public boolean equals(Sample201 obj) { /* BUG */
return true;
}
...
public void test_arraySample201() {
...
public void testRule2Sample201() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample201(Collection<Object> c) {
...
Sample201 other = (Sample201) o;
return (other.name.equals(""));
}

public void process_controlSample201() {
...
public int test_return_finallySample201(File file) {
try {
file.delete();
...
public void assignSample201() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample201() {
...
public void missing_defaultSample201(int x) {
switch (x) {
case 0:
...
public List<String> getASample201() {
return a;
}

public void weakSample201() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
