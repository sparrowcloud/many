...
public class Sample223 extends HttpServlet {
...
String retNullSample223() {
    return null;
}

public BufferedInputStream getInputStreamSample223() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample223() {
    
    String x = retNullSample223();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample223() throws IOException {
BufferedInputStream i = getInputStreamSample223();
...
public void test_finalizeSample223() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample223() {
System.gc();
}

public void test_direct_management_of_connectionsSample223() {
try {
...
public native void testJNISample223();

public boolean equals(Sample223 obj) { /* BUG */
return true;
}
...
public void test_arraySample223() {
...
public void testRule2Sample223() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample223(Collection<Object> c) {
...
Sample223 other = (Sample223) o;
return (other.name.equals(""));
}

public void process_controlSample223() {
...
public int test_return_finallySample223(File file) {
try {
file.delete();
...
public void assignSample223() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample223() {
...
public void missing_defaultSample223(int x) {
switch (x) {
case 0:
...
public List<String> getASample223() {
return a;
}

public void weakSample223() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
