...
public class Sample140 extends HttpServlet {
...
String retNullSample140() {
    return null;
}

public BufferedInputStream getInputStreamSample140() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample140() {
    
    String x = retNullSample140();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample140() throws IOException {
BufferedInputStream i = getInputStreamSample140();
...
public void test_finalizeSample140() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample140() {
System.gc();
}

public void test_direct_management_of_connectionsSample140() {
try {
...
public native void testJNISample140();

public boolean equals(Sample140 obj) { /* BUG */
return true;
}
...
public void test_arraySample140() {
...
public void testRule2Sample140() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample140(Collection<Object> c) {
...
Sample140 other = (Sample140) o;
return (other.name.equals(""));
}

public void process_controlSample140() {
...
public int test_return_finallySample140(File file) {
try {
file.delete();
...
public void assignSample140() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample140() {
...
public void missing_defaultSample140(int x) {
switch (x) {
case 0:
...
public List<String> getASample140() {
return a;
}

public void weakSample140() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
