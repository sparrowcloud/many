...
String retNullSample123() {
    return null;
}

public BufferedInputStream getInputStreamSample123() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample123() {
    
    String x = retNullSample123();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample123() throws IOException {
BufferedInputStream i = getInputStreamSample123();
...
public void test_finalizeSample123() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample123() {
System.gc();
}

public void test_direct_management_of_connectionsSample123() {
try {
...
public native void testJNISample123();

public boolean equals(Sample123 obj) { /* BUG */
return true;
}
...
public void test_arraySample123() {
...
public void testRule2Sample123() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample123(Collection<Object> c) {
...
Sample123 other = (Sample123) o;
return (other.name.equals(""));
}

public void process_controlSample123() {
...
public int test_return_finallySample123(File file) {
try {
file.delete();
...
public void assignSample123() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample123() {
...
public void missing_defaultSample123(int x) {
switch (x) {
case 0:
...
public List<String> getASample123() {
return a;
}

public void weakSample123() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
