...
public class Sample242 extends HttpServlet {
...
String retNullSample242() {
    return null;
}

public BufferedInputStream getInputStreamSample242() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample242() {
    
    String x = retNullSample242();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample242() throws IOException {
BufferedInputStream i = getInputStreamSample242();
...
public void test_finalizeSample242() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample242() {
System.gc();
}

public void test_direct_management_of_connectionsSample242() {
try {
...
public native void testJNISample242();

public boolean equals(Sample242 obj) { /* BUG */
return true;
}
...
public void test_arraySample242() {
...
public void testRule2Sample242() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample242(Collection<Object> c) {
...
Sample242 other = (Sample242) o;
return (other.name.equals(""));
}

public void process_controlSample242() {
...
public int test_return_finallySample242(File file) {
try {
file.delete();
...
public void assignSample242() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample242() {
...
public void missing_defaultSample242(int x) {
switch (x) {
case 0:
...
public List<String> getASample242() {
return a;
}

public void weakSample242() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
