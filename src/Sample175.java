...
public class Sample175 extends HttpServlet {
...
String retNullSample175() {
    return null;
}

public BufferedInputStream getInputStreamSample175() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample175() {
    
    String x = retNullSample175();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample175() throws IOException {
BufferedInputStream i = getInputStreamSample175();
...
public void test_finalizeSample175() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample175() {
System.gc();
}

public void test_direct_management_of_connectionsSample175() {
try {
...
public native void testJNISample175();

public boolean equals(Sample175 obj) { /* BUG */
return true;
}
...
public void test_arraySample175() {
...
public void testRule2Sample175() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample175(Collection<Object> c) {
...
Sample175 other = (Sample175) o;
return (other.name.equals(""));
}

public void process_controlSample175() {
...
public int test_return_finallySample175(File file) {
try {
file.delete();
...
public void assignSample175() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample175() {
...
public void missing_defaultSample175(int x) {
switch (x) {
case 0:
...
public List<String> getASample175() {
return a;
}

public void weakSample175() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
