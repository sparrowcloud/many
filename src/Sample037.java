...
public class Sample037 extends HttpServlet {
...
String retNullSample037() {
    return null;
}

public BufferedInputStream getInputStreamSample037() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample037() {
    
    String x = retNullSample037();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample037() throws IOException {
BufferedInputStream i = getInputStreamSample037();
...
public void test_finalizeSample037() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample037() {
System.gc();
}

public void test_direct_management_of_connectionsSample037() {
try {
...
public native void testJNISample037();

public boolean equals(Sample037 obj) { /* BUG */
return true;
}
...
public void test_arraySample037() {
...
public void testRule2Sample037() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample037(Collection<Object> c) {
...
Sample037 other = (Sample037) o;
return (other.name.equals(""));
}

public void process_controlSample037() {
...
public int test_return_finallySample037(File file) {
try {
file.delete();
...
public void assignSample037() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample037() {
...
public void missing_defaultSample037(int x) {
switch (x) {
case 0:
...
public List<String> getASample037() {
return a;
}

public void weakSample037() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
