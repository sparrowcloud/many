...
String retNullSample116() {
    return null;
}

public BufferedInputStream getInputStreamSample116() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample116() {
    
    String x = retNullSample116();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample116() throws IOException {
BufferedInputStream i = getInputStreamSample116();
...
public void test_finalizeSample116() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample116() {
System.gc();
}

public void test_direct_management_of_connectionsSample116() {
try {
...
public native void testJNISample116();

public boolean equals(Sample116 obj) { /* BUG */
return true;
}
...
public void test_arraySample116() {
...
public void testRule2Sample116() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample116(Collection<Object> c) {
...
Sample116 other = (Sample116) o;
return (other.name.equals(""));
}

public void process_controlSample116() {
...
public int test_return_finallySample116(File file) {
try {
file.delete();
...
public void assignSample116() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample116() {
...
public void missing_defaultSample116(int x) {
switch (x) {
case 0:
...
public List<String> getASample116() {
return a;
}

public void weakSample116() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
