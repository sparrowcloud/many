...
public class Sample048 extends HttpServlet {
...
String retNullSample048() {
    return null;
}

public BufferedInputStream getInputStreamSample048() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample048() {
    
    String x = retNullSample048();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample048() throws IOException {
BufferedInputStream i = getInputStreamSample048();
...
public void test_finalizeSample048() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample048() {
System.gc();
}

public void test_direct_management_of_connectionsSample048() {
try {
...
public native void testJNISample048();

public boolean equals(Sample048 obj) { /* BUG */
return true;
}
...
public void test_arraySample048() {
...
public void testRule2Sample048() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample048(Collection<Object> c) {
...
Sample048 other = (Sample048) o;
return (other.name.equals(""));
}

public void process_controlSample048() {
...
public int test_return_finallySample048(File file) {
try {
file.delete();
...
public void assignSample048() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample048() {
...
public void missing_defaultSample048(int x) {
switch (x) {
case 0:
...
public List<String> getASample048() {
return a;
}

public void weakSample048() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
