...
public class Sample096 extends HttpServlet {
...
String retNullSample096() {
    return null;
}

public BufferedInputStream getInputStreamSample096() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample096() {
    
    String x = retNullSample096();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample096() throws IOException {
BufferedInputStream i = getInputStreamSample096();
...
public void test_finalizeSample096() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample096() {
System.gc();
}

public void test_direct_management_of_connectionsSample096() {
try {
...
public native void testJNISample096();

public boolean equals(Sample096 obj) { /* BUG */
return true;
}
...
public void test_arraySample096() {
...
public void testRule2Sample096() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample096(Collection<Object> c) {
...
Sample096 other = (Sample096) o;
return (other.name.equals(""));
}

public void process_controlSample096() {
...
public int test_return_finallySample096(File file) {
try {
file.delete();
...
public void assignSample096() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample096() {
...
public void missing_defaultSample096(int x) {
switch (x) {
case 0:
...
public List<String> getASample096() {
return a;
}

public void weakSample096() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
