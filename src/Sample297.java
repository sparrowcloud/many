...
public class Sample297 extends HttpServlet {
...
String retNullSample297() {
    return null;
}

public BufferedInputStream getInputStreamSample297() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample297() {
    
    String x = retNullSample297();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample297() throws IOException {
BufferedInputStream i = getInputStreamSample297();
...
public void test_finalizeSample297() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample297() {
System.gc();
}

public void test_direct_management_of_connectionsSample297() {
try {
...
public native void testJNISample297();

public boolean equals(Sample297 obj) { /* BUG */
return true;
}
...
public void test_arraySample297() {
...
public void testRule2Sample297() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample297(Collection<Object> c) {
...
Sample297 other = (Sample297) o;
return (other.name.equals(""));
}

public void process_controlSample297() {
...
public int test_return_finallySample297(File file) {
try {
file.delete();
...
public void assignSample297() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample297() {
...
public void missing_defaultSample297(int x) {
switch (x) {
case 0:
...
public List<String> getASample297() {
return a;
}

public void weakSample297() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
