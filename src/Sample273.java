...
public class Sample273 extends HttpServlet {
...
String retNullSample273() {
    return null;
}

public BufferedInputStream getInputStreamSample273() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample273() {
    
    String x = retNullSample273();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample273() throws IOException {
BufferedInputStream i = getInputStreamSample273();
...
public void test_finalizeSample273() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample273() {
System.gc();
}

public void test_direct_management_of_connectionsSample273() {
try {
...
public native void testJNISample273();

public boolean equals(Sample273 obj) { /* BUG */
return true;
}
...
public void test_arraySample273() {
...
public void testRule2Sample273() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample273(Collection<Object> c) {
...
Sample273 other = (Sample273) o;
return (other.name.equals(""));
}

public void process_controlSample273() {
...
public int test_return_finallySample273(File file) {
try {
file.delete();
...
public void assignSample273() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample273() {
...
public void missing_defaultSample273(int x) {
switch (x) {
case 0:
...
public List<String> getASample273() {
return a;
}

public void weakSample273() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
