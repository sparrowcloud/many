...
public class Sample265 extends HttpServlet {
...
String retNullSample265() {
    return null;
}

public BufferedInputStream getInputStreamSample265() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample265() {
    
    String x = retNullSample265();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample265() throws IOException {
BufferedInputStream i = getInputStreamSample265();
...
public void test_finalizeSample265() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample265() {
System.gc();
}

public void test_direct_management_of_connectionsSample265() {
try {
...
public native void testJNISample265();

public boolean equals(Sample265 obj) { /* BUG */
return true;
}
...
public void test_arraySample265() {
...
public void testRule2Sample265() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample265(Collection<Object> c) {
...
Sample265 other = (Sample265) o;
return (other.name.equals(""));
}

public void process_controlSample265() {
...
public int test_return_finallySample265(File file) {
try {
file.delete();
...
public void assignSample265() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample265() {
...
public void missing_defaultSample265(int x) {
switch (x) {
case 0:
...
public List<String> getASample265() {
return a;
}

public void weakSample265() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
