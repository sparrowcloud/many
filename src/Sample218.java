...
public class Sample218 extends HttpServlet {
...
String retNullSample218() {
    return null;
}

public BufferedInputStream getInputStreamSample218() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample218() {
    
    String x = retNullSample218();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample218() throws IOException {
BufferedInputStream i = getInputStreamSample218();
...
public void test_finalizeSample218() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample218() {
System.gc();
}

public void test_direct_management_of_connectionsSample218() {
try {
...
public native void testJNISample218();

public boolean equals(Sample218 obj) { /* BUG */
return true;
}
...
public void test_arraySample218() {
...
public void testRule2Sample218() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample218(Collection<Object> c) {
...
Sample218 other = (Sample218) o;
return (other.name.equals(""));
}

public void process_controlSample218() {
...
public int test_return_finallySample218(File file) {
try {
file.delete();
...
public void assignSample218() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample218() {
...
public void missing_defaultSample218(int x) {
switch (x) {
case 0:
...
public List<String> getASample218() {
return a;
}

public void weakSample218() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
