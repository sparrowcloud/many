...
public class Sample187 extends HttpServlet {
...
String retNullSample187() {
    return null;
}

public BufferedInputStream getInputStreamSample187() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample187() {
    
    String x = retNullSample187();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample187() throws IOException {
BufferedInputStream i = getInputStreamSample187();
...
public void test_finalizeSample187() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample187() {
System.gc();
}

public void test_direct_management_of_connectionsSample187() {
try {
...
public native void testJNISample187();

public boolean equals(Sample187 obj) { /* BUG */
return true;
}
...
public void test_arraySample187() {
...
public void testRule2Sample187() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample187(Collection<Object> c) {
...
Sample187 other = (Sample187) o;
return (other.name.equals(""));
}

public void process_controlSample187() {
...
public int test_return_finallySample187(File file) {
try {
file.delete();
...
public void assignSample187() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample187() {
...
public void missing_defaultSample187(int x) {
switch (x) {
case 0:
...
public List<String> getASample187() {
return a;
}

public void weakSample187() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
