...
public class Sample066{
    ...
    String retNullSample066() {
        return null;
    }

    public BufferedInputStream getInputStreamSample066() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample066() {

        String x = retNullSample066();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample066() throws IOException {
        BufferedInputStream i = getInputStreamSample066();
    ...
    public void test_finalizeSample066() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample066() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample066() {
        try {
    ...
    public native void testJNISample066();

    public boolean equals(Sample066 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample066() {
    ...
    public void testRule2Sample066() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample066(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample066 other = (Sample066) o;
        return (other.name.equals(""));
    }

    public void process_controlSample066() {
    ...
    public int test_return_finallySample066(File file) {
        try {
            file.delete();
    ...
    public void assignSample066() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample066() {
    ...
    public void missing_defaultSample066(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample066() {
        return a;
    }

    public void weakSample066() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
