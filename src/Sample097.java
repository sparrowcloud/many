...
public class Sample097 extends HttpServlet {
...
String retNullSample097() {
    return null;
}

public BufferedInputStream getInputStreamSample097() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample097() {
    
    String x = retNullSample097();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample097() throws IOException {
BufferedInputStream i = getInputStreamSample097();
...
public void test_finalizeSample097() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample097() {
System.gc();
}

public void test_direct_management_of_connectionsSample097() {
try {
...
public native void testJNISample097();

public boolean equals(Sample097 obj) { /* BUG */
return true;
}
...
public void test_arraySample097() {
...
public void testRule2Sample097() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample097(Collection<Object> c) {
...
Sample097 other = (Sample097) o;
return (other.name.equals(""));
}

public void process_controlSample097() {
...
public int test_return_finallySample097(File file) {
try {
file.delete();
...
public void assignSample097() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample097() {
...
public void missing_defaultSample097(int x) {
switch (x) {
case 0:
...
public List<String> getASample097() {
return a;
}

public void weakSample097() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
