...
public class Sample008 extends HttpServlet {
...
String retNullSample008() {
    return null;
}

public BufferedInputStream getInputStreamSample008() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample008() {
    
    String x = retNullSample008();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample008() throws IOException {
BufferedInputStream i = getInputStreamSample008();
...
public void test_finalizeSample008() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample008() {
System.gc();
}

public void test_direct_management_of_connectionsSample008() {
try {
...
public native void testJNISample008();

public boolean equals(Sample008 obj) { /* BUG */
return true;
}
...
public void test_arraySample008() {
...
public void testRule2Sample008() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample008(Collection<Object> c) {
...
Sample008 other = (Sample008) o;
return (other.name.equals(""));
}

public void process_controlSample008() {
...
public int test_return_finallySample008(File file) {
try {
file.delete();
...
public void assignSample008() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample008() {
...
public void missing_defaultSample008(int x) {
switch (x) {
case 0:
...
public List<String> getASample008() {
return a;
}

public void weakSample008() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
