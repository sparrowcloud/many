...
public class Sample168 extends HttpServlet {
...
String retNullSample168() {
    return null;
}

public BufferedInputStream getInputStreamSample168() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample168() {
    
    String x = retNullSample168();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample168() throws IOException {
BufferedInputStream i = getInputStreamSample168();
...
public void test_finalizeSample168() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample168() {
System.gc();
}

public void test_direct_management_of_connectionsSample168() {
try {
...
public native void testJNISample168();

public boolean equals(Sample168 obj) { /* BUG */
return true;
}
...
public void test_arraySample168() {
...
public void testRule2Sample168() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample168(Collection<Object> c) {
...
Sample168 other = (Sample168) o;
return (other.name.equals(""));
}

public void process_controlSample168() {
...
public int test_return_finallySample168(File file) {
try {
file.delete();
...
public void assignSample168() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample168() {
...
public void missing_defaultSample168(int x) {
switch (x) {
case 0:
...
public List<String> getASample168() {
return a;
}

public void weakSample168() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
