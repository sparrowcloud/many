...
public class Sample107 extends HttpServlet {
...
String retNullSample107() {
    return null;
}

public BufferedInputStream getInputStreamSample107() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample107() {
    
    String x = retNullSample107();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample107() throws IOException {
BufferedInputStream i = getInputStreamSample107();
...
public void test_finalizeSample107() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample107() {
System.gc();
}

public void test_direct_management_of_connectionsSample107() {
try {
...
public native void testJNISample107();

public boolean equals(Sample107 obj) { /* BUG */
return true;
}
...
public void test_arraySample107() {
...
public void testRule2Sample107() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample107(Collection<Object> c) {
...
Sample107 other = (Sample107) o;
return (other.name.equals(""));
}

public void process_controlSample107() {
...
public int test_return_finallySample107(File file) {
try {
file.delete();
...
public void assignSample107() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample107() {
...
public void missing_defaultSample107(int x) {
switch (x) {
case 0:
...
public List<String> getASample107() {
return a;
}

public void weakSample107() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
