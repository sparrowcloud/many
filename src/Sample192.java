...
String retNullSample192() {
    return null;
}

public BufferedInputStream getInputStreamSample192() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample192() {
    
    String x = retNullSample192();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample192() throws IOException {
BufferedInputStream i = getInputStreamSample192();
...
public void test_finalizeSample192() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample192() {
System.gc();
}

public void test_direct_management_of_connectionsSample192() {
try {
...
public native void testJNISample192();

public boolean equals(Sample192 obj) { /* BUG */
return true;
}
...
public void test_arraySample192() {
...
public void testRule2Sample192() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample192(Collection<Object> c) {
...
Sample192 other = (Sample192) o;
return (other.name.equals(""));
}

public void process_controlSample192() {
...
public int test_return_finallySample192(File file) {
try {
file.delete();
...
public void assignSample192() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample192() {
...
public void missing_defaultSample192(int x) {
switch (x) {
case 0:
...
public List<String> getASample192() {
return a;
}

public void weakSample192() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
