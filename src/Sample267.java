...
public class Sample267 extends HttpServlet {
...
String retNullSample267() {
    return null;
}

public BufferedInputStream getInputStreamSample267() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample267() {
    
    String x = retNullSample267();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample267() throws IOException {
BufferedInputStream i = getInputStreamSample267();
...
public void test_finalizeSample267() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample267() {
System.gc();
}

public void test_direct_management_of_connectionsSample267() {
try {
...
public native void testJNISample267();

public boolean equals(Sample267 obj) { /* BUG */
return true;
}
...
public void test_arraySample267() {
...
public void testRule2Sample267() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample267(Collection<Object> c) {
...
Sample267 other = (Sample267) o;
return (other.name.equals(""));
}

public void process_controlSample267() {
...
public int test_return_finallySample267(File file) {
try {
file.delete();
...
public void assignSample267() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample267() {
...
public void missing_defaultSample267(int x) {
switch (x) {
case 0:
...
public List<String> getASample267() {
return a;
}

public void weakSample267() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
