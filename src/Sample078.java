...
public class Sample078 extends HttpServlet {
...
String retNullSample078() {
    return null;
}

public BufferedInputStream getInputStreamSample078() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample078() {
    
    String x = retNullSample078();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample078() throws IOException {
BufferedInputStream i = getInputStreamSample078();
...
public void test_finalizeSample078() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample078() {
System.gc();
}

public void test_direct_management_of_connectionsSample078() {
try {
...
public native void testJNISample078();

public boolean equals(Sample078 obj) { /* BUG */
return true;
}
...
public void test_arraySample078() {
...
public void testRule2Sample078() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample078(Collection<Object> c) {
...
Sample078 other = (Sample078) o;
return (other.name.equals(""));
}

public void process_controlSample078() {
...
public int test_return_finallySample078(File file) {
try {
file.delete();
...
public void assignSample078() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample078() {
...
public void missing_defaultSample078(int x) {
switch (x) {
case 0:
...
public List<String> getASample078() {
return a;
}

public void weakSample078() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
