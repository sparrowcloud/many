...
public class Sample220 extends HttpServlet {
...
String retNullSample220() {
    return null;
}

public BufferedInputStream getInputStreamSample220() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample220() {
    
    String x = retNullSample220();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample220() throws IOException {
BufferedInputStream i = getInputStreamSample220();
...
public void test_finalizeSample220() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample220() {
System.gc();
}

public void test_direct_management_of_connectionsSample220() {
try {
...
public native void testJNISample220();

public boolean equals(Sample220 obj) { /* BUG */
return true;
}
...
public void test_arraySample220() {
...
public void testRule2Sample220() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample220(Collection<Object> c) {
...
Sample220 other = (Sample220) o;
return (other.name.equals(""));
}

public void process_controlSample220() {
...
public int test_return_finallySample220(File file) {
try {
file.delete();
...
public void assignSample220() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample220() {
...
public void missing_defaultSample220(int x) {
switch (x) {
case 0:
...
public List<String> getASample220() {
return a;
}

public void weakSample220() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
