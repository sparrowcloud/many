...
String retNullSample120() {
    return null;
}

public BufferedInputStream getInputStreamSample120() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample120() {
    
    String x = retNullSample120();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample120() throws IOException {
BufferedInputStream i = getInputStreamSample120();
...
public void test_finalizeSample120() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample120() {
System.gc();
}

public void test_direct_management_of_connectionsSample120() {
try {
...
public native void testJNISample120();

public boolean equals(Sample120 obj) { /* BUG */
return true;
}
...
public void test_arraySample120() {
...
public void testRule2Sample120() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample120(Collection<Object> c) {
...
Sample120 other = (Sample120) o;
return (other.name.equals(""));
}

public void process_controlSample120() {
...
public int test_return_finallySample120(File file) {
try {
file.delete();
...
public void assignSample120() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample120() {
...
public void missing_defaultSample120(int x) {
switch (x) {
case 0:
...
public List<String> getASample120() {
return a;
}

public void weakSample120() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
