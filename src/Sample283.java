...
public class Sample283 extends HttpServlet {
...
String retNullSample283() {
    return null;
}

public BufferedInputStream getInputStreamSample283() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample283() {
    
    String x = retNullSample283();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample283() throws IOException {
BufferedInputStream i = getInputStreamSample283();
...
public void test_finalizeSample283() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample283() {
System.gc();
}

public void test_direct_management_of_connectionsSample283() {
try {
...
public native void testJNISample283();

public boolean equals(Sample283 obj) { /* BUG */
return true;
}
...
public void test_arraySample283() {
...
public void testRule2Sample283() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample283(Collection<Object> c) {
...
Sample283 other = (Sample283) o;
return (other.name.equals(""));
}

public void process_controlSample283() {
...
public int test_return_finallySample283(File file) {
try {
file.delete();
...
public void assignSample283() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample283() {
...
public void missing_defaultSample283(int x) {
switch (x) {
case 0:
...
public List<String> getASample283() {
return a;
}

public void weakSample283() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
