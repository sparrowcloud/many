...
public class Sample006{
    ...
    String retNullSample006() {
        return null;
    }

    public BufferedInputStream getInputStreamSample006() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample006() {

        String x = retNullSample006();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample006() throws IOException {
        BufferedInputStream i = getInputStreamSample006();
    ...
    public void test_finalizeSample006() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample006() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample006() {
        try {
    ...
    public native void testJNISample006();

    public boolean equals(Sample006 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample006() {
    ...
    public void testRule2Sample006() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample006(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample006 other = (Sample006) o;
        return (other.name.equals(""));
    }

    public void process_controlSample006() {
    ...
    public int test_return_finallySample006(File file) {
        try {
            file.delete();
    ...
    public void assignSample006() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample006() {
    ...
    public void missing_defaultSample006(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample006() {
        return a;
    }

    public void weakSample006() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
