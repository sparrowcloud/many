...
String retNullSample014() {
    return null;
}

public BufferedInputStream getInputStreamSample014() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample014() {
    
    String x = retNullSample014();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample014() throws IOException {
BufferedInputStream i = getInputStreamSample014();
...
public void test_finalizeSample014() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample014() {
System.gc();
}

public void test_direct_management_of_connectionsSample014() {
try {
...
public native void testJNISample014();

public boolean equals(Sample014 obj) { /* BUG */
return true;
}
...
public void test_arraySample014() {
...
public void testRule2Sample014() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample014(Collection<Object> c) {
...
Sample014 other = (Sample014) o;
return (other.name.equals(""));
}

public void process_controlSample014() {
...
public int test_return_finallySample014(File file) {
try {
file.delete();
...
public void assignSample014() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample014() {
...
public void missing_defaultSample014(int x) {
switch (x) {
case 0:
...
public List<String> getASample014() {
return a;
}

public void weakSample014() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
