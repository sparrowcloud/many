...
public class Sample141 extends HttpServlet {
...
String retNullSample141() {
    return null;
}

public BufferedInputStream getInputStreamSample141() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample141() {
    
    String x = retNullSample141();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample141() throws IOException {
BufferedInputStream i = getInputStreamSample141();
...
public void test_finalizeSample141() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample141() {
System.gc();
}

public void test_direct_management_of_connectionsSample141() {
try {
...
public native void testJNISample141();

public boolean equals(Sample141 obj) { /* BUG */
return true;
}
...
public void test_arraySample141() {
...
public void testRule2Sample141() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample141(Collection<Object> c) {
...
Sample141 other = (Sample141) o;
return (other.name.equals(""));
}

public void process_controlSample141() {
...
public int test_return_finallySample141(File file) {
try {
file.delete();
...
public void assignSample141() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample141() {
...
public void missing_defaultSample141(int x) {
switch (x) {
case 0:
...
public List<String> getASample141() {
return a;
}

public void weakSample141() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
