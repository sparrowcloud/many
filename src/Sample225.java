...
public class Sample225 extends HttpServlet {
...
String retNullSample225() {
    return null;
}

public BufferedInputStream getInputStreamSample225() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample225() {
    
    String x = retNullSample225();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample225() throws IOException {
BufferedInputStream i = getInputStreamSample225();
...
public void test_finalizeSample225() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample225() {
System.gc();
}

public void test_direct_management_of_connectionsSample225() {
try {
...
public native void testJNISample225();

public boolean equals(Sample225 obj) { /* BUG */
return true;
}
...
public void test_arraySample225() {
...
public void testRule2Sample225() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample225(Collection<Object> c) {
...
Sample225 other = (Sample225) o;
return (other.name.equals(""));
}

public void process_controlSample225() {
...
public int test_return_finallySample225(File file) {
try {
file.delete();
...
public void assignSample225() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample225() {
...
public void missing_defaultSample225(int x) {
switch (x) {
case 0:
...
public List<String> getASample225() {
return a;
}

public void weakSample225() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
