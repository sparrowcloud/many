...
public class Sample202 extends HttpServlet {
...
String retNullSample202() {
    return null;
}

public BufferedInputStream getInputStreamSample202() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample202() {
    
    String x = retNullSample202();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample202() throws IOException {
BufferedInputStream i = getInputStreamSample202();
...
public void test_finalizeSample202() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample202() {
System.gc();
}

public void test_direct_management_of_connectionsSample202() {
try {
...
public native void testJNISample202();

public boolean equals(Sample202 obj) { /* BUG */
return true;
}
...
public void test_arraySample202() {
...
public void testRule2Sample202() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample202(Collection<Object> c) {
...
Sample202 other = (Sample202) o;
return (other.name.equals(""));
}

public void process_controlSample202() {
...
public int test_return_finallySample202(File file) {
try {
file.delete();
...
public void assignSample202() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample202() {
...
public void missing_defaultSample202(int x) {
switch (x) {
case 0:
...
public List<String> getASample202() {
return a;
}

public void weakSample202() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
