...
String retNullSample118() {
    return null;
}

public BufferedInputStream getInputStreamSample118() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample118() {
    
    String x = retNullSample118();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample118() throws IOException {
BufferedInputStream i = getInputStreamSample118();
...
public void test_finalizeSample118() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample118() {
System.gc();
}

public void test_direct_management_of_connectionsSample118() {
try {
...
public native void testJNISample118();

public boolean equals(Sample118 obj) { /* BUG */
return true;
}
...
public void test_arraySample118() {
...
public void testRule2Sample118() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample118(Collection<Object> c) {
...
Sample118 other = (Sample118) o;
return (other.name.equals(""));
}

public void process_controlSample118() {
...
public int test_return_finallySample118(File file) {
try {
file.delete();
...
public void assignSample118() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample118() {
...
public void missing_defaultSample118(int x) {
switch (x) {
case 0:
...
public List<String> getASample118() {
return a;
}

public void weakSample118() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
