...
public class Sample216 extends HttpServlet {
...
String retNullSample216() {
    return null;
}

public BufferedInputStream getInputStreamSample216() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample216() {
    
    String x = retNullSample216();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample216() throws IOException {
BufferedInputStream i = getInputStreamSample216();
...
public void test_finalizeSample216() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample216() {
System.gc();
}

public void test_direct_management_of_connectionsSample216() {
try {
...
public native void testJNISample216();

public boolean equals(Sample216 obj) { /* BUG */
return true;
}
...
public void test_arraySample216() {
...
public void testRule2Sample216() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample216(Collection<Object> c) {
...
Sample216 other = (Sample216) o;
return (other.name.equals(""));
}

public void process_controlSample216() {
...
public int test_return_finallySample216(File file) {
try {
file.delete();
...
public void assignSample216() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample216() {
...
public void missing_defaultSample216(int x) {
switch (x) {
case 0:
...
public List<String> getASample216() {
return a;
}

public void weakSample216() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
