...
public class Sample257 extends HttpServlet {
...
String retNullSample257() {
    return null;
}

public BufferedInputStream getInputStreamSample257() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample257() {
    
    String x = retNullSample257();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample257() throws IOException {
BufferedInputStream i = getInputStreamSample257();
...
public void test_finalizeSample257() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample257() {
System.gc();
}

public void test_direct_management_of_connectionsSample257() {
try {
...
public native void testJNISample257();

public boolean equals(Sample257 obj) { /* BUG */
return true;
}
...
public void test_arraySample257() {
...
public void testRule2Sample257() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample257(Collection<Object> c) {
...
Sample257 other = (Sample257) o;
return (other.name.equals(""));
}

public void process_controlSample257() {
...
public int test_return_finallySample257(File file) {
try {
file.delete();
...
public void assignSample257() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample257() {
...
public void missing_defaultSample257(int x) {
switch (x) {
case 0:
...
public List<String> getASample257() {
return a;
}

public void weakSample257() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
