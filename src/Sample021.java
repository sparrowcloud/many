...
public class Sample021 extends HttpServlet {
...
String retNullSample021() {
    return null;
}

public BufferedInputStream getInputStreamSample021() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample021() {
    
    String x = retNullSample021();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample021() throws IOException {
BufferedInputStream i = getInputStreamSample021();
...
public void test_finalizeSample021() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample021() {
System.gc();
}

public void test_direct_management_of_connectionsSample021() {
try {
...
public native void testJNISample021();

public boolean equals(Sample021 obj) { /* BUG */
return true;
}
...
public void test_arraySample021() {
...
public void testRule2Sample021() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample021(Collection<Object> c) {
...
Sample021 other = (Sample021) o;
return (other.name.equals(""));
}

public void process_controlSample021() {
...
public int test_return_finallySample021(File file) {
try {
file.delete();
...
public void assignSample021() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample021() {
...
public void missing_defaultSample021(int x) {
switch (x) {
case 0:
...
public List<String> getASample021() {
return a;
}

public void weakSample021() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
