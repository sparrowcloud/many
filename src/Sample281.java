...
public class Sample281 extends HttpServlet {
...
String retNullSample281() {
    return null;
}

public BufferedInputStream getInputStreamSample281() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample281() {
    
    String x = retNullSample281();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample281() throws IOException {
BufferedInputStream i = getInputStreamSample281();
...
public void test_finalizeSample281() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample281() {
System.gc();
}

public void test_direct_management_of_connectionsSample281() {
try {
...
public native void testJNISample281();

public boolean equals(Sample281 obj) { /* BUG */
return true;
}
...
public void test_arraySample281() {
...
public void testRule2Sample281() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample281(Collection<Object> c) {
...
Sample281 other = (Sample281) o;
return (other.name.equals(""));
}

public void process_controlSample281() {
...
public int test_return_finallySample281(File file) {
try {
file.delete();
...
public void assignSample281() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample281() {
...
public void missing_defaultSample281(int x) {
switch (x) {
case 0:
...
public List<String> getASample281() {
return a;
}

public void weakSample281() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
