...
public class Sample032 extends HttpServlet {
...
String retNullSample032() {
    return null;
}

public BufferedInputStream getInputStreamSample032() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample032() {
    
    String x = retNullSample032();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample032() throws IOException {
BufferedInputStream i = getInputStreamSample032();
...
public void test_finalizeSample032() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample032() {
System.gc();
}

public void test_direct_management_of_connectionsSample032() {
try {
...
public native void testJNISample032();

public boolean equals(Sample032 obj) { /* BUG */
return true;
}
...
public void test_arraySample032() {
...
public void testRule2Sample032() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample032(Collection<Object> c) {
...
Sample032 other = (Sample032) o;
return (other.name.equals(""));
}

public void process_controlSample032() {
...
public int test_return_finallySample032(File file) {
try {
file.delete();
...
public void assignSample032() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample032() {
...
public void missing_defaultSample032(int x) {
switch (x) {
case 0:
...
public List<String> getASample032() {
return a;
}

public void weakSample032() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
