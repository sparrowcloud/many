...
public class Sample031 extends HttpServlet {
...
String retNullSample031() {
    return null;
}

public BufferedInputStream getInputStreamSample031() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample031() {
    
    String x = retNullSample031();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample031() throws IOException {
BufferedInputStream i = getInputStreamSample031();
...
public void test_finalizeSample031() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample031() {
System.gc();
}

public void test_direct_management_of_connectionsSample031() {
try {
...
public native void testJNISample031();

public boolean equals(Sample031 obj) { /* BUG */
return true;
}
...
public void test_arraySample031() {
...
public void testRule2Sample031() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample031(Collection<Object> c) {
...
Sample031 other = (Sample031) o;
return (other.name.equals(""));
}

public void process_controlSample031() {
...
public int test_return_finallySample031(File file) {
try {
file.delete();
...
public void assignSample031() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample031() {
...
public void missing_defaultSample031(int x) {
switch (x) {
case 0:
...
public List<String> getASample031() {
return a;
}

public void weakSample031() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
