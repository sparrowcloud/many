...
public class Sample214 extends HttpServlet {
...
String retNullSample214() {
    return null;
}

public BufferedInputStream getInputStreamSample214() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample214() {
    
    String x = retNullSample214();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample214() throws IOException {
BufferedInputStream i = getInputStreamSample214();
...
public void test_finalizeSample214() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample214() {
System.gc();
}

public void test_direct_management_of_connectionsSample214() {
try {
...
public native void testJNISample214();

public boolean equals(Sample214 obj) { /* BUG */
return true;
}
...
public void test_arraySample214() {
...
public void testRule2Sample214() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample214(Collection<Object> c) {
...
Sample214 other = (Sample214) o;
return (other.name.equals(""));
}

public void process_controlSample214() {
...
public int test_return_finallySample214(File file) {
try {
file.delete();
...
public void assignSample214() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample214() {
...
public void missing_defaultSample214(int x) {
switch (x) {
case 0:
...
public List<String> getASample214() {
return a;
}

public void weakSample214() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
