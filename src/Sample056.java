...
public class Sample056 extends HttpServlet {
...
String retNullSample056() {
    return null;
}

public BufferedInputStream getInputStreamSample056() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample056() {
    
    String x = retNullSample056();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample056() throws IOException {
BufferedInputStream i = getInputStreamSample056();
...
public void test_finalizeSample056() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample056() {
System.gc();
}

public void test_direct_management_of_connectionsSample056() {
try {
...
public native void testJNISample056();

public boolean equals(Sample056 obj) { /* BUG */
return true;
}
...
public void test_arraySample056() {
...
public void testRule2Sample056() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample056(Collection<Object> c) {
...
Sample056 other = (Sample056) o;
return (other.name.equals(""));
}

public void process_controlSample056() {
...
public int test_return_finallySample056(File file) {
try {
file.delete();
...
public void assignSample056() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample056() {
...
public void missing_defaultSample056(int x) {
switch (x) {
case 0:
...
public List<String> getASample056() {
return a;
}

public void weakSample056() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
