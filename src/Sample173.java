...
String retNullSample173() {
    return null;
}

public BufferedInputStream getInputStreamSample173() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample173() {
    
    String x = retNullSample173();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample173() throws IOException {
BufferedInputStream i = getInputStreamSample173();
...
public void test_finalizeSample173() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample173() {
System.gc();
}

public void test_direct_management_of_connectionsSample173() {
try {
...
public native void testJNISample173();

public boolean equals(Sample173 obj) { /* BUG */
return true;
}
...
public void test_arraySample173() {
...
public void testRule2Sample173() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample173(Collection<Object> c) {
...
Sample173 other = (Sample173) o;
return (other.name.equals(""));
}

public void process_controlSample173() {
...
public int test_return_finallySample173(File file) {
try {
file.delete();
...
public void assignSample173() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample173() {
...
public void missing_defaultSample173(int x) {
switch (x) {
case 0:
...
public List<String> getASample173() {
return a;
}

public void weakSample173() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
