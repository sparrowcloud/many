...
public class Sample070 extends HttpServlet {
...
String retNullSample070() {
    return null;
}

public BufferedInputStream getInputStreamSample070() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample070() {
    
    String x = retNullSample070();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample070() throws IOException {
BufferedInputStream i = getInputStreamSample070();
...
public void test_finalizeSample070() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample070() {
System.gc();
}

public void test_direct_management_of_connectionsSample070() {
try {
...
public native void testJNISample070();

public boolean equals(Sample070 obj) { /* BUG */
return true;
}
...
public void test_arraySample070() {
...
public void testRule2Sample070() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample070(Collection<Object> c) {
...
Sample070 other = (Sample070) o;
return (other.name.equals(""));
}

public void process_controlSample070() {
...
public int test_return_finallySample070(File file) {
try {
file.delete();
...
public void assignSample070() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample070() {
...
public void missing_defaultSample070(int x) {
switch (x) {
case 0:
...
public List<String> getASample070() {
return a;
}

public void weakSample070() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
