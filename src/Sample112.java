...
String retNullSample112() {
    return null;
}

public BufferedInputStream getInputStreamSample112() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample112() {
    
    String x = retNullSample112();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample112() throws IOException {
BufferedInputStream i = getInputStreamSample112();
...
public void test_finalizeSample112() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample112() {
System.gc();
}

public void test_direct_management_of_connectionsSample112() {
try {
...
public native void testJNISample112();

public boolean equals(Sample112 obj) { /* BUG */
return true;
}
...
public void test_arraySample112() {
...
public void testRule2Sample112() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample112(Collection<Object> c) {
...
Sample112 other = (Sample112) o;
return (other.name.equals(""));
}

public void process_controlSample112() {
...
public int test_return_finallySample112(File file) {
try {
file.delete();
...
public void assignSample112() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample112() {
...
public void missing_defaultSample112(int x) {
switch (x) {
case 0:
...
public List<String> getASample112() {
return a;
}

public void weakSample112() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
