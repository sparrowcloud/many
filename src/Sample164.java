...
public class Sample164 extends HttpServlet {
...
String retNullSample164() {
    return null;
}

public BufferedInputStream getInputStreamSample164() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample164() {
    
    String x = retNullSample164();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample164() throws IOException {
BufferedInputStream i = getInputStreamSample164();
...
public void test_finalizeSample164() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample164() {
System.gc();
}

public void test_direct_management_of_connectionsSample164() {
try {
...
public native void testJNISample164();

public boolean equals(Sample164 obj) { /* BUG */
return true;
}
...
public void test_arraySample164() {
...
public void testRule2Sample164() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample164(Collection<Object> c) {
...
Sample164 other = (Sample164) o;
return (other.name.equals(""));
}

public void process_controlSample164() {
...
public int test_return_finallySample164(File file) {
try {
file.delete();
...
public void assignSample164() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample164() {
...
public void missing_defaultSample164(int x) {
switch (x) {
case 0:
...
public List<String> getASample164() {
return a;
}

public void weakSample164() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
