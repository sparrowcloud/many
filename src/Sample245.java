...
public class Sample245 extends HttpServlet {
...
String retNullSample245() {
    return null;
}

public BufferedInputStream getInputStreamSample245() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample245() {
    
    String x = retNullSample245();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample245() throws IOException {
BufferedInputStream i = getInputStreamSample245();
...
public void test_finalizeSample245() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample245() {
System.gc();
}

public void test_direct_management_of_connectionsSample245() {
try {
...
public native void testJNISample245();

public boolean equals(Sample245 obj) { /* BUG */
return true;
}
...
public void test_arraySample245() {
...
public void testRule2Sample245() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample245(Collection<Object> c) {
...
Sample245 other = (Sample245) o;
return (other.name.equals(""));
}

public void process_controlSample245() {
...
public int test_return_finallySample245(File file) {
try {
file.delete();
...
public void assignSample245() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample245() {
...
public void missing_defaultSample245(int x) {
switch (x) {
case 0:
...
public List<String> getASample245() {
return a;
}

public void weakSample245() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
