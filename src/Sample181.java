...
public class Sample181 extends HttpServlet {
...
String retNullSample181() {
    return null;
}

public BufferedInputStream getInputStreamSample181() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample181() {
    
    String x = retNullSample181();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample181() throws IOException {
BufferedInputStream i = getInputStreamSample181();
...
public void test_finalizeSample181() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample181() {
System.gc();
}

public void test_direct_management_of_connectionsSample181() {
try {
...
public native void testJNISample181();

public boolean equals(Sample181 obj) { /* BUG */
return true;
}
...
public void test_arraySample181() {
...
public void testRule2Sample181() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample181(Collection<Object> c) {
...
Sample181 other = (Sample181) o;
return (other.name.equals(""));
}

public void process_controlSample181() {
...
public int test_return_finallySample181(File file) {
try {
file.delete();
...
public void assignSample181() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample181() {
...
public void missing_defaultSample181(int x) {
switch (x) {
case 0:
...
public List<String> getASample181() {
return a;
}

public void weakSample181() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
