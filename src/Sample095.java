...
public class Sample095 extends HttpServlet {
...
String retNullSample095() {
    return null;
}

public BufferedInputStream getInputStreamSample095() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample095() {
    
    String x = retNullSample095();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample095() throws IOException {
BufferedInputStream i = getInputStreamSample095();
...
public void test_finalizeSample095() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample095() {
System.gc();
}

public void test_direct_management_of_connectionsSample095() {
try {
...
public native void testJNISample095();

public boolean equals(Sample095 obj) { /* BUG */
return true;
}
...
public void test_arraySample095() {
...
public void testRule2Sample095() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample095(Collection<Object> c) {
...
Sample095 other = (Sample095) o;
return (other.name.equals(""));
}

public void process_controlSample095() {
...
public int test_return_finallySample095(File file) {
try {
file.delete();
...
public void assignSample095() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample095() {
...
public void missing_defaultSample095(int x) {
switch (x) {
case 0:
...
public List<String> getASample095() {
return a;
}

public void weakSample095() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
