...
public class Sample115 extends HttpServlet {
...
String retNullSample115() {
    return null;
}

public BufferedInputStream getInputStreamSample115() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample115() {
    
    String x = retNullSample115();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample115() throws IOException {
BufferedInputStream i = getInputStreamSample115();
...
public void test_finalizeSample115() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample115() {
System.gc();
}

public void test_direct_management_of_connectionsSample115() {
try {
...
public native void testJNISample115();

public boolean equals(Sample115 obj) { /* BUG */
return true;
}
...
public void test_arraySample115() {
...
public void testRule2Sample115() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample115(Collection<Object> c) {
...
Sample115 other = (Sample115) o;
return (other.name.equals(""));
}

public void process_controlSample115() {
...
public int test_return_finallySample115(File file) {
try {
file.delete();
...
public void assignSample115() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample115() {
...
public void missing_defaultSample115(int x) {
switch (x) {
case 0:
...
public List<String> getASample115() {
return a;
}

public void weakSample115() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
