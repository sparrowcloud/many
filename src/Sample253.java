...
public class Sample253 extends HttpServlet {
...
String retNullSample253() {
    return null;
}

public BufferedInputStream getInputStreamSample253() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample253() {
    
    String x = retNullSample253();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample253() throws IOException {
BufferedInputStream i = getInputStreamSample253();
...
public void test_finalizeSample253() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample253() {
System.gc();
}

public void test_direct_management_of_connectionsSample253() {
try {
...
public native void testJNISample253();

public boolean equals(Sample253 obj) { /* BUG */
return true;
}
...
public void test_arraySample253() {
...
public void testRule2Sample253() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample253(Collection<Object> c) {
...
Sample253 other = (Sample253) o;
return (other.name.equals(""));
}

public void process_controlSample253() {
...
public int test_return_finallySample253(File file) {
try {
file.delete();
...
public void assignSample253() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample253() {
...
public void missing_defaultSample253(int x) {
switch (x) {
case 0:
...
public List<String> getASample253() {
return a;
}

public void weakSample253() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
