...
public class Sample099 extends HttpServlet {
...
String retNullSample099() {
    return null;
}

public BufferedInputStream getInputStreamSample099() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample099() {
    
    String x = retNullSample099();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample099() throws IOException {
BufferedInputStream i = getInputStreamSample099();
...
public void test_finalizeSample099() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample099() {
System.gc();
}

public void test_direct_management_of_connectionsSample099() {
try {
...
public native void testJNISample099();

public boolean equals(Sample099 obj) { /* BUG */
return true;
}
...
public void test_arraySample099() {
...
public void testRule2Sample099() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample099(Collection<Object> c) {
...
Sample099 other = (Sample099) o;
return (other.name.equals(""));
}

public void process_controlSample099() {
...
public int test_return_finallySample099(File file) {
try {
file.delete();
...
public void assignSample099() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample099() {
...
public void missing_defaultSample099(int x) {
switch (x) {
case 0:
...
public List<String> getASample099() {
return a;
}

public void weakSample099() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
