...
String retNullSample126() {
    return null;
}

public BufferedInputStream getInputStreamSample126() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample126() {
    
    String x = retNullSample126();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample126() throws IOException {
BufferedInputStream i = getInputStreamSample126();
...
public void test_finalizeSample126() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample126() {
System.gc();
}

public void test_direct_management_of_connectionsSample126() {
try {
...
public native void testJNISample126();

public boolean equals(Sample126 obj) { /* BUG */
return true;
}
...
public void test_arraySample126() {
...
public void testRule2Sample126() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample126(Collection<Object> c) {
...
Sample126 other = (Sample126) o;
return (other.name.equals(""));
}

public void process_controlSample126() {
...
public int test_return_finallySample126(File file) {
try {
file.delete();
...
public void assignSample126() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample126() {
...
public void missing_defaultSample126(int x) {
switch (x) {
case 0:
...
public List<String> getASample126() {
return a;
}

public void weakSample126() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
