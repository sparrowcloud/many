...
public class Sample163 extends HttpServlet {
...
String retNullSample163() {
    return null;
}

public BufferedInputStream getInputStreamSample163() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample163() {
    
    String x = retNullSample163();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample163() throws IOException {
BufferedInputStream i = getInputStreamSample163();
...
public void test_finalizeSample163() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample163() {
System.gc();
}

public void test_direct_management_of_connectionsSample163() {
try {
...
public native void testJNISample163();

public boolean equals(Sample163 obj) { /* BUG */
return true;
}
...
public void test_arraySample163() {
...
public void testRule2Sample163() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample163(Collection<Object> c) {
...
Sample163 other = (Sample163) o;
return (other.name.equals(""));
}

public void process_controlSample163() {
...
public int test_return_finallySample163(File file) {
try {
file.delete();
...
public void assignSample163() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample163() {
...
public void missing_defaultSample163(int x) {
switch (x) {
case 0:
...
public List<String> getASample163() {
return a;
}

public void weakSample163() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
