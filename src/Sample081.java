...
public class Sample081 extends HttpServlet {
...
String retNullSample081() {
    return null;
}

public BufferedInputStream getInputStreamSample081() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample081() {
    
    String x = retNullSample081();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample081() throws IOException {
BufferedInputStream i = getInputStreamSample081();
...
public void test_finalizeSample081() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample081() {
System.gc();
}

public void test_direct_management_of_connectionsSample081() {
try {
...
public native void testJNISample081();

public boolean equals(Sample081 obj) { /* BUG */
return true;
}
...
public void test_arraySample081() {
...
public void testRule2Sample081() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample081(Collection<Object> c) {
...
Sample081 other = (Sample081) o;
return (other.name.equals(""));
}

public void process_controlSample081() {
...
public int test_return_finallySample081(File file) {
try {
file.delete();
...
public void assignSample081() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample081() {
...
public void missing_defaultSample081(int x) {
switch (x) {
case 0:
...
public List<String> getASample081() {
return a;
}

public void weakSample081() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
