...
public class Sample089 extends HttpServlet {
...
String retNullSample089() {
    return null;
}

public BufferedInputStream getInputStreamSample089() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample089() {
    
    String x = retNullSample089();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample089() throws IOException {
BufferedInputStream i = getInputStreamSample089();
...
public void test_finalizeSample089() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample089() {
System.gc();
}

public void test_direct_management_of_connectionsSample089() {
try {
...
public native void testJNISample089();

public boolean equals(Sample089 obj) { /* BUG */
return true;
}
...
public void test_arraySample089() {
...
public void testRule2Sample089() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample089(Collection<Object> c) {
...
Sample089 other = (Sample089) o;
return (other.name.equals(""));
}

public void process_controlSample089() {
...
public int test_return_finallySample089(File file) {
try {
file.delete();
...
public void assignSample089() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample089() {
...
public void missing_defaultSample089(int x) {
switch (x) {
case 0:
...
public List<String> getASample089() {
return a;
}

public void weakSample089() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
