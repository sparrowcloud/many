...
public class Sample143 extends HttpServlet {
...
String retNullSample143() {
    return null;
}

public BufferedInputStream getInputStreamSample143() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample143() {
    
    String x = retNullSample143();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample143() throws IOException {
BufferedInputStream i = getInputStreamSample143();
...
public void test_finalizeSample143() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample143() {
System.gc();
}

public void test_direct_management_of_connectionsSample143() {
try {
...
public native void testJNISample143();

public boolean equals(Sample143 obj) { /* BUG */
return true;
}
...
public void test_arraySample143() {
...
public void testRule2Sample143() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample143(Collection<Object> c) {
...
Sample143 other = (Sample143) o;
return (other.name.equals(""));
}

public void process_controlSample143() {
...
public int test_return_finallySample143(File file) {
try {
file.delete();
...
public void assignSample143() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample143() {
...
public void missing_defaultSample143(int x) {
switch (x) {
case 0:
...
public List<String> getASample143() {
return a;
}

public void weakSample143() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
