...
String retNullSample131() {
    return null;
}

public BufferedInputStream getInputStreamSample131() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample131() {
    
    String x = retNullSample131();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample131() throws IOException {
BufferedInputStream i = getInputStreamSample131();
...
public void test_finalizeSample131() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample131() {
System.gc();
}

public void test_direct_management_of_connectionsSample131() {
try {
...
public native void testJNISample131();

public boolean equals(Sample131 obj) { /* BUG */
return true;
}
...
public void test_arraySample131() {
...
public void testRule2Sample131() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample131(Collection<Object> c) {
...
Sample131 other = (Sample131) o;
return (other.name.equals(""));
}

public void process_controlSample131() {
...
public int test_return_finallySample131(File file) {
try {
file.delete();
...
public void assignSample131() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample131() {
...
public void missing_defaultSample131(int x) {
switch (x) {
case 0:
...
public List<String> getASample131() {
return a;
}

public void weakSample131() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
