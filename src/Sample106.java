...
String retNullSample106() {
    return null;
}

public BufferedInputStream getInputStreamSample106() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample106() {
    
    String x = retNullSample106();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample106() throws IOException {
BufferedInputStream i = getInputStreamSample106();
...
public void test_finalizeSample106() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample106() {
System.gc();
}

public void test_direct_management_of_connectionsSample106() {
try {
...
public native void testJNISample106();

public boolean equals(Sample106 obj) { /* BUG */
return true;
}
...
public void test_arraySample106() {
...
public void testRule2Sample106() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample106(Collection<Object> c) {
...
Sample106 other = (Sample106) o;
return (other.name.equals(""));
}

public void process_controlSample106() {
...
public int test_return_finallySample106(File file) {
try {
file.delete();
...
public void assignSample106() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample106() {
...
public void missing_defaultSample106(int x) {
switch (x) {
case 0:
...
public List<String> getASample106() {
return a;
}

public void weakSample106() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
