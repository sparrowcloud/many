...
String retNullSample018() {
    return null;
}

public BufferedInputStream getInputStreamSample018() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample018() {
    
    String x = retNullSample018();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample018() throws IOException {
BufferedInputStream i = getInputStreamSample018();
...
public void test_finalizeSample018() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample018() {
System.gc();
}

public void test_direct_management_of_connectionsSample018() {
try {
...
public native void testJNISample018();

public boolean equals(Sample018 obj) { /* BUG */
return true;
}
...
public void test_arraySample018() {
...
public void testRule2Sample018() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample018(Collection<Object> c) {
...
Sample018 other = (Sample018) o;
return (other.name.equals(""));
}

public void process_controlSample018() {
...
public int test_return_finallySample018(File file) {
try {
file.delete();
...
public void assignSample018() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample018() {
...
public void missing_defaultSample018(int x) {
switch (x) {
case 0:
...
public List<String> getASample018() {
return a;
}

public void weakSample018() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
