...
public class Sample183 extends HttpServlet {
...
String retNullSample183() {
    return null;
}

public BufferedInputStream getInputStreamSample183() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample183() {
    
    String x = retNullSample183();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample183() throws IOException {
BufferedInputStream i = getInputStreamSample183();
...
public void test_finalizeSample183() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample183() {
System.gc();
}

public void test_direct_management_of_connectionsSample183() {
try {
...
public native void testJNISample183();

public boolean equals(Sample183 obj) { /* BUG */
return true;
}
...
public void test_arraySample183() {
...
public void testRule2Sample183() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample183(Collection<Object> c) {
...
Sample183 other = (Sample183) o;
return (other.name.equals(""));
}

public void process_controlSample183() {
...
public int test_return_finallySample183(File file) {
try {
file.delete();
...
public void assignSample183() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample183() {
...
public void missing_defaultSample183(int x) {
switch (x) {
case 0:
...
public List<String> getASample183() {
return a;
}

public void weakSample183() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
