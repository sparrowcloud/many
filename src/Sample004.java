...
public class Sample004{
    ...
    String retNullSample004() {
        return null;
    }

    public BufferedInputStream getInputStreamSample004() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample004() {

        String x = retNullSample004();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample004() throws IOException {
        BufferedInputStream i = getInputStreamSample004();
    ...
    public void test_finalizeSample004() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample004() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample004() {
        try {
    ...
    public native void testJNISample004();

    public boolean equals(Sample004 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample004() {
    ...
    public void testRule2Sample004() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample004(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample004 other = (Sample004) o;
        return (other.name.equals(""));
    }

    public void process_controlSample004() {
    ...
    public int test_return_finallySample004(File file) {
        try {
            file.delete();
    ...
    public void assignSample004() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample004() {
    ...
    public void missing_defaultSample004(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample004() {
        return a;
    }

    public void weakSample004() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
