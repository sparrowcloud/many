...
public class Sample186 extends HttpServlet {
...
String retNullSample186() {
    return null;
}

public BufferedInputStream getInputStreamSample186() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample186() {
    
    String x = retNullSample186();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample186() throws IOException {
BufferedInputStream i = getInputStreamSample186();
...
public void test_finalizeSample186() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample186() {
System.gc();
}

public void test_direct_management_of_connectionsSample186() {
try {
...
public native void testJNISample186();

public boolean equals(Sample186 obj) { /* BUG */
return true;
}
...
public void test_arraySample186() {
...
public void testRule2Sample186() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample186(Collection<Object> c) {
...
Sample186 other = (Sample186) o;
return (other.name.equals(""));
}

public void process_controlSample186() {
...
public int test_return_finallySample186(File file) {
try {
file.delete();
...
public void assignSample186() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample186() {
...
public void missing_defaultSample186(int x) {
switch (x) {
case 0:
...
public List<String> getASample186() {
return a;
}

public void weakSample186() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
