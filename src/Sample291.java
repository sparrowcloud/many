...
public class Sample291 extends HttpServlet {
...
String retNullSample291() {
    return null;
}

public BufferedInputStream getInputStreamSample291() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample291() {
    
    String x = retNullSample291();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample291() throws IOException {
BufferedInputStream i = getInputStreamSample291();
...
public void test_finalizeSample291() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample291() {
System.gc();
}

public void test_direct_management_of_connectionsSample291() {
try {
...
public native void testJNISample291();

public boolean equals(Sample291 obj) { /* BUG */
return true;
}
...
public void test_arraySample291() {
...
public void testRule2Sample291() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample291(Collection<Object> c) {
...
Sample291 other = (Sample291) o;
return (other.name.equals(""));
}

public void process_controlSample291() {
...
public int test_return_finallySample291(File file) {
try {
file.delete();
...
public void assignSample291() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample291() {
...
public void missing_defaultSample291(int x) {
switch (x) {
case 0:
...
public List<String> getASample291() {
return a;
}

public void weakSample291() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
