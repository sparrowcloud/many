...
public class Sample261 extends HttpServlet {
...
String retNullSample261() {
    return null;
}

public BufferedInputStream getInputStreamSample261() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample261() {
    
    String x = retNullSample261();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample261() throws IOException {
BufferedInputStream i = getInputStreamSample261();
...
public void test_finalizeSample261() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample261() {
System.gc();
}

public void test_direct_management_of_connectionsSample261() {
try {
...
public native void testJNISample261();

public boolean equals(Sample261 obj) { /* BUG */
return true;
}
...
public void test_arraySample261() {
...
public void testRule2Sample261() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample261(Collection<Object> c) {
...
Sample261 other = (Sample261) o;
return (other.name.equals(""));
}

public void process_controlSample261() {
...
public int test_return_finallySample261(File file) {
try {
file.delete();
...
public void assignSample261() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample261() {
...
public void missing_defaultSample261(int x) {
switch (x) {
case 0:
...
public List<String> getASample261() {
return a;
}

public void weakSample261() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
