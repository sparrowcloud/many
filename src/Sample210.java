...
public class Sample210 extends HttpServlet {
...
String retNullSample210() {
    return null;
}

public BufferedInputStream getInputStreamSample210() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample210() {
    
    String x = retNullSample210();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample210() throws IOException {
BufferedInputStream i = getInputStreamSample210();
...
public void test_finalizeSample210() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample210() {
System.gc();
}

public void test_direct_management_of_connectionsSample210() {
try {
...
public native void testJNISample210();

public boolean equals(Sample210 obj) { /* BUG */
return true;
}
...
public void test_arraySample210() {
...
public void testRule2Sample210() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample210(Collection<Object> c) {
...
Sample210 other = (Sample210) o;
return (other.name.equals(""));
}

public void process_controlSample210() {
...
public int test_return_finallySample210(File file) {
try {
file.delete();
...
public void assignSample210() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample210() {
...
public void missing_defaultSample210(int x) {
switch (x) {
case 0:
...
public List<String> getASample210() {
return a;
}

public void weakSample210() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
