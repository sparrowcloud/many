...
public class Sample288 extends HttpServlet {
...
String retNullSample288() {
    return null;
}

public BufferedInputStream getInputStreamSample288() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample288() {
    
    String x = retNullSample288();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample288() throws IOException {
BufferedInputStream i = getInputStreamSample288();
...
public void test_finalizeSample288() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample288() {
System.gc();
}

public void test_direct_management_of_connectionsSample288() {
try {
...
public native void testJNISample288();

public boolean equals(Sample288 obj) { /* BUG */
return true;
}
...
public void test_arraySample288() {
...
public void testRule2Sample288() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample288(Collection<Object> c) {
...
Sample288 other = (Sample288) o;
return (other.name.equals(""));
}

public void process_controlSample288() {
...
public int test_return_finallySample288(File file) {
try {
file.delete();
...
public void assignSample288() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample288() {
...
public void missing_defaultSample288(int x) {
switch (x) {
case 0:
...
public List<String> getASample288() {
return a;
}

public void weakSample288() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
