...
public class Sample251 extends HttpServlet {
...
String retNullSample251() {
    return null;
}

public BufferedInputStream getInputStreamSample251() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample251() {
    
    String x = retNullSample251();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample251() throws IOException {
BufferedInputStream i = getInputStreamSample251();
...
public void test_finalizeSample251() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample251() {
System.gc();
}

public void test_direct_management_of_connectionsSample251() {
try {
...
public native void testJNISample251();

public boolean equals(Sample251 obj) { /* BUG */
return true;
}
...
public void test_arraySample251() {
...
public void testRule2Sample251() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample251(Collection<Object> c) {
...
Sample251 other = (Sample251) o;
return (other.name.equals(""));
}

public void process_controlSample251() {
...
public int test_return_finallySample251(File file) {
try {
file.delete();
...
public void assignSample251() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample251() {
...
public void missing_defaultSample251(int x) {
switch (x) {
case 0:
...
public List<String> getASample251() {
return a;
}

public void weakSample251() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
