...
public class Sample142 extends HttpServlet {
...
String retNullSample142() {
    return null;
}

public BufferedInputStream getInputStreamSample142() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample142() {
    
    String x = retNullSample142();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample142() throws IOException {
BufferedInputStream i = getInputStreamSample142();
...
public void test_finalizeSample142() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample142() {
System.gc();
}

public void test_direct_management_of_connectionsSample142() {
try {
...
public native void testJNISample142();

public boolean equals(Sample142 obj) { /* BUG */
return true;
}
...
public void test_arraySample142() {
...
public void testRule2Sample142() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample142(Collection<Object> c) {
...
Sample142 other = (Sample142) o;
return (other.name.equals(""));
}

public void process_controlSample142() {
...
public int test_return_finallySample142(File file) {
try {
file.delete();
...
public void assignSample142() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample142() {
...
public void missing_defaultSample142(int x) {
switch (x) {
case 0:
...
public List<String> getASample142() {
return a;
}

public void weakSample142() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
