...
public class Sample194 extends HttpServlet {
...
String retNullSample194() {
    return null;
}

public BufferedInputStream getInputStreamSample194() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample194() {
    
    String x = retNullSample194();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample194() throws IOException {
BufferedInputStream i = getInputStreamSample194();
...
public void test_finalizeSample194() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample194() {
System.gc();
}

public void test_direct_management_of_connectionsSample194() {
try {
...
public native void testJNISample194();

public boolean equals(Sample194 obj) { /* BUG */
return true;
}
...
public void test_arraySample194() {
...
public void testRule2Sample194() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample194(Collection<Object> c) {
...
Sample194 other = (Sample194) o;
return (other.name.equals(""));
}

public void process_controlSample194() {
...
public int test_return_finallySample194(File file) {
try {
file.delete();
...
public void assignSample194() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample194() {
...
public void missing_defaultSample194(int x) {
switch (x) {
case 0:
...
public List<String> getASample194() {
return a;
}

public void weakSample194() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
