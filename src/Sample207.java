...
public class Sample207 extends HttpServlet {
...
String retNullSample207() {
    return null;
}

public BufferedInputStream getInputStreamSample207() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample207() {
    
    String x = retNullSample207();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample207() throws IOException {
BufferedInputStream i = getInputStreamSample207();
...
public void test_finalizeSample207() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample207() {
System.gc();
}

public void test_direct_management_of_connectionsSample207() {
try {
...
public native void testJNISample207();

public boolean equals(Sample207 obj) { /* BUG */
return true;
}
...
public void test_arraySample207() {
...
public void testRule2Sample207() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample207(Collection<Object> c) {
...
Sample207 other = (Sample207) o;
return (other.name.equals(""));
}

public void process_controlSample207() {
...
public int test_return_finallySample207(File file) {
try {
file.delete();
...
public void assignSample207() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample207() {
...
public void missing_defaultSample207(int x) {
switch (x) {
case 0:
...
public List<String> getASample207() {
return a;
}

public void weakSample207() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
