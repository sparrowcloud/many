...
String retNullSample092() {
    return null;
}

public BufferedInputStream getInputStreamSample092() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample092() {
    
    String x = retNullSample092();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample092() throws IOException {
BufferedInputStream i = getInputStreamSample092();
...
public void test_finalizeSample092() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample092() {
System.gc();
}

public void test_direct_management_of_connectionsSample092() {
try {
...
public native void testJNISample092();

public boolean equals(Sample092 obj) { /* BUG */
return true;
}
...
public void test_arraySample092() {
...
public void testRule2Sample092() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample092(Collection<Object> c) {
...
Sample092 other = (Sample092) o;
return (other.name.equals(""));
}

public void process_controlSample092() {
...
public int test_return_finallySample092(File file) {
try {
file.delete();
...
public void assignSample092() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample092() {
...
public void missing_defaultSample092(int x) {
switch (x) {
case 0:
...
public List<String> getASample092() {
return a;
}

public void weakSample092() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
