...
public class Sample258 extends HttpServlet {
...
String retNullSample258() {
    return null;
}

public BufferedInputStream getInputStreamSample258() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample258() {
    
    String x = retNullSample258();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample258() throws IOException {
BufferedInputStream i = getInputStreamSample258();
...
public void test_finalizeSample258() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample258() {
System.gc();
}

public void test_direct_management_of_connectionsSample258() {
try {
...
public native void testJNISample258();

public boolean equals(Sample258 obj) { /* BUG */
return true;
}
...
public void test_arraySample258() {
...
public void testRule2Sample258() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample258(Collection<Object> c) {
...
Sample258 other = (Sample258) o;
return (other.name.equals(""));
}

public void process_controlSample258() {
...
public int test_return_finallySample258(File file) {
try {
file.delete();
...
public void assignSample258() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample258() {
...
public void missing_defaultSample258(int x) {
switch (x) {
case 0:
...
public List<String> getASample258() {
return a;
}

public void weakSample258() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
