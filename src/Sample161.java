...
public class Sample161 extends HttpServlet {
...
String retNullSample161() {
    return null;
}

public BufferedInputStream getInputStreamSample161() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample161() {
    
    String x = retNullSample161();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample161() throws IOException {
BufferedInputStream i = getInputStreamSample161();
...
public void test_finalizeSample161() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample161() {
System.gc();
}

public void test_direct_management_of_connectionsSample161() {
try {
...
public native void testJNISample161();

public boolean equals(Sample161 obj) { /* BUG */
return true;
}
...
public void test_arraySample161() {
...
public void testRule2Sample161() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample161(Collection<Object> c) {
...
Sample161 other = (Sample161) o;
return (other.name.equals(""));
}

public void process_controlSample161() {
...
public int test_return_finallySample161(File file) {
try {
file.delete();
...
public void assignSample161() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample161() {
...
public void missing_defaultSample161(int x) {
switch (x) {
case 0:
...
public List<String> getASample161() {
return a;
}

public void weakSample161() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
