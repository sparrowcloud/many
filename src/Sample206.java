...
public class Sample206 extends HttpServlet {
...
String retNullSample206() {
    return null;
}

public BufferedInputStream getInputStreamSample206() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample206() {
    
    String x = retNullSample206();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample206() throws IOException {
BufferedInputStream i = getInputStreamSample206();
...
public void test_finalizeSample206() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample206() {
System.gc();
}

public void test_direct_management_of_connectionsSample206() {
try {
...
public native void testJNISample206();

public boolean equals(Sample206 obj) { /* BUG */
return true;
}
...
public void test_arraySample206() {
...
public void testRule2Sample206() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample206(Collection<Object> c) {
...
Sample206 other = (Sample206) o;
return (other.name.equals(""));
}

public void process_controlSample206() {
...
public int test_return_finallySample206(File file) {
try {
file.delete();
...
public void assignSample206() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample206() {
...
public void missing_defaultSample206(int x) {
switch (x) {
case 0:
...
public List<String> getASample206() {
return a;
}

public void weakSample206() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
