...
public class Sample145 extends HttpServlet {
...
String retNullSample145() {
    return null;
}

public BufferedInputStream getInputStreamSample145() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample145() {
    
    String x = retNullSample145();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample145() throws IOException {
BufferedInputStream i = getInputStreamSample145();
...
public void test_finalizeSample145() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample145() {
System.gc();
}

public void test_direct_management_of_connectionsSample145() {
try {
...
public native void testJNISample145();

public boolean equals(Sample145 obj) { /* BUG */
return true;
}
...
public void test_arraySample145() {
...
public void testRule2Sample145() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample145(Collection<Object> c) {
...
Sample145 other = (Sample145) o;
return (other.name.equals(""));
}

public void process_controlSample145() {
...
public int test_return_finallySample145(File file) {
try {
file.delete();
...
public void assignSample145() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample145() {
...
public void missing_defaultSample145(int x) {
switch (x) {
case 0:
...
public List<String> getASample145() {
return a;
}

public void weakSample145() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
