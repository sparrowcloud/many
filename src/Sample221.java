...
public class Sample221 extends HttpServlet {
...
String retNullSample221() {
    return null;
}

public BufferedInputStream getInputStreamSample221() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample221() {
    
    String x = retNullSample221();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample221() throws IOException {
BufferedInputStream i = getInputStreamSample221();
...
public void test_finalizeSample221() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample221() {
System.gc();
}

public void test_direct_management_of_connectionsSample221() {
try {
...
public native void testJNISample221();

public boolean equals(Sample221 obj) { /* BUG */
return true;
}
...
public void test_arraySample221() {
...
public void testRule2Sample221() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample221(Collection<Object> c) {
...
Sample221 other = (Sample221) o;
return (other.name.equals(""));
}

public void process_controlSample221() {
...
public int test_return_finallySample221(File file) {
try {
file.delete();
...
public void assignSample221() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample221() {
...
public void missing_defaultSample221(int x) {
switch (x) {
case 0:
...
public List<String> getASample221() {
return a;
}

public void weakSample221() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
