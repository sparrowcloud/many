...
String retNullSample125() {
    return null;
}

public BufferedInputStream getInputStreamSample125() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample125() {
    
    String x = retNullSample125();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample125() throws IOException {
BufferedInputStream i = getInputStreamSample125();
...
public void test_finalizeSample125() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample125() {
System.gc();
}

public void test_direct_management_of_connectionsSample125() {
try {
...
public native void testJNISample125();

public boolean equals(Sample125 obj) { /* BUG */
return true;
}
...
public void test_arraySample125() {
...
public void testRule2Sample125() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample125(Collection<Object> c) {
...
Sample125 other = (Sample125) o;
return (other.name.equals(""));
}

public void process_controlSample125() {
...
public int test_return_finallySample125(File file) {
try {
file.delete();
...
public void assignSample125() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample125() {
...
public void missing_defaultSample125(int x) {
switch (x) {
case 0:
...
public List<String> getASample125() {
return a;
}

public void weakSample125() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
