...
public class Sample086{
    ...
    String retNullSample086() {
        return null;
    }

    public BufferedInputStream getInputStreamSample086() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample086() {

        String x = retNullSample086();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample086() throws IOException {
        BufferedInputStream i = getInputStreamSample086();
    ...
    public void test_finalizeSample086() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample086() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample086() {
        try {
    ...
    public native void testJNISample086();

    public boolean equals(Sample086 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample086() {
    ...
    public void testRule2Sample086() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample086(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample086 other = (Sample086) o;
        return (other.name.equals(""));
    }

    public void process_controlSample086() {
    ...
    public int test_return_finallySample086(File file) {
        try {
            file.delete();
    ...
    public void assignSample086() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample086() {
    ...
    public void missing_defaultSample086(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample086() {
        return a;
    }

    public void weakSample086() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
