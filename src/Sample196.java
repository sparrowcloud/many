...
public class Sample196 extends HttpServlet {
...
String retNullSample196() {
    return null;
}

public BufferedInputStream getInputStreamSample196() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample196() {
    
    String x = retNullSample196();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample196() throws IOException {
BufferedInputStream i = getInputStreamSample196();
...
public void test_finalizeSample196() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample196() {
System.gc();
}

public void test_direct_management_of_connectionsSample196() {
try {
...
public native void testJNISample196();

public boolean equals(Sample196 obj) { /* BUG */
return true;
}
...
public void test_arraySample196() {
...
public void testRule2Sample196() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample196(Collection<Object> c) {
...
Sample196 other = (Sample196) o;
return (other.name.equals(""));
}

public void process_controlSample196() {
...
public int test_return_finallySample196(File file) {
try {
file.delete();
...
public void assignSample196() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample196() {
...
public void missing_defaultSample196(int x) {
switch (x) {
case 0:
...
public List<String> getASample196() {
return a;
}

public void weakSample196() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
