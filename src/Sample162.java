...
public class Sample162 extends HttpServlet {
...
String retNullSample162() {
    return null;
}

public BufferedInputStream getInputStreamSample162() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample162() {
    
    String x = retNullSample162();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample162() throws IOException {
BufferedInputStream i = getInputStreamSample162();
...
public void test_finalizeSample162() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample162() {
System.gc();
}

public void test_direct_management_of_connectionsSample162() {
try {
...
public native void testJNISample162();

public boolean equals(Sample162 obj) { /* BUG */
return true;
}
...
public void test_arraySample162() {
...
public void testRule2Sample162() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample162(Collection<Object> c) {
...
Sample162 other = (Sample162) o;
return (other.name.equals(""));
}

public void process_controlSample162() {
...
public int test_return_finallySample162(File file) {
try {
file.delete();
...
public void assignSample162() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample162() {
...
public void missing_defaultSample162(int x) {
switch (x) {
case 0:
...
public List<String> getASample162() {
return a;
}

public void weakSample162() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
