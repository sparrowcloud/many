...
String retNullSample133() {
    return null;
}

public BufferedInputStream getInputStreamSample133() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample133() {
    
    String x = retNullSample133();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample133() throws IOException {
BufferedInputStream i = getInputStreamSample133();
...
public void test_finalizeSample133() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample133() {
System.gc();
}

public void test_direct_management_of_connectionsSample133() {
try {
...
public native void testJNISample133();

public boolean equals(Sample133 obj) { /* BUG */
return true;
}
...
public void test_arraySample133() {
...
public void testRule2Sample133() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample133(Collection<Object> c) {
...
Sample133 other = (Sample133) o;
return (other.name.equals(""));
}

public void process_controlSample133() {
...
public int test_return_finallySample133(File file) {
try {
file.delete();
...
public void assignSample133() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample133() {
...
public void missing_defaultSample133(int x) {
switch (x) {
case 0:
...
public List<String> getASample133() {
return a;
}

public void weakSample133() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
