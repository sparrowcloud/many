...
public class Sample190 extends HttpServlet {
...
String retNullSample190() {
    return null;
}

public BufferedInputStream getInputStreamSample190() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample190() {
    
    String x = retNullSample190();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample190() throws IOException {
BufferedInputStream i = getInputStreamSample190();
...
public void test_finalizeSample190() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample190() {
System.gc();
}

public void test_direct_management_of_connectionsSample190() {
try {
...
public native void testJNISample190();

public boolean equals(Sample190 obj) { /* BUG */
return true;
}
...
public void test_arraySample190() {
...
public void testRule2Sample190() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample190(Collection<Object> c) {
...
Sample190 other = (Sample190) o;
return (other.name.equals(""));
}

public void process_controlSample190() {
...
public int test_return_finallySample190(File file) {
try {
file.delete();
...
public void assignSample190() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample190() {
...
public void missing_defaultSample190(int x) {
switch (x) {
case 0:
...
public List<String> getASample190() {
return a;
}

public void weakSample190() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
