...
String retNullSample150() {
    return null;
}

public BufferedInputStream getInputStreamSample150() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample150() {
    
    String x = retNullSample150();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample150() throws IOException {
BufferedInputStream i = getInputStreamSample150();
...
public void test_finalizeSample150() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample150() {
System.gc();
}

public void test_direct_management_of_connectionsSample150() {
try {
...
public native void testJNISample150();

public boolean equals(Sample150 obj) { /* BUG */
return true;
}
...
public void test_arraySample150() {
...
public void testRule2Sample150() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample150(Collection<Object> c) {
...
Sample150 other = (Sample150) o;
return (other.name.equals(""));
}

public void process_controlSample150() {
...
public int test_return_finallySample150(File file) {
try {
file.delete();
...
public void assignSample150() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample150() {
...
public void missing_defaultSample150(int x) {
switch (x) {
case 0:
...
public List<String> getASample150() {
return a;
}

public void weakSample150() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
