...
public class Sample009 extends HttpServlet {
...
String retNullSample009() {
    return null;
}

public BufferedInputStream getInputStreamSample009() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample009() {
    
    String x = retNullSample009();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample009() throws IOException {
BufferedInputStream i = getInputStreamSample009();
...
public void test_finalizeSample009() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample009() {
System.gc();
}

public void test_direct_management_of_connectionsSample009() {
try {
...
public native void testJNISample009();

public boolean equals(Sample009 obj) { /* BUG */
return true;
}
...
public void test_arraySample009() {
...
public void testRule2Sample009() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample009(Collection<Object> c) {
...
Sample009 other = (Sample009) o;
return (other.name.equals(""));
}

public void process_controlSample009() {
...
public int test_return_finallySample009(File file) {
try {
file.delete();
...
public void assignSample009() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample009() {
...
public void missing_defaultSample009(int x) {
switch (x) {
case 0:
...
public List<String> getASample009() {
return a;
}

public void weakSample009() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
