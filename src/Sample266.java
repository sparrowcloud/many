...
public class Sample266 extends HttpServlet {
...
String retNullSample266() {
    return null;
}

public BufferedInputStream getInputStreamSample266() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample266() {
    
    String x = retNullSample266();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample266() throws IOException {
BufferedInputStream i = getInputStreamSample266();
...
public void test_finalizeSample266() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample266() {
System.gc();
}

public void test_direct_management_of_connectionsSample266() {
try {
...
public native void testJNISample266();

public boolean equals(Sample266 obj) { /* BUG */
return true;
}
...
public void test_arraySample266() {
...
public void testRule2Sample266() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample266(Collection<Object> c) {
...
Sample266 other = (Sample266) o;
return (other.name.equals(""));
}

public void process_controlSample266() {
...
public int test_return_finallySample266(File file) {
try {
file.delete();
...
public void assignSample266() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample266() {
...
public void missing_defaultSample266(int x) {
switch (x) {
case 0:
...
public List<String> getASample266() {
return a;
}

public void weakSample266() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
