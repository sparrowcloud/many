...
public class Sample113 extends HttpServlet {
...
String retNullSample113() {
    return null;
}

public BufferedInputStream getInputStreamSample113() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample113() {
    
    String x = retNullSample113();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample113() throws IOException {
BufferedInputStream i = getInputStreamSample113();
...
public void test_finalizeSample113() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample113() {
System.gc();
}

public void test_direct_management_of_connectionsSample113() {
try {
...
public native void testJNISample113();

public boolean equals(Sample113 obj) { /* BUG */
return true;
}
...
public void test_arraySample113() {
...
public void testRule2Sample113() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample113(Collection<Object> c) {
...
Sample113 other = (Sample113) o;
return (other.name.equals(""));
}

public void process_controlSample113() {
...
public int test_return_finallySample113(File file) {
try {
file.delete();
...
public void assignSample113() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample113() {
...
public void missing_defaultSample113(int x) {
switch (x) {
case 0:
...
public List<String> getASample113() {
return a;
}

public void weakSample113() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
