...
public class Sample138 extends HttpServlet {
...
String retNullSample138() {
    return null;
}

public BufferedInputStream getInputStreamSample138() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample138() {
    
    String x = retNullSample138();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample138() throws IOException {
BufferedInputStream i = getInputStreamSample138();
...
public void test_finalizeSample138() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample138() {
System.gc();
}

public void test_direct_management_of_connectionsSample138() {
try {
...
public native void testJNISample138();

public boolean equals(Sample138 obj) { /* BUG */
return true;
}
...
public void test_arraySample138() {
...
public void testRule2Sample138() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample138(Collection<Object> c) {
...
Sample138 other = (Sample138) o;
return (other.name.equals(""));
}

public void process_controlSample138() {
...
public int test_return_finallySample138(File file) {
try {
file.delete();
...
public void assignSample138() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample138() {
...
public void missing_defaultSample138(int x) {
switch (x) {
case 0:
...
public List<String> getASample138() {
return a;
}

public void weakSample138() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
