...
public class Sample229 extends HttpServlet {
...
String retNullSample229() {
    return null;
}

public BufferedInputStream getInputStreamSample229() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample229() {
    
    String x = retNullSample229();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample229() throws IOException {
BufferedInputStream i = getInputStreamSample229();
...
public void test_finalizeSample229() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample229() {
System.gc();
}

public void test_direct_management_of_connectionsSample229() {
try {
...
public native void testJNISample229();

public boolean equals(Sample229 obj) { /* BUG */
return true;
}
...
public void test_arraySample229() {
...
public void testRule2Sample229() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample229(Collection<Object> c) {
...
Sample229 other = (Sample229) o;
return (other.name.equals(""));
}

public void process_controlSample229() {
...
public int test_return_finallySample229(File file) {
try {
file.delete();
...
public void assignSample229() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample229() {
...
public void missing_defaultSample229(int x) {
switch (x) {
case 0:
...
public List<String> getASample229() {
return a;
}

public void weakSample229() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
