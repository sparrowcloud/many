...
public class Sample176 extends HttpServlet {
...
String retNullSample176() {
    return null;
}

public BufferedInputStream getInputStreamSample176() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample176() {
    
    String x = retNullSample176();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample176() throws IOException {
BufferedInputStream i = getInputStreamSample176();
...
public void test_finalizeSample176() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample176() {
System.gc();
}

public void test_direct_management_of_connectionsSample176() {
try {
...
public native void testJNISample176();

public boolean equals(Sample176 obj) { /* BUG */
return true;
}
...
public void test_arraySample176() {
...
public void testRule2Sample176() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample176(Collection<Object> c) {
...
Sample176 other = (Sample176) o;
return (other.name.equals(""));
}

public void process_controlSample176() {
...
public int test_return_finallySample176(File file) {
try {
file.delete();
...
public void assignSample176() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample176() {
...
public void missing_defaultSample176(int x) {
switch (x) {
case 0:
...
public List<String> getASample176() {
return a;
}

public void weakSample176() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
