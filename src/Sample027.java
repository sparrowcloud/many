...
String retNullSample027() {
    return null;
}

public BufferedInputStream getInputStreamSample027() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample027() {
    
    String x = retNullSample027();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample027() throws IOException {
BufferedInputStream i = getInputStreamSample027();
...
public void test_finalizeSample027() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample027() {
System.gc();
}

public void test_direct_management_of_connectionsSample027() {
try {
...
public native void testJNISample027();

public boolean equals(Sample027 obj) { /* BUG */
return true;
}
...
public void test_arraySample027() {
...
public void testRule2Sample027() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample027(Collection<Object> c) {
...
Sample027 other = (Sample027) o;
return (other.name.equals(""));
}

public void process_controlSample027() {
...
public int test_return_finallySample027(File file) {
try {
file.delete();
...
public void assignSample027() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample027() {
...
public void missing_defaultSample027(int x) {
switch (x) {
case 0:
...
public List<String> getASample027() {
return a;
}

public void weakSample027() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
