...
public class Sample172 extends HttpServlet {
...
String retNullSample172() {
    return null;
}

public BufferedInputStream getInputStreamSample172() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample172() {
    
    String x = retNullSample172();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample172() throws IOException {
BufferedInputStream i = getInputStreamSample172();
...
public void test_finalizeSample172() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample172() {
System.gc();
}

public void test_direct_management_of_connectionsSample172() {
try {
...
public native void testJNISample172();

public boolean equals(Sample172 obj) { /* BUG */
return true;
}
...
public void test_arraySample172() {
...
public void testRule2Sample172() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample172(Collection<Object> c) {
...
Sample172 other = (Sample172) o;
return (other.name.equals(""));
}

public void process_controlSample172() {
...
public int test_return_finallySample172(File file) {
try {
file.delete();
...
public void assignSample172() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample172() {
...
public void missing_defaultSample172(int x) {
switch (x) {
case 0:
...
public List<String> getASample172() {
return a;
}

public void weakSample172() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
