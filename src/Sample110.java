...
String retNullSample110() {
    return null;
}

public BufferedInputStream getInputStreamSample110() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample110() {
    
    String x = retNullSample110();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample110() throws IOException {
BufferedInputStream i = getInputStreamSample110();
...
public void test_finalizeSample110() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample110() {
System.gc();
}

public void test_direct_management_of_connectionsSample110() {
try {
...
public native void testJNISample110();

public boolean equals(Sample110 obj) { /* BUG */
return true;
}
...
public void test_arraySample110() {
...
public void testRule2Sample110() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample110(Collection<Object> c) {
...
Sample110 other = (Sample110) o;
return (other.name.equals(""));
}

public void process_controlSample110() {
...
public int test_return_finallySample110(File file) {
try {
file.delete();
...
public void assignSample110() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample110() {
...
public void missing_defaultSample110(int x) {
switch (x) {
case 0:
...
public List<String> getASample110() {
return a;
}

public void weakSample110() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
