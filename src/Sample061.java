...
public class Sample061{
    ...
    String retNullSample061() {
        return null;
    }

    public BufferedInputStream getInputStreamSample061() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample061() {

        String x = retNullSample061();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample061() throws IOException {
        BufferedInputStream i = getInputStreamSample061();
    ...
    public void test_finalizeSample061() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample061() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample061() {
        try {
    ...
    public native void testJNISample061();

    public boolean equals(Sample061 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample061() {
    ...
    public void testRule2Sample061() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample061(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample061 other = (Sample061) o;
        return (other.name.equals(""));
    }

    public void process_controlSample061() {
    ...
    public int test_return_finallySample061(File file) {
        try {
            file.delete();
    ...
    public void assignSample061() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample061() {
    ...
    public void missing_defaultSample061(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample061() {
        return a;
    }

    public void weakSample061() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
