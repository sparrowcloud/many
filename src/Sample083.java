...
public class Sample083{
    ...
    String retNullSample083() {
        return null;
    }

    public BufferedInputStream getInputStreamSample083() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample083() {

        String x = retNullSample083();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample083() throws IOException {
        BufferedInputStream i = getInputStreamSample083();
    ...
    public void test_finalizeSample083() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample083() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample083() {
        try {
    ...
    public native void testJNISample083();

    public boolean equals(Sample083 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample083() {
    ...
    public void testRule2Sample083() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample083(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample083 other = (Sample083) o;
        return (other.name.equals(""));
    }

    public void process_controlSample083() {
    ...
    public int test_return_finallySample083(File file) {
        try {
            file.delete();
    ...
    public void assignSample083() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample083() {
    ...
    public void missing_defaultSample083(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample083() {
        return a;
    }

    public void weakSample083() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
