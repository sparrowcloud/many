...
public class Sample279 extends HttpServlet {
...
String retNullSample279() {
    return null;
}

public BufferedInputStream getInputStreamSample279() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample279() {
    
    String x = retNullSample279();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample279() throws IOException {
BufferedInputStream i = getInputStreamSample279();
...
public void test_finalizeSample279() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample279() {
System.gc();
}

public void test_direct_management_of_connectionsSample279() {
try {
...
public native void testJNISample279();

public boolean equals(Sample279 obj) { /* BUG */
return true;
}
...
public void test_arraySample279() {
...
public void testRule2Sample279() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample279(Collection<Object> c) {
...
Sample279 other = (Sample279) o;
return (other.name.equals(""));
}

public void process_controlSample279() {
...
public int test_return_finallySample279(File file) {
try {
file.delete();
...
public void assignSample279() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample279() {
...
public void missing_defaultSample279(int x) {
switch (x) {
case 0:
...
public List<String> getASample279() {
return a;
}

public void weakSample279() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
