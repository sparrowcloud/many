...
String retNullSample121() {
    return null;
}

public BufferedInputStream getInputStreamSample121() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample121() {
    
    String x = retNullSample121();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample121() throws IOException {
BufferedInputStream i = getInputStreamSample121();
...
public void test_finalizeSample121() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample121() {
System.gc();
}

public void test_direct_management_of_connectionsSample121() {
try {
...
public native void testJNISample121();

public boolean equals(Sample121 obj) { /* BUG */
return true;
}
...
public void test_arraySample121() {
...
public void testRule2Sample121() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample121(Collection<Object> c) {
...
Sample121 other = (Sample121) o;
return (other.name.equals(""));
}

public void process_controlSample121() {
...
public int test_return_finallySample121(File file) {
try {
file.delete();
...
public void assignSample121() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample121() {
...
public void missing_defaultSample121(int x) {
switch (x) {
case 0:
...
public List<String> getASample121() {
return a;
}

public void weakSample121() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
