...
public class Sample249 extends HttpServlet {
...
String retNullSample249() {
    return null;
}

public BufferedInputStream getInputStreamSample249() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample249() {
    
    String x = retNullSample249();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample249() throws IOException {
BufferedInputStream i = getInputStreamSample249();
...
public void test_finalizeSample249() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample249() {
System.gc();
}

public void test_direct_management_of_connectionsSample249() {
try {
...
public native void testJNISample249();

public boolean equals(Sample249 obj) { /* BUG */
return true;
}
...
public void test_arraySample249() {
...
public void testRule2Sample249() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample249(Collection<Object> c) {
...
Sample249 other = (Sample249) o;
return (other.name.equals(""));
}

public void process_controlSample249() {
...
public int test_return_finallySample249(File file) {
try {
file.delete();
...
public void assignSample249() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample249() {
...
public void missing_defaultSample249(int x) {
switch (x) {
case 0:
...
public List<String> getASample249() {
return a;
}

public void weakSample249() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
