...
public class Sample228 extends HttpServlet {
...
String retNullSample228() {
    return null;
}

public BufferedInputStream getInputStreamSample228() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample228() {
    
    String x = retNullSample228();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample228() throws IOException {
BufferedInputStream i = getInputStreamSample228();
...
public void test_finalizeSample228() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample228() {
System.gc();
}

public void test_direct_management_of_connectionsSample228() {
try {
...
public native void testJNISample228();

public boolean equals(Sample228 obj) { /* BUG */
return true;
}
...
public void test_arraySample228() {
...
public void testRule2Sample228() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample228(Collection<Object> c) {
...
Sample228 other = (Sample228) o;
return (other.name.equals(""));
}

public void process_controlSample228() {
...
public int test_return_finallySample228(File file) {
try {
file.delete();
...
public void assignSample228() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample228() {
...
public void missing_defaultSample228(int x) {
switch (x) {
case 0:
...
public List<String> getASample228() {
return a;
}

public void weakSample228() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
