...
public class Sample035 extends HttpServlet {
...
String retNullSample035() {
    return null;
}

public BufferedInputStream getInputStreamSample035() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample035() {
    
    String x = retNullSample035();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample035() throws IOException {
BufferedInputStream i = getInputStreamSample035();
...
public void test_finalizeSample035() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample035() {
System.gc();
}

public void test_direct_management_of_connectionsSample035() {
try {
...
public native void testJNISample035();

public boolean equals(Sample035 obj) { /* BUG */
return true;
}
...
public void test_arraySample035() {
...
public void testRule2Sample035() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample035(Collection<Object> c) {
...
Sample035 other = (Sample035) o;
return (other.name.equals(""));
}

public void process_controlSample035() {
...
public int test_return_finallySample035(File file) {
try {
file.delete();
...
public void assignSample035() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample035() {
...
public void missing_defaultSample035(int x) {
switch (x) {
case 0:
...
public List<String> getASample035() {
return a;
}

public void weakSample035() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
