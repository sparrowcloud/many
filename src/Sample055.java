...
public class Sample055{
    ...
    String retNullSample055() {
        return null;
    }

    public BufferedInputStream getInputStreamSample055() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample055() {

        String x = retNullSample055();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample055() throws IOException {
        BufferedInputStream i = getInputStreamSample055();
    ...
    public void test_finalizeSample055() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample055() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample055() {
        try {
    ...
    public native void testJNISample055();

    public boolean equals(Sample055 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample055() {
    ...
    public void testRule2Sample055() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample055(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample055 other = (Sample055) o;
        return (other.name.equals(""));
    }

    public void process_controlSample055() {
    ...
    public int test_return_finallySample055(File file) {
        try {
            file.delete();
    ...
    public void assignSample055() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample055() {
    ...
    public void missing_defaultSample055(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample055() {
        return a;
    }

    public void weakSample055() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
