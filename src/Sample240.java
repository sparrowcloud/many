...
public class Sample240 extends HttpServlet {
...
String retNullSample240() {
    return null;
}

public BufferedInputStream getInputStreamSample240() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample240() {
    
    String x = retNullSample240();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample240() throws IOException {
BufferedInputStream i = getInputStreamSample240();
...
public void test_finalizeSample240() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample240() {
System.gc();
}

public void test_direct_management_of_connectionsSample240() {
try {
...
public native void testJNISample240();

public boolean equals(Sample240 obj) { /* BUG */
return true;
}
...
public void test_arraySample240() {
...
public void testRule2Sample240() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample240(Collection<Object> c) {
...
Sample240 other = (Sample240) o;
return (other.name.equals(""));
}

public void process_controlSample240() {
...
public int test_return_finallySample240(File file) {
try {
file.delete();
...
public void assignSample240() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample240() {
...
public void missing_defaultSample240(int x) {
switch (x) {
case 0:
...
public List<String> getASample240() {
return a;
}

public void weakSample240() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
