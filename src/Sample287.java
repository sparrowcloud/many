...
public class Sample287 extends HttpServlet {
...
String retNullSample287() {
    return null;
}

public BufferedInputStream getInputStreamSample287() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample287() {
    
    String x = retNullSample287();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample287() throws IOException {
BufferedInputStream i = getInputStreamSample287();
...
public void test_finalizeSample287() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample287() {
System.gc();
}

public void test_direct_management_of_connectionsSample287() {
try {
...
public native void testJNISample287();

public boolean equals(Sample287 obj) { /* BUG */
return true;
}
...
public void test_arraySample287() {
...
public void testRule2Sample287() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample287(Collection<Object> c) {
...
Sample287 other = (Sample287) o;
return (other.name.equals(""));
}

public void process_controlSample287() {
...
public int test_return_finallySample287(File file) {
try {
file.delete();
...
public void assignSample287() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample287() {
...
public void missing_defaultSample287(int x) {
switch (x) {
case 0:
...
public List<String> getASample287() {
return a;
}

public void weakSample287() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
