...
public class Sample262 extends HttpServlet {
...
String retNullSample262() {
    return null;
}

public BufferedInputStream getInputStreamSample262() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample262() {
    
    String x = retNullSample262();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample262() throws IOException {
BufferedInputStream i = getInputStreamSample262();
...
public void test_finalizeSample262() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample262() {
System.gc();
}

public void test_direct_management_of_connectionsSample262() {
try {
...
public native void testJNISample262();

public boolean equals(Sample262 obj) { /* BUG */
return true;
}
...
public void test_arraySample262() {
...
public void testRule2Sample262() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample262(Collection<Object> c) {
...
Sample262 other = (Sample262) o;
return (other.name.equals(""));
}

public void process_controlSample262() {
...
public int test_return_finallySample262(File file) {
try {
file.delete();
...
public void assignSample262() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample262() {
...
public void missing_defaultSample262(int x) {
switch (x) {
case 0:
...
public List<String> getASample262() {
return a;
}

public void weakSample262() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
