...
public class Sample204 extends HttpServlet {
...
String retNullSample204() {
    return null;
}

public BufferedInputStream getInputStreamSample204() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample204() {
    
    String x = retNullSample204();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample204() throws IOException {
BufferedInputStream i = getInputStreamSample204();
...
public void test_finalizeSample204() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample204() {
System.gc();
}

public void test_direct_management_of_connectionsSample204() {
try {
...
public native void testJNISample204();

public boolean equals(Sample204 obj) { /* BUG */
return true;
}
...
public void test_arraySample204() {
...
public void testRule2Sample204() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample204(Collection<Object> c) {
...
Sample204 other = (Sample204) o;
return (other.name.equals(""));
}

public void process_controlSample204() {
...
public int test_return_finallySample204(File file) {
try {
file.delete();
...
public void assignSample204() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample204() {
...
public void missing_defaultSample204(int x) {
switch (x) {
case 0:
...
public List<String> getASample204() {
return a;
}

public void weakSample204() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
