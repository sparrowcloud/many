...
public class Sample15534{
    ...
    void nullDeSample15534() {

        String x = retNullSample15534();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample15534() throws IOException {
        BufferedInputStream i = getInputStreamSample15534();
    ...
    public void test_finalizeSample15534() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample15534() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample15534() {
        try {
    ...
    public native void testJNISample15534();

    public boolean equals(Sample15534 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample15534() {
    ...
    public void testRule2Sample15534() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample15534(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample15534 other = (Sample15534) o;
        return (other.name.equals(""));
    }

    public void process_controlSample15534() {
    ...
    public int test_return_finallySample15534(File file) {
        try {
            file.delete();
    ...
    public void assignSample15534() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample15534() {
    ...
    public void missing_defaultSample15534(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample15534() {
        return a;
    }

    public void weakSample15534() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
