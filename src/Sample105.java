...
public class Sample105 extends HttpServlet {
...
String retNullSample105() {
    return null;
}

public BufferedInputStream getInputStreamSample105() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample105() {
    
    String x = retNullSample105();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample105() throws IOException {
BufferedInputStream i = getInputStreamSample105();
...
public void test_finalizeSample105() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample105() {
System.gc();
}

public void test_direct_management_of_connectionsSample105() {
try {
...
public native void testJNISample105();

public boolean equals(Sample105 obj) { /* BUG */
return true;
}
...
public void test_arraySample105() {
...
public void testRule2Sample105() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample105(Collection<Object> c) {
...
Sample105 other = (Sample105) o;
return (other.name.equals(""));
}

public void process_controlSample105() {
...
public int test_return_finallySample105(File file) {
try {
file.delete();
...
public void assignSample105() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample105() {
...
public void missing_defaultSample105(int x) {
switch (x) {
case 0:
...
public List<String> getASample105() {
return a;
}

public void weakSample105() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
