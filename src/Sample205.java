...
public class Sample205 extends HttpServlet {
...
String retNullSample205() {
    return null;
}

public BufferedInputStream getInputStreamSample205() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample205() {
    
    String x = retNullSample205();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample205() throws IOException {
BufferedInputStream i = getInputStreamSample205();
...
public void test_finalizeSample205() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample205() {
System.gc();
}

public void test_direct_management_of_connectionsSample205() {
try {
...
public native void testJNISample205();

public boolean equals(Sample205 obj) { /* BUG */
return true;
}
...
public void test_arraySample205() {
...
public void testRule2Sample205() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample205(Collection<Object> c) {
...
Sample205 other = (Sample205) o;
return (other.name.equals(""));
}

public void process_controlSample205() {
...
public int test_return_finallySample205(File file) {
try {
file.delete();
...
public void assignSample205() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample205() {
...
public void missing_defaultSample205(int x) {
switch (x) {
case 0:
...
public List<String> getASample205() {
return a;
}

public void weakSample205() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
