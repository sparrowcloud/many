...
public class Sample246 extends HttpServlet {
...
String retNullSample246() {
    return null;
}

public BufferedInputStream getInputStreamSample246() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample246() {
    
    String x = retNullSample246();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample246() throws IOException {
BufferedInputStream i = getInputStreamSample246();
...
public void test_finalizeSample246() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample246() {
System.gc();
}

public void test_direct_management_of_connectionsSample246() {
try {
...
public native void testJNISample246();

public boolean equals(Sample246 obj) { /* BUG */
return true;
}
...
public void test_arraySample246() {
...
public void testRule2Sample246() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample246(Collection<Object> c) {
...
Sample246 other = (Sample246) o;
return (other.name.equals(""));
}

public void process_controlSample246() {
...
public int test_return_finallySample246(File file) {
try {
file.delete();
...
public void assignSample246() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample246() {
...
public void missing_defaultSample246(int x) {
switch (x) {
case 0:
...
public List<String> getASample246() {
return a;
}

public void weakSample246() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
