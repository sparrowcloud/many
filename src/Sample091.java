...
public class Sample091 extends HttpServlet {
...
String retNullSample091() {
    return null;
}

public BufferedInputStream getInputStreamSample091() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample091() {
    
    String x = retNullSample091();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample091() throws IOException {
BufferedInputStream i = getInputStreamSample091();
...
public void test_finalizeSample091() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample091() {
System.gc();
}

public void test_direct_management_of_connectionsSample091() {
try {
...
public native void testJNISample091();

public boolean equals(Sample091 obj) { /* BUG */
return true;
}
...
public void test_arraySample091() {
...
public void testRule2Sample091() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample091(Collection<Object> c) {
...
Sample091 other = (Sample091) o;
return (other.name.equals(""));
}

public void process_controlSample091() {
...
public int test_return_finallySample091(File file) {
try {
file.delete();
...
public void assignSample091() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample091() {
...
public void missing_defaultSample091(int x) {
switch (x) {
case 0:
...
public List<String> getASample091() {
return a;
}

public void weakSample091() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
