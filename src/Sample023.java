...
public class Sample023 extends HttpServlet {
...
String retNullSample023() {
    return null;
}

public BufferedInputStream getInputStreamSample023() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample023() {
    
    String x = retNullSample023();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample023() throws IOException {
BufferedInputStream i = getInputStreamSample023();
...
public void test_finalizeSample023() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample023() {
System.gc();
}

public void test_direct_management_of_connectionsSample023() {
try {
...
public native void testJNISample023();

public boolean equals(Sample023 obj) { /* BUG */
return true;
}
...
public void test_arraySample023() {
...
public void testRule2Sample023() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample023(Collection<Object> c) {
...
Sample023 other = (Sample023) o;
return (other.name.equals(""));
}

public void process_controlSample023() {
...
public int test_return_finallySample023(File file) {
try {
file.delete();
...
public void assignSample023() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample023() {
...
public void missing_defaultSample023(int x) {
switch (x) {
case 0:
...
public List<String> getASample023() {
return a;
}

public void weakSample023() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
