...
public class Sample264 extends HttpServlet {
...
String retNullSample264() {
    return null;
}

public BufferedInputStream getInputStreamSample264() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample264() {
    
    String x = retNullSample264();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample264() throws IOException {
BufferedInputStream i = getInputStreamSample264();
...
public void test_finalizeSample264() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample264() {
System.gc();
}

public void test_direct_management_of_connectionsSample264() {
try {
...
public native void testJNISample264();

public boolean equals(Sample264 obj) { /* BUG */
return true;
}
...
public void test_arraySample264() {
...
public void testRule2Sample264() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample264(Collection<Object> c) {
...
Sample264 other = (Sample264) o;
return (other.name.equals(""));
}

public void process_controlSample264() {
...
public int test_return_finallySample264(File file) {
try {
file.delete();
...
public void assignSample264() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample264() {
...
public void missing_defaultSample264(int x) {
switch (x) {
case 0:
...
public List<String> getASample264() {
return a;
}

public void weakSample264() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
