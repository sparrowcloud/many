...
String retNullSample146() {
    return null;
}

public BufferedInputStream getInputStreamSample146() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample146() {
    
    String x = retNullSample146();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample146() throws IOException {
BufferedInputStream i = getInputStreamSample146();
...
public void test_finalizeSample146() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample146() {
System.gc();
}

public void test_direct_management_of_connectionsSample146() {
try {
...
public native void testJNISample146();

public boolean equals(Sample146 obj) { /* BUG */
return true;
}
...
public void test_arraySample146() {
...
public void testRule2Sample146() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample146(Collection<Object> c) {
...
Sample146 other = (Sample146) o;
return (other.name.equals(""));
}

public void process_controlSample146() {
...
public int test_return_finallySample146(File file) {
try {
file.delete();
...
public void assignSample146() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample146() {
...
public void missing_defaultSample146(int x) {
switch (x) {
case 0:
...
public List<String> getASample146() {
return a;
}

public void weakSample146() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
