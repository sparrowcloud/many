...
public class Sample277 extends HttpServlet {
...
String retNullSample277() {
    return null;
}

public BufferedInputStream getInputStreamSample277() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample277() {
    
    String x = retNullSample277();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample277() throws IOException {
BufferedInputStream i = getInputStreamSample277();
...
public void test_finalizeSample277() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample277() {
System.gc();
}

public void test_direct_management_of_connectionsSample277() {
try {
...
public native void testJNISample277();

public boolean equals(Sample277 obj) { /* BUG */
return true;
}
...
public void test_arraySample277() {
...
public void testRule2Sample277() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample277(Collection<Object> c) {
...
Sample277 other = (Sample277) o;
return (other.name.equals(""));
}

public void process_controlSample277() {
...
public int test_return_finallySample277(File file) {
try {
file.delete();
...
public void assignSample277() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample277() {
...
public void missing_defaultSample277(int x) {
switch (x) {
case 0:
...
public List<String> getASample277() {
return a;
}

public void weakSample277() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
