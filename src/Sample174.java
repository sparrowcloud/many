...
public class Sample174 extends HttpServlet {
...
String retNullSample174() {
    return null;
}

public BufferedInputStream getInputStreamSample174() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample174() {
    
    String x = retNullSample174();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample174() throws IOException {
BufferedInputStream i = getInputStreamSample174();
...
public void test_finalizeSample174() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample174() {
System.gc();
}

public void test_direct_management_of_connectionsSample174() {
try {
...
public native void testJNISample174();

public boolean equals(Sample174 obj) { /* BUG */
return true;
}
...
public void test_arraySample174() {
...
public void testRule2Sample174() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample174(Collection<Object> c) {
...
Sample174 other = (Sample174) o;
return (other.name.equals(""));
}

public void process_controlSample174() {
...
public int test_return_finallySample174(File file) {
try {
file.delete();
...
public void assignSample174() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample174() {
...
public void missing_defaultSample174(int x) {
switch (x) {
case 0:
...
public List<String> getASample174() {
return a;
}

public void weakSample174() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
