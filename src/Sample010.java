...
String retNullSample010() {
    return null;
}

public BufferedInputStream getInputStreamSample010() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample010() {
    
    String x = retNullSample010();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample010() throws IOException {
BufferedInputStream i = getInputStreamSample010();
...
public void test_finalizeSample010() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample010() {
System.gc();
}

public void test_direct_management_of_connectionsSample010() {
try {
...
public native void testJNISample010();

public boolean equals(Sample010 obj) { /* BUG */
return true;
}
...
public void test_arraySample010() {
...
public void testRule2Sample010() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample010(Collection<Object> c) {
...
Sample010 other = (Sample010) o;
return (other.name.equals(""));
}

public void process_controlSample010() {
...
public int test_return_finallySample010(File file) {
try {
file.delete();
...
public void assignSample010() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample010() {
...
public void missing_defaultSample010(int x) {
switch (x) {
case 0:
...
public List<String> getASample010() {
return a;
}

public void weakSample010() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
