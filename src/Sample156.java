...
public class Sample156 extends HttpServlet {
...
String retNullSample156() {
    return null;
}

public BufferedInputStream getInputStreamSample156() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample156() {
    
    String x = retNullSample156();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample156() throws IOException {
BufferedInputStream i = getInputStreamSample156();
...
public void test_finalizeSample156() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample156() {
System.gc();
}

public void test_direct_management_of_connectionsSample156() {
try {
...
public native void testJNISample156();

public boolean equals(Sample156 obj) { /* BUG */
return true;
}
...
public void test_arraySample156() {
...
public void testRule2Sample156() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample156(Collection<Object> c) {
...
Sample156 other = (Sample156) o;
return (other.name.equals(""));
}

public void process_controlSample156() {
...
public int test_return_finallySample156(File file) {
try {
file.delete();
...
public void assignSample156() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample156() {
...
public void missing_defaultSample156(int x) {
switch (x) {
case 0:
...
public List<String> getASample156() {
return a;
}

public void weakSample156() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
