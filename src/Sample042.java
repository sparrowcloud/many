...
public class Sample042 extends HttpServlet {
...
String retNullSample042() {
    return null;
}

public BufferedInputStream getInputStreamSample042() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample042() {
    
    String x = retNullSample042();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample042() throws IOException {
BufferedInputStream i = getInputStreamSample042();
...
public void test_finalizeSample042() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample042() {
System.gc();
}

public void test_direct_management_of_connectionsSample042() {
try {
...
public native void testJNISample042();

public boolean equals(Sample042 obj) { /* BUG */
return true;
}
...
public void test_arraySample042() {
...
public void testRule2Sample042() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample042(Collection<Object> c) {
...
Sample042 other = (Sample042) o;
return (other.name.equals(""));
}

public void process_controlSample042() {
...
public int test_return_finallySample042(File file) {
try {
file.delete();
...
public void assignSample042() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample042() {
...
public void missing_defaultSample042(int x) {
switch (x) {
case 0:
...
public List<String> getASample042() {
return a;
}

public void weakSample042() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
