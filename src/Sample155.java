...
public class Sample155 extends HttpServlet {
...
String retNullSample155() {
    return null;
}

public BufferedInputStream getInputStreamSample155() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample155() {
    
    String x = retNullSample155();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample155() throws IOException {
BufferedInputStream i = getInputStreamSample155();
...
public void test_finalizeSample155() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample155() {
System.gc();
}

public void test_direct_management_of_connectionsSample155() {
try {
...
public native void testJNISample155();

public boolean equals(Sample155 obj) { /* BUG */
return true;
}
...
public void test_arraySample155() {
...
public void testRule2Sample155() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample155(Collection<Object> c) {
...
Sample155 other = (Sample155) o;
return (other.name.equals(""));
}

public void process_controlSample155() {
...
public int test_return_finallySample155(File file) {
try {
file.delete();
...
public void assignSample155() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample155() {
...
public void missing_defaultSample155(int x) {
switch (x) {
case 0:
...
public List<String> getASample155() {
return a;
}

public void weakSample155() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
