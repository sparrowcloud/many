...
public class Sample289 extends HttpServlet {
...
String retNullSample289() {
    return null;
}

public BufferedInputStream getInputStreamSample289() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample289() {
    
    String x = retNullSample289();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample289() throws IOException {
BufferedInputStream i = getInputStreamSample289();
...
public void test_finalizeSample289() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample289() {
System.gc();
}

public void test_direct_management_of_connectionsSample289() {
try {
...
public native void testJNISample289();

public boolean equals(Sample289 obj) { /* BUG */
return true;
}
...
public void test_arraySample289() {
...
public void testRule2Sample289() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample289(Collection<Object> c) {
...
Sample289 other = (Sample289) o;
return (other.name.equals(""));
}

public void process_controlSample289() {
...
public int test_return_finallySample289(File file) {
try {
file.delete();
...
public void assignSample289() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample289() {
...
public void missing_defaultSample289(int x) {
switch (x) {
case 0:
...
public List<String> getASample289() {
return a;
}

public void weakSample289() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
