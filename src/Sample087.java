...
public class Sample087 extends HttpServlet {
...
String retNullSample087() {
    return null;
}

public BufferedInputStream getInputStreamSample087() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample087() {
    
    String x = retNullSample087();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample087() throws IOException {
BufferedInputStream i = getInputStreamSample087();
...
public void test_finalizeSample087() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample087() {
System.gc();
}

public void test_direct_management_of_connectionsSample087() {
try {
...
public native void testJNISample087();

public boolean equals(Sample087 obj) { /* BUG */
return true;
}
...
public void test_arraySample087() {
...
public void testRule2Sample087() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample087(Collection<Object> c) {
...
Sample087 other = (Sample087) o;
return (other.name.equals(""));
}

public void process_controlSample087() {
...
public int test_return_finallySample087(File file) {
try {
file.delete();
...
public void assignSample087() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample087() {
...
public void missing_defaultSample087(int x) {
switch (x) {
case 0:
...
public List<String> getASample087() {
return a;
}

public void weakSample087() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
