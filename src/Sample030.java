...
public class Sample030{
    ...
    String retNullSample030() {
        return null;
    }

    public BufferedInputStream getInputStreamSample030() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample030() {

        String x = retNullSample030();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample030() throws IOException {
        BufferedInputStream i = getInputStreamSample030();
    ...
    public void test_finalizeSample030() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample030() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample030() {
        try {
    ...
    public native void testJNISample030();

    public boolean equals(Sample030 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample030() {
    ...
    public void testRule2Sample030() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample030(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample030 other = (Sample030) o;
        return (other.name.equals(""));
    }

    public void process_controlSample030() {
    ...
    public int test_return_finallySample030(File file) {
        try {
            file.delete();
    ...
    public void assignSample030() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample030() {
    ...
    public void missing_defaultSample030(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample030() {
        return a;
    }

    public void weakSample030() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
