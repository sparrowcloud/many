...
String retNullSample152() {
    return null;
}

public BufferedInputStream getInputStreamSample152() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample152() {
    
    String x = retNullSample152();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample152() throws IOException {
BufferedInputStream i = getInputStreamSample152();
...
public void test_finalizeSample152() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample152() {
System.gc();
}

public void test_direct_management_of_connectionsSample152() {
try {
...
public native void testJNISample152();

public boolean equals(Sample152 obj) { /* BUG */
return true;
}
...
public void test_arraySample152() {
...
public void testRule2Sample152() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample152(Collection<Object> c) {
...
Sample152 other = (Sample152) o;
return (other.name.equals(""));
}

public void process_controlSample152() {
...
public int test_return_finallySample152(File file) {
try {
file.delete();
...
public void assignSample152() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample152() {
...
public void missing_defaultSample152(int x) {
switch (x) {
case 0:
...
public List<String> getASample152() {
return a;
}

public void weakSample152() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
