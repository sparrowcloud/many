...
public class Sample280 extends HttpServlet {
...
String retNullSample280() {
    return null;
}

public BufferedInputStream getInputStreamSample280() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample280() {
    
    String x = retNullSample280();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample280() throws IOException {
BufferedInputStream i = getInputStreamSample280();
...
public void test_finalizeSample280() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample280() {
System.gc();
}

public void test_direct_management_of_connectionsSample280() {
try {
...
public native void testJNISample280();

public boolean equals(Sample280 obj) { /* BUG */
return true;
}
...
public void test_arraySample280() {
...
public void testRule2Sample280() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample280(Collection<Object> c) {
...
Sample280 other = (Sample280) o;
return (other.name.equals(""));
}

public void process_controlSample280() {
...
public int test_return_finallySample280(File file) {
try {
file.delete();
...
public void assignSample280() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample280() {
...
public void missing_defaultSample280(int x) {
switch (x) {
case 0:
...
public List<String> getASample280() {
return a;
}

public void weakSample280() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
