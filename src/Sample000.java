...
public class Sample000 extends HttpServlet {
...
String retNullSample000() {
    return null;
}

public BufferedInputStream getInputStreamSample000() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample000() {
    
    String x = retNullSample000();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample000() throws IOException {
BufferedInputStream i = getInputStreamSample000();
...
public void test_finalizeSample000() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample000() {
System.gc();
}

public void test_direct_management_of_connectionsSample000() {
try {
...
public native void testJNISample000();

public boolean equals(Sample000 obj) { /* BUG */
return true;
}
...
public void test_arraySample000() {
...
public void testRule2Sample000() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample000(Collection<Object> c) {
...
Sample000 other = (Sample000) o;
return (other.name.equals(""));
}

public void process_controlSample000() {
...
public int test_return_finallySample000(File file) {
try {
file.delete();
...
public void assignSample000() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample000() {
...
public void missing_defaultSample000(int x) {
switch (x) {
case 0:
...
public List<String> getASample000() {
return a;
}

public void weakSample000() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
