...
public class Sample167 extends HttpServlet {
...
String retNullSample167() {
    return null;
}

public BufferedInputStream getInputStreamSample167() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample167() {
    
    String x = retNullSample167();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample167() throws IOException {
BufferedInputStream i = getInputStreamSample167();
...
public void test_finalizeSample167() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample167() {
System.gc();
}

public void test_direct_management_of_connectionsSample167() {
try {
...
public native void testJNISample167();

public boolean equals(Sample167 obj) { /* BUG */
return true;
}
...
public void test_arraySample167() {
...
public void testRule2Sample167() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample167(Collection<Object> c) {
...
Sample167 other = (Sample167) o;
return (other.name.equals(""));
}

public void process_controlSample167() {
...
public int test_return_finallySample167(File file) {
try {
file.delete();
...
public void assignSample167() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample167() {
...
public void missing_defaultSample167(int x) {
switch (x) {
case 0:
...
public List<String> getASample167() {
return a;
}

public void weakSample167() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
