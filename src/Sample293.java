...
public class Sample293 extends HttpServlet {
...
String retNullSample293() {
    return null;
}

public BufferedInputStream getInputStreamSample293() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample293() {
    
    String x = retNullSample293();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample293() throws IOException {
BufferedInputStream i = getInputStreamSample293();
...
public void test_finalizeSample293() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample293() {
System.gc();
}

public void test_direct_management_of_connectionsSample293() {
try {
...
public native void testJNISample293();

public boolean equals(Sample293 obj) { /* BUG */
return true;
}
...
public void test_arraySample293() {
...
public void testRule2Sample293() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample293(Collection<Object> c) {
...
Sample293 other = (Sample293) o;
return (other.name.equals(""));
}

public void process_controlSample293() {
...
public int test_return_finallySample293(File file) {
try {
file.delete();
...
public void assignSample293() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample293() {
...
public void missing_defaultSample293(int x) {
switch (x) {
case 0:
...
public List<String> getASample293() {
return a;
}

public void weakSample293() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
