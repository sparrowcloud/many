...
public class Sample079 extends HttpServlet {
...
String retNullSample079() {
    return null;
}

public BufferedInputStream getInputStreamSample079() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample079() {
    
    String x = retNullSample079();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample079() throws IOException {
BufferedInputStream i = getInputStreamSample079();
...
public void test_finalizeSample079() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample079() {
System.gc();
}

public void test_direct_management_of_connectionsSample079() {
try {
...
public native void testJNISample079();

public boolean equals(Sample079 obj) { /* BUG */
return true;
}
...
public void test_arraySample079() {
...
public void testRule2Sample079() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample079(Collection<Object> c) {
...
Sample079 other = (Sample079) o;
return (other.name.equals(""));
}

public void process_controlSample079() {
...
public int test_return_finallySample079(File file) {
try {
file.delete();
...
public void assignSample079() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample079() {
...
public void missing_defaultSample079(int x) {
switch (x) {
case 0:
...
public List<String> getASample079() {
return a;
}

public void weakSample079() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
