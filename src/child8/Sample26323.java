...
public class Sample26323{
    ...
    String retNullSample26323() {
        return null;
    }

    public BufferedInputStream getInputStreamSample26323() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample26323() {

        String x = retNullSample26323();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample26323() throws IOException {
        BufferedInputStream i = getInputStreamSample26323();
    ...
    public void test_finalizeSample26323() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample26323() {
        System.gc();
    }
    ...
    public native void testJNISample26323();

    public boolean equals(Sample26323 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample26323() {
    ...
    public void testRule2Sample26323() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample26323(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample26323 other = (Sample26323) o;
        return (other.name.equals(""));
    }

    public void process_controlSample26323() {
    ...
    public int test_return_finallySample26323(File file) {
        try {
            file.delete();
    ...
    public void assignSample26323() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample26323() {
    ...
    public void missing_defaultSample26323(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample26323() {
        return a;
    }

    public void weakSample26323() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
