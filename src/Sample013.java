...
String retNullSample013() {
    return null;
}

public BufferedInputStream getInputStreamSample013() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample013() {
    
    String x = retNullSample013();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample013() throws IOException {
BufferedInputStream i = getInputStreamSample013();
...
public void test_finalizeSample013() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample013() {
System.gc();
}

public void test_direct_management_of_connectionsSample013() {
try {
...
public native void testJNISample013();

public boolean equals(Sample013 obj) { /* BUG */
return true;
}
...
public void test_arraySample013() {
...
public void testRule2Sample013() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample013(Collection<Object> c) {
...
Sample013 other = (Sample013) o;
return (other.name.equals(""));
}

public void process_controlSample013() {
...
public int test_return_finallySample013(File file) {
try {
file.delete();
...
public void assignSample013() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample013() {
...
public void missing_defaultSample013(int x) {
switch (x) {
case 0:
...
public List<String> getASample013() {
return a;
}

public void weakSample013() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
