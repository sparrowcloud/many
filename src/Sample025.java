...
public class Sample025{
    ...
    String retNullSample025() {
        return null;
    }

    public BufferedInputStream getInputStreamSample025() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample025() {

        String x = retNullSample025();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample025() throws IOException {
        BufferedInputStream i = getInputStreamSample025();
    ...
    public void test_finalizeSample025() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample025() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample025() {
        try {
    ...
    public native void testJNISample025();

    public boolean equals(Sample025 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample025() {
    ...
    public void testRule2Sample025() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample025(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample025 other = (Sample025) o;
        return (other.name.equals(""));
    }

    public void process_controlSample025() {
    ...
    public int test_return_finallySample025(File file) {
        try {
            file.delete();
    ...
    public void assignSample025() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample025() {
    ...
    public void missing_defaultSample025(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample025() {
        return a;
    }

    public void weakSample025() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
