...
public class Sample224 extends HttpServlet {
...
String retNullSample224() {
    return null;
}

public BufferedInputStream getInputStreamSample224() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample224() {
    
    String x = retNullSample224();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample224() throws IOException {
BufferedInputStream i = getInputStreamSample224();
...
public void test_finalizeSample224() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample224() {
System.gc();
}

public void test_direct_management_of_connectionsSample224() {
try {
...
public native void testJNISample224();

public boolean equals(Sample224 obj) { /* BUG */
return true;
}
...
public void test_arraySample224() {
...
public void testRule2Sample224() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample224(Collection<Object> c) {
...
Sample224 other = (Sample224) o;
return (other.name.equals(""));
}

public void process_controlSample224() {
...
public int test_return_finallySample224(File file) {
try {
file.delete();
...
public void assignSample224() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample224() {
...
public void missing_defaultSample224(int x) {
switch (x) {
case 0:
...
public List<String> getASample224() {
return a;
}

public void weakSample224() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
