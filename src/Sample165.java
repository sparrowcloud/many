...
public class Sample165 extends HttpServlet {
...
String retNullSample165() {
    return null;
}

public BufferedInputStream getInputStreamSample165() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample165() {
    
    String x = retNullSample165();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample165() throws IOException {
BufferedInputStream i = getInputStreamSample165();
...
public void test_finalizeSample165() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample165() {
System.gc();
}

public void test_direct_management_of_connectionsSample165() {
try {
...
public native void testJNISample165();

public boolean equals(Sample165 obj) { /* BUG */
return true;
}
...
public void test_arraySample165() {
...
public void testRule2Sample165() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample165(Collection<Object> c) {
...
Sample165 other = (Sample165) o;
return (other.name.equals(""));
}

public void process_controlSample165() {
...
public int test_return_finallySample165(File file) {
try {
file.delete();
...
public void assignSample165() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample165() {
...
public void missing_defaultSample165(int x) {
switch (x) {
case 0:
...
public List<String> getASample165() {
return a;
}

public void weakSample165() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
