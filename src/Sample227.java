...
public class Sample227 extends HttpServlet {
...
String retNullSample227() {
    return null;
}

public BufferedInputStream getInputStreamSample227() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample227() {
    
    String x = retNullSample227();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample227() throws IOException {
BufferedInputStream i = getInputStreamSample227();
...
public void test_finalizeSample227() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample227() {
System.gc();
}

public void test_direct_management_of_connectionsSample227() {
try {
...
public native void testJNISample227();

public boolean equals(Sample227 obj) { /* BUG */
return true;
}
...
public void test_arraySample227() {
...
public void testRule2Sample227() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample227(Collection<Object> c) {
...
Sample227 other = (Sample227) o;
return (other.name.equals(""));
}

public void process_controlSample227() {
...
public int test_return_finallySample227(File file) {
try {
file.delete();
...
public void assignSample227() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample227() {
...
public void missing_defaultSample227(int x) {
switch (x) {
case 0:
...
public List<String> getASample227() {
return a;
}

public void weakSample227() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
