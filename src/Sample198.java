...
public class Sample198 extends HttpServlet {
...
String retNullSample198() {
    return null;
}

public BufferedInputStream getInputStreamSample198() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample198() {
    
    String x = retNullSample198();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample198() throws IOException {
BufferedInputStream i = getInputStreamSample198();
...
public void test_finalizeSample198() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample198() {
System.gc();
}

public void test_direct_management_of_connectionsSample198() {
try {
...
public native void testJNISample198();

public boolean equals(Sample198 obj) { /* BUG */
return true;
}
...
public void test_arraySample198() {
...
public void testRule2Sample198() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample198(Collection<Object> c) {
...
Sample198 other = (Sample198) o;
return (other.name.equals(""));
}

public void process_controlSample198() {
...
public int test_return_finallySample198(File file) {
try {
file.delete();
...
public void assignSample198() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample198() {
...
public void missing_defaultSample198(int x) {
switch (x) {
case 0:
...
public List<String> getASample198() {
return a;
}

public void weakSample198() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
