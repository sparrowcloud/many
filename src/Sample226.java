...
public class Sample226 extends HttpServlet {
...
String retNullSample226() {
    return null;
}

public BufferedInputStream getInputStreamSample226() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample226() {
    
    String x = retNullSample226();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample226() throws IOException {
BufferedInputStream i = getInputStreamSample226();
...
public void test_finalizeSample226() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample226() {
System.gc();
}

public void test_direct_management_of_connectionsSample226() {
try {
...
public native void testJNISample226();

public boolean equals(Sample226 obj) { /* BUG */
return true;
}
...
public void test_arraySample226() {
...
public void testRule2Sample226() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample226(Collection<Object> c) {
...
Sample226 other = (Sample226) o;
return (other.name.equals(""));
}

public void process_controlSample226() {
...
public int test_return_finallySample226(File file) {
try {
file.delete();
...
public void assignSample226() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample226() {
...
public void missing_defaultSample226(int x) {
switch (x) {
case 0:
...
public List<String> getASample226() {
return a;
}

public void weakSample226() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
