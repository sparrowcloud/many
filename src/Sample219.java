...
public class Sample219 extends HttpServlet {
...
String retNullSample219() {
    return null;
}

public BufferedInputStream getInputStreamSample219() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample219() {
    
    String x = retNullSample219();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample219() throws IOException {
BufferedInputStream i = getInputStreamSample219();
...
public void test_finalizeSample219() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample219() {
System.gc();
}

public void test_direct_management_of_connectionsSample219() {
try {
...
public native void testJNISample219();

public boolean equals(Sample219 obj) { /* BUG */
return true;
}
...
public void test_arraySample219() {
...
public void testRule2Sample219() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample219(Collection<Object> c) {
...
Sample219 other = (Sample219) o;
return (other.name.equals(""));
}

public void process_controlSample219() {
...
public int test_return_finallySample219(File file) {
try {
file.delete();
...
public void assignSample219() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample219() {
...
public void missing_defaultSample219(int x) {
switch (x) {
case 0:
...
public List<String> getASample219() {
return a;
}

public void weakSample219() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
