...
public class Sample067{
    ...
    String retNullSample067() {
        return null;
    }

    public BufferedInputStream getInputStreamSample067() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample067() {

        String x = retNullSample067();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample067() throws IOException {
        BufferedInputStream i = getInputStreamSample067();
    ...
    public void test_finalizeSample067() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample067() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample067() {
        try {
    ...
    public native void testJNISample067();

    public boolean equals(Sample067 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample067() {
    ...
    public void testRule2Sample067() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample067(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample067 other = (Sample067) o;
        return (other.name.equals(""));
    }

    public void process_controlSample067() {
    ...
    public int test_return_finallySample067(File file) {
        try {
            file.delete();
    ...
    public void assignSample067() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample067() {
    ...
    public void missing_defaultSample067(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample067() {
        return a;
    }

    public void weakSample067() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
