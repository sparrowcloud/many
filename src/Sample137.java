...
public class Sample137 extends HttpServlet {
...
String retNullSample137() {
    return null;
}

public BufferedInputStream getInputStreamSample137() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample137() {
    
    String x = retNullSample137();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample137() throws IOException {
BufferedInputStream i = getInputStreamSample137();
...
public void test_finalizeSample137() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample137() {
System.gc();
}

public void test_direct_management_of_connectionsSample137() {
try {
...
public native void testJNISample137();

public boolean equals(Sample137 obj) { /* BUG */
return true;
}
...
public void test_arraySample137() {
...
public void testRule2Sample137() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample137(Collection<Object> c) {
...
Sample137 other = (Sample137) o;
return (other.name.equals(""));
}

public void process_controlSample137() {
...
public int test_return_finallySample137(File file) {
try {
file.delete();
...
public void assignSample137() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample137() {
...
public void missing_defaultSample137(int x) {
switch (x) {
case 0:
...
public List<String> getASample137() {
return a;
}

public void weakSample137() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
