...
String retNullSample065() {
    return null;
}

public BufferedInputStream getInputStreamSample065() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample065() {
    
    String x = retNullSample065();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample065() throws IOException {
BufferedInputStream i = getInputStreamSample065();
...
public void test_finalizeSample065() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample065() {
System.gc();
}

public void test_direct_management_of_connectionsSample065() {
try {
...
public native void testJNISample065();

public boolean equals(Sample065 obj) { /* BUG */
return true;
}
...
public void test_arraySample065() {
...
public void testRule2Sample065() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample065(Collection<Object> c) {
...
Sample065 other = (Sample065) o;
return (other.name.equals(""));
}

public void process_controlSample065() {
...
public int test_return_finallySample065(File file) {
try {
file.delete();
...
public void assignSample065() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample065() {
...
public void missing_defaultSample065(int x) {
switch (x) {
case 0:
...
public List<String> getASample065() {
return a;
}

public void weakSample065() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
