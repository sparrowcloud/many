...
public class Sample074 extends HttpServlet {
...
String retNullSample074() {
    return null;
}

public BufferedInputStream getInputStreamSample074() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample074() {
    
    String x = retNullSample074();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample074() throws IOException {
BufferedInputStream i = getInputStreamSample074();
...
public void test_finalizeSample074() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample074() {
System.gc();
}

public void test_direct_management_of_connectionsSample074() {
try {
...
public native void testJNISample074();

public boolean equals(Sample074 obj) { /* BUG */
return true;
}
...
public void test_arraySample074() {
...
public void testRule2Sample074() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample074(Collection<Object> c) {
...
Sample074 other = (Sample074) o;
return (other.name.equals(""));
}

public void process_controlSample074() {
...
public int test_return_finallySample074(File file) {
try {
file.delete();
...
public void assignSample074() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample074() {
...
public void missing_defaultSample074(int x) {
switch (x) {
case 0:
...
public List<String> getASample074() {
return a;
}

public void weakSample074() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
