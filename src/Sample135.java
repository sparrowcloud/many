...
public class Sample135 extends HttpServlet {
...
String retNullSample135() {
    return null;
}

public BufferedInputStream getInputStreamSample135() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample135() {
    
    String x = retNullSample135();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample135() throws IOException {
BufferedInputStream i = getInputStreamSample135();
...
public void test_finalizeSample135() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample135() {
System.gc();
}

public void test_direct_management_of_connectionsSample135() {
try {
...
public native void testJNISample135();

public boolean equals(Sample135 obj) { /* BUG */
return true;
}
...
public void test_arraySample135() {
...
public void testRule2Sample135() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample135(Collection<Object> c) {
...
Sample135 other = (Sample135) o;
return (other.name.equals(""));
}

public void process_controlSample135() {
...
public int test_return_finallySample135(File file) {
try {
file.delete();
...
public void assignSample135() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample135() {
...
public void missing_defaultSample135(int x) {
switch (x) {
case 0:
...
public List<String> getASample135() {
return a;
}

public void weakSample135() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
