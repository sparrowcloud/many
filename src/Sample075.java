...
public class Sample075 extends HttpServlet {
...
String retNullSample075() {
    return null;
}

public BufferedInputStream getInputStreamSample075() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample075() {
    
    String x = retNullSample075();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample075() throws IOException {
BufferedInputStream i = getInputStreamSample075();
...
public void test_finalizeSample075() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample075() {
System.gc();
}

public void test_direct_management_of_connectionsSample075() {
try {
...
public native void testJNISample075();

public boolean equals(Sample075 obj) { /* BUG */
return true;
}
...
public void test_arraySample075() {
...
public void testRule2Sample075() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample075(Collection<Object> c) {
...
Sample075 other = (Sample075) o;
return (other.name.equals(""));
}

public void process_controlSample075() {
...
public int test_return_finallySample075(File file) {
try {
file.delete();
...
public void assignSample075() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample075() {
...
public void missing_defaultSample075(int x) {
switch (x) {
case 0:
...
public List<String> getASample075() {
return a;
}

public void weakSample075() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
