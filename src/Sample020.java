...
public class Sample020{
    ...
    String retNullSample020() {
        return null;
    }

    public BufferedInputStream getInputStreamSample020() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample020() {

        String x = retNullSample020();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample020() throws IOException {
        BufferedInputStream i = getInputStreamSample020();
    ...
    public void test_finalizeSample020() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample020() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample020() {
        try {
    ...
    public native void testJNISample020();

    public boolean equals(Sample020 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample020() {
    ...
    public void testRule2Sample020() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample020(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample020 other = (Sample020) o;
        return (other.name.equals(""));
    }

    public void process_controlSample020() {
    ...
    public int test_return_finallySample020(File file) {
        try {
            file.delete();
    ...
    public void assignSample020() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample020() {
    ...
    public void missing_defaultSample020(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample020() {
        return a;
    }

    public void weakSample020() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
