...
public class Sample153 extends HttpServlet {
...
String retNullSample153() {
    return null;
}

public BufferedInputStream getInputStreamSample153() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample153() {
    
    String x = retNullSample153();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample153() throws IOException {
BufferedInputStream i = getInputStreamSample153();
...
public void test_finalizeSample153() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample153() {
System.gc();
}

public void test_direct_management_of_connectionsSample153() {
try {
...
public native void testJNISample153();

public boolean equals(Sample153 obj) { /* BUG */
return true;
}
...
public void test_arraySample153() {
...
public void testRule2Sample153() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample153(Collection<Object> c) {
...
Sample153 other = (Sample153) o;
return (other.name.equals(""));
}

public void process_controlSample153() {
...
public int test_return_finallySample153(File file) {
try {
file.delete();
...
public void assignSample153() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample153() {
...
public void missing_defaultSample153(int x) {
switch (x) {
case 0:
...
public List<String> getASample153() {
return a;
}

public void weakSample153() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
