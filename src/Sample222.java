...
public class Sample222 extends HttpServlet {
...
String retNullSample222() {
    return null;
}

public BufferedInputStream getInputStreamSample222() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample222() {
    
    String x = retNullSample222();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample222() throws IOException {
BufferedInputStream i = getInputStreamSample222();
...
public void test_finalizeSample222() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample222() {
System.gc();
}

public void test_direct_management_of_connectionsSample222() {
try {
...
public native void testJNISample222();

public boolean equals(Sample222 obj) { /* BUG */
return true;
}
...
public void test_arraySample222() {
...
public void testRule2Sample222() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample222(Collection<Object> c) {
...
Sample222 other = (Sample222) o;
return (other.name.equals(""));
}

public void process_controlSample222() {
...
public int test_return_finallySample222(File file) {
try {
file.delete();
...
public void assignSample222() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample222() {
...
public void missing_defaultSample222(int x) {
switch (x) {
case 0:
...
public List<String> getASample222() {
return a;
}

public void weakSample222() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
