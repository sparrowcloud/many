...
String retNullSample102() {
    return null;
}

public BufferedInputStream getInputStreamSample102() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample102() {
    
    String x = retNullSample102();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample102() throws IOException {
BufferedInputStream i = getInputStreamSample102();
...
public void test_finalizeSample102() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample102() {
System.gc();
}

public void test_direct_management_of_connectionsSample102() {
try {
...
public native void testJNISample102();

public boolean equals(Sample102 obj) { /* BUG */
return true;
}
...
public void test_arraySample102() {
...
public void testRule2Sample102() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample102(Collection<Object> c) {
...
Sample102 other = (Sample102) o;
return (other.name.equals(""));
}

public void process_controlSample102() {
...
public int test_return_finallySample102(File file) {
try {
file.delete();
...
public void assignSample102() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample102() {
...
public void missing_defaultSample102(int x) {
switch (x) {
case 0:
...
public List<String> getASample102() {
return a;
}

public void weakSample102() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
