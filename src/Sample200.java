...
public class Sample200 extends HttpServlet {
...
String retNullSample200() {
    return null;
}

public BufferedInputStream getInputStreamSample200() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample200() {
    
    String x = retNullSample200();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample200() throws IOException {
BufferedInputStream i = getInputStreamSample200();
...
public void test_finalizeSample200() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample200() {
System.gc();
}

public void test_direct_management_of_connectionsSample200() {
try {
...
public native void testJNISample200();

public boolean equals(Sample200 obj) { /* BUG */
return true;
}
...
public void test_arraySample200() {
...
public void testRule2Sample200() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample200(Collection<Object> c) {
...
Sample200 other = (Sample200) o;
return (other.name.equals(""));
}

public void process_controlSample200() {
...
public int test_return_finallySample200(File file) {
try {
file.delete();
...
public void assignSample200() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample200() {
...
public void missing_defaultSample200(int x) {
switch (x) {
case 0:
...
public List<String> getASample200() {
return a;
}

public void weakSample200() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
