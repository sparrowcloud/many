...
public class Sample108 extends HttpServlet {
...
String retNullSample108() {
    return null;
}

public BufferedInputStream getInputStreamSample108() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample108() {
    
    String x = retNullSample108();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample108() throws IOException {
BufferedInputStream i = getInputStreamSample108();
...
public void test_finalizeSample108() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample108() {
System.gc();
}

public void test_direct_management_of_connectionsSample108() {
try {
...
public native void testJNISample108();

public boolean equals(Sample108 obj) { /* BUG */
return true;
}
...
public void test_arraySample108() {
...
public void testRule2Sample108() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample108(Collection<Object> c) {
...
Sample108 other = (Sample108) o;
return (other.name.equals(""));
}

public void process_controlSample108() {
...
public int test_return_finallySample108(File file) {
try {
file.delete();
...
public void assignSample108() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample108() {
...
public void missing_defaultSample108(int x) {
switch (x) {
case 0:
...
public List<String> getASample108() {
return a;
}

public void weakSample108() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
