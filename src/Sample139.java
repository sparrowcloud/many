...
public class Sample139 extends HttpServlet {
...
String retNullSample139() {
    return null;
}

public BufferedInputStream getInputStreamSample139() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample139() {
    
    String x = retNullSample139();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample139() throws IOException {
BufferedInputStream i = getInputStreamSample139();
...
public void test_finalizeSample139() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample139() {
System.gc();
}

public void test_direct_management_of_connectionsSample139() {
try {
...
public native void testJNISample139();

public boolean equals(Sample139 obj) { /* BUG */
return true;
}
...
public void test_arraySample139() {
...
public void testRule2Sample139() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample139(Collection<Object> c) {
...
Sample139 other = (Sample139) o;
return (other.name.equals(""));
}

public void process_controlSample139() {
...
public int test_return_finallySample139(File file) {
try {
file.delete();
...
public void assignSample139() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample139() {
...
public void missing_defaultSample139(int x) {
switch (x) {
case 0:
...
public List<String> getASample139() {
return a;
}

public void weakSample139() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
