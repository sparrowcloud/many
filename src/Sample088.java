...
public class Sample088 extends HttpServlet {
...
String retNullSample088() {
    return null;
}

public BufferedInputStream getInputStreamSample088() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample088() {
    
    String x = retNullSample088();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample088() throws IOException {
BufferedInputStream i = getInputStreamSample088();
...
public void test_finalizeSample088() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample088() {
System.gc();
}

public void test_direct_management_of_connectionsSample088() {
try {
...
public native void testJNISample088();

public boolean equals(Sample088 obj) { /* BUG */
return true;
}
...
public void test_arraySample088() {
...
public void testRule2Sample088() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample088(Collection<Object> c) {
...
Sample088 other = (Sample088) o;
return (other.name.equals(""));
}

public void process_controlSample088() {
...
public int test_return_finallySample088(File file) {
try {
file.delete();
...
public void assignSample088() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample088() {
...
public void missing_defaultSample088(int x) {
switch (x) {
case 0:
...
public List<String> getASample088() {
return a;
}

public void weakSample088() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
