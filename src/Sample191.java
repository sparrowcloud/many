...
public class Sample191 extends HttpServlet {
...
String retNullSample191() {
    return null;
}

public BufferedInputStream getInputStreamSample191() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample191() {
    
    String x = retNullSample191();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample191() throws IOException {
BufferedInputStream i = getInputStreamSample191();
...
public void test_finalizeSample191() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample191() {
System.gc();
}

public void test_direct_management_of_connectionsSample191() {
try {
...
public native void testJNISample191();

public boolean equals(Sample191 obj) { /* BUG */
return true;
}
...
public void test_arraySample191() {
...
public void testRule2Sample191() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample191(Collection<Object> c) {
...
Sample191 other = (Sample191) o;
return (other.name.equals(""));
}

public void process_controlSample191() {
...
public int test_return_finallySample191(File file) {
try {
file.delete();
...
public void assignSample191() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample191() {
...
public void missing_defaultSample191(int x) {
switch (x) {
case 0:
...
public List<String> getASample191() {
return a;
}

public void weakSample191() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
