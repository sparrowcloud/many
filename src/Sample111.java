...
String retNullSample111() {
    return null;
}

public BufferedInputStream getInputStreamSample111() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample111() {
    
    String x = retNullSample111();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample111() throws IOException {
BufferedInputStream i = getInputStreamSample111();
...
public void test_finalizeSample111() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample111() {
System.gc();
}

public void test_direct_management_of_connectionsSample111() {
try {
...
public native void testJNISample111();

public boolean equals(Sample111 obj) { /* BUG */
return true;
}
...
public void test_arraySample111() {
...
public void testRule2Sample111() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample111(Collection<Object> c) {
...
Sample111 other = (Sample111) o;
return (other.name.equals(""));
}

public void process_controlSample111() {
...
public int test_return_finallySample111(File file) {
try {
file.delete();
...
public void assignSample111() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample111() {
...
public void missing_defaultSample111(int x) {
switch (x) {
case 0:
...
public List<String> getASample111() {
return a;
}

public void weakSample111() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
