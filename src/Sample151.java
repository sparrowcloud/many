...
String retNullSample151() {
    return null;
}

public BufferedInputStream getInputStreamSample151() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample151() {
    
    String x = retNullSample151();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample151() throws IOException {
BufferedInputStream i = getInputStreamSample151();
...
public void test_finalizeSample151() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample151() {
System.gc();
}

public void test_direct_management_of_connectionsSample151() {
try {
...
public native void testJNISample151();

public boolean equals(Sample151 obj) { /* BUG */
return true;
}
...
public void test_arraySample151() {
...
public void testRule2Sample151() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample151(Collection<Object> c) {
...
Sample151 other = (Sample151) o;
return (other.name.equals(""));
}

public void process_controlSample151() {
...
public int test_return_finallySample151(File file) {
try {
file.delete();
...
public void assignSample151() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample151() {
...
public void missing_defaultSample151(int x) {
switch (x) {
case 0:
...
public List<String> getASample151() {
return a;
}

public void weakSample151() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
