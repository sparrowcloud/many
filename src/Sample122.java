...
String retNullSample122() {
    return null;
}

public BufferedInputStream getInputStreamSample122() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample122() {
    
    String x = retNullSample122();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample122() throws IOException {
BufferedInputStream i = getInputStreamSample122();
...
public void test_finalizeSample122() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample122() {
System.gc();
}

public void test_direct_management_of_connectionsSample122() {
try {
...
public native void testJNISample122();

public boolean equals(Sample122 obj) { /* BUG */
return true;
}
...
public void test_arraySample122() {
...
public void testRule2Sample122() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample122(Collection<Object> c) {
...
Sample122 other = (Sample122) o;
return (other.name.equals(""));
}

public void process_controlSample122() {
...
public int test_return_finallySample122(File file) {
try {
file.delete();
...
public void assignSample122() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample122() {
...
public void missing_defaultSample122(int x) {
switch (x) {
case 0:
...
public List<String> getASample122() {
return a;
}

public void weakSample122() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
