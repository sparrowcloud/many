...
String retNullSample117() {
    return null;
}

public BufferedInputStream getInputStreamSample117() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample117() {
    
    String x = retNullSample117();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample117() throws IOException {
BufferedInputStream i = getInputStreamSample117();
...
public void test_finalizeSample117() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample117() {
System.gc();
}

public void test_direct_management_of_connectionsSample117() {
try {
...
public native void testJNISample117();

public boolean equals(Sample117 obj) { /* BUG */
return true;
}
...
public void test_arraySample117() {
...
public void testRule2Sample117() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample117(Collection<Object> c) {
...
Sample117 other = (Sample117) o;
return (other.name.equals(""));
}

public void process_controlSample117() {
...
public int test_return_finallySample117(File file) {
try {
file.delete();
...
public void assignSample117() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample117() {
...
public void missing_defaultSample117(int x) {
switch (x) {
case 0:
...
public List<String> getASample117() {
return a;
}

public void weakSample117() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
