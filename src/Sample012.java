...
public class Sample012{
    ...
    String retNullSample012() {
        return null;
    }

    public BufferedInputStream getInputStreamSample012() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample012() {

        String x = retNullSample012();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample012() throws IOException {
        BufferedInputStream i = getInputStreamSample012();
    ...
    public void test_finalizeSample012() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample012() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample012() {
        try {
    ...
    public native void testJNISample012();

    public boolean equals(Sample012 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample012() {
    ...
    public void testRule2Sample012() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample012(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample012 other = (Sample012) o;
        return (other.name.equals(""));
    }

    public void process_controlSample012() {
    ...
    public int test_return_finallySample012(File file) {
        try {
            file.delete();
    ...
    public void assignSample012() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample012() {
    ...
    public void missing_defaultSample012(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample012() {
        return a;
    }

    public void weakSample012() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
