...
public class Sample209 extends HttpServlet {
...
String retNullSample209() {
    return null;
}

public BufferedInputStream getInputStreamSample209() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample209() {
    
    String x = retNullSample209();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample209() throws IOException {
BufferedInputStream i = getInputStreamSample209();
...
public void test_finalizeSample209() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample209() {
System.gc();
}

public void test_direct_management_of_connectionsSample209() {
try {
...
public native void testJNISample209();

public boolean equals(Sample209 obj) { /* BUG */
return true;
}
...
public void test_arraySample209() {
...
public void testRule2Sample209() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample209(Collection<Object> c) {
...
Sample209 other = (Sample209) o;
return (other.name.equals(""));
}

public void process_controlSample209() {
...
public int test_return_finallySample209(File file) {
try {
file.delete();
...
public void assignSample209() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample209() {
...
public void missing_defaultSample209(int x) {
switch (x) {
case 0:
...
public List<String> getASample209() {
return a;
}

public void weakSample209() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
