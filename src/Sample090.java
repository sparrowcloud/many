...
public class Sample090 extends HttpServlet {
...
String retNullSample090() {
    return null;
}

public BufferedInputStream getInputStreamSample090() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample090() {
    
    String x = retNullSample090();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample090() throws IOException {
BufferedInputStream i = getInputStreamSample090();
...
public void test_finalizeSample090() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample090() {
System.gc();
}

public void test_direct_management_of_connectionsSample090() {
try {
...
public native void testJNISample090();

public boolean equals(Sample090 obj) { /* BUG */
return true;
}
...
public void test_arraySample090() {
...
public void testRule2Sample090() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample090(Collection<Object> c) {
...
Sample090 other = (Sample090) o;
return (other.name.equals(""));
}

public void process_controlSample090() {
...
public int test_return_finallySample090(File file) {
try {
file.delete();
...
public void assignSample090() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample090() {
...
public void missing_defaultSample090(int x) {
switch (x) {
case 0:
...
public List<String> getASample090() {
return a;
}

public void weakSample090() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
