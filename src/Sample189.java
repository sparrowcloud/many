...
public class Sample189 extends HttpServlet {
...
String retNullSample189() {
    return null;
}

public BufferedInputStream getInputStreamSample189() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample189() {
    
    String x = retNullSample189();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample189() throws IOException {
BufferedInputStream i = getInputStreamSample189();
...
public void test_finalizeSample189() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample189() {
System.gc();
}

public void test_direct_management_of_connectionsSample189() {
try {
...
public native void testJNISample189();

public boolean equals(Sample189 obj) { /* BUG */
return true;
}
...
public void test_arraySample189() {
...
public void testRule2Sample189() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample189(Collection<Object> c) {
...
Sample189 other = (Sample189) o;
return (other.name.equals(""));
}

public void process_controlSample189() {
...
public int test_return_finallySample189(File file) {
try {
file.delete();
...
public void assignSample189() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample189() {
...
public void missing_defaultSample189(int x) {
switch (x) {
case 0:
...
public List<String> getASample189() {
return a;
}

public void weakSample189() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
