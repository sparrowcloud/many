...
public class Sample255 extends HttpServlet {
...
String retNullSample255() {
    return null;
}

public BufferedInputStream getInputStreamSample255() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample255() {
    
    String x = retNullSample255();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample255() throws IOException {
BufferedInputStream i = getInputStreamSample255();
...
public void test_finalizeSample255() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample255() {
System.gc();
}

public void test_direct_management_of_connectionsSample255() {
try {
...
public native void testJNISample255();

public boolean equals(Sample255 obj) { /* BUG */
return true;
}
...
public void test_arraySample255() {
...
public void testRule2Sample255() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample255(Collection<Object> c) {
...
Sample255 other = (Sample255) o;
return (other.name.equals(""));
}

public void process_controlSample255() {
...
public int test_return_finallySample255(File file) {
try {
file.delete();
...
public void assignSample255() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample255() {
...
public void missing_defaultSample255(int x) {
switch (x) {
case 0:
...
public List<String> getASample255() {
return a;
}

public void weakSample255() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
