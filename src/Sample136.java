...
String retNullSample136() {
    return null;
}

public BufferedInputStream getInputStreamSample136() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample136() {
    
    String x = retNullSample136();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample136() throws IOException {
BufferedInputStream i = getInputStreamSample136();
...
public void test_finalizeSample136() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample136() {
System.gc();
}

public void test_direct_management_of_connectionsSample136() {
try {
...
public native void testJNISample136();

public boolean equals(Sample136 obj) { /* BUG */
return true;
}
...
public void test_arraySample136() {
...
public void testRule2Sample136() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample136(Collection<Object> c) {
...
Sample136 other = (Sample136) o;
return (other.name.equals(""));
}

public void process_controlSample136() {
...
public int test_return_finallySample136(File file) {
try {
file.delete();
...
public void assignSample136() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample136() {
...
public void missing_defaultSample136(int x) {
switch (x) {
case 0:
...
public List<String> getASample136() {
return a;
}

public void weakSample136() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
