...
public class Sample093 extends HttpServlet {
...
String retNullSample093() {
    return null;
}

public BufferedInputStream getInputStreamSample093() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample093() {
    
    String x = retNullSample093();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample093() throws IOException {
BufferedInputStream i = getInputStreamSample093();
...
public void test_finalizeSample093() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample093() {
System.gc();
}

public void test_direct_management_of_connectionsSample093() {
try {
...
public native void testJNISample093();

public boolean equals(Sample093 obj) { /* BUG */
return true;
}
...
public void test_arraySample093() {
...
public void testRule2Sample093() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample093(Collection<Object> c) {
...
Sample093 other = (Sample093) o;
return (other.name.equals(""));
}

public void process_controlSample093() {
...
public int test_return_finallySample093(File file) {
try {
file.delete();
...
public void assignSample093() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample093() {
...
public void missing_defaultSample093(int x) {
switch (x) {
case 0:
...
public List<String> getASample093() {
return a;
}

public void weakSample093() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
