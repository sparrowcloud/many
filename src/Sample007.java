...
String retNullSample007() {
    return null;
}

public BufferedInputStream getInputStreamSample007() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample007() {
    
    String x = retNullSample007();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample007() throws IOException {
BufferedInputStream i = getInputStreamSample007();
...
public void test_finalizeSample007() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample007() {
System.gc();
}

public void test_direct_management_of_connectionsSample007() {
try {
...
public native void testJNISample007();

public boolean equals(Sample007 obj) { /* BUG */
return true;
}
...
public void test_arraySample007() {
...
public void testRule2Sample007() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample007(Collection<Object> c) {
...
Sample007 other = (Sample007) o;
return (other.name.equals(""));
}

public void process_controlSample007() {
...
public int test_return_finallySample007(File file) {
try {
file.delete();
...
public void assignSample007() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample007() {
...
public void missing_defaultSample007(int x) {
switch (x) {
case 0:
...
public List<String> getASample007() {
return a;
}

public void weakSample007() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
