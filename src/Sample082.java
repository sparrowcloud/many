...
public class Sample082 extends HttpServlet {
...
String retNullSample082() {
    return null;
}

public BufferedInputStream getInputStreamSample082() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample082() {
    
    String x = retNullSample082();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample082() throws IOException {
BufferedInputStream i = getInputStreamSample082();
...
public void test_finalizeSample082() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample082() {
System.gc();
}

public void test_direct_management_of_connectionsSample082() {
try {
...
public native void testJNISample082();

public boolean equals(Sample082 obj) { /* BUG */
return true;
}
...
public void test_arraySample082() {
...
public void testRule2Sample082() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample082(Collection<Object> c) {
...
Sample082 other = (Sample082) o;
return (other.name.equals(""));
}

public void process_controlSample082() {
...
public int test_return_finallySample082(File file) {
try {
file.delete();
...
public void assignSample082() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample082() {
...
public void missing_defaultSample082(int x) {
switch (x) {
case 0:
...
public List<String> getASample082() {
return a;
}

public void weakSample082() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
