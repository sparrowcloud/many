...
public class Sample178 extends HttpServlet {
...
String retNullSample178() {
    return null;
}

public BufferedInputStream getInputStreamSample178() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample178() {
    
    String x = retNullSample178();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample178() throws IOException {
BufferedInputStream i = getInputStreamSample178();
...
public void test_finalizeSample178() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample178() {
System.gc();
}

public void test_direct_management_of_connectionsSample178() {
try {
...
public native void testJNISample178();

public boolean equals(Sample178 obj) { /* BUG */
return true;
}
...
public void test_arraySample178() {
...
public void testRule2Sample178() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample178(Collection<Object> c) {
...
Sample178 other = (Sample178) o;
return (other.name.equals(""));
}

public void process_controlSample178() {
...
public int test_return_finallySample178(File file) {
try {
file.delete();
...
public void assignSample178() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample178() {
...
public void missing_defaultSample178(int x) {
switch (x) {
case 0:
...
public List<String> getASample178() {
return a;
}

public void weakSample178() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
