...
String retNullSample002() {
    return null;
}

public BufferedInputStream getInputStreamSample002() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample002() {
    
    String x = retNullSample002();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample002() throws IOException {
BufferedInputStream i = getInputStreamSample002();
...
public void test_finalizeSample002() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample002() {
System.gc();
}

public void test_direct_management_of_connectionsSample002() {
try {
...
public native void testJNISample002();

public boolean equals(Sample002 obj) { /* BUG */
return true;
}
...
public void test_arraySample002() {
...
public void testRule2Sample002() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample002(Collection<Object> c) {
...
Sample002 other = (Sample002) o;
return (other.name.equals(""));
}

public void process_controlSample002() {
...
public int test_return_finallySample002(File file) {
try {
file.delete();
...
public void assignSample002() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample002() {
...
public void missing_defaultSample002(int x) {
switch (x) {
case 0:
...
public List<String> getASample002() {
return a;
}

public void weakSample002() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
