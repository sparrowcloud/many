...
public class Sample295 extends HttpServlet {
...
String retNullSample295() {
    return null;
}

public BufferedInputStream getInputStreamSample295() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample295() {
    
    String x = retNullSample295();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample295() throws IOException {
BufferedInputStream i = getInputStreamSample295();
...
public void test_finalizeSample295() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample295() {
System.gc();
}

public void test_direct_management_of_connectionsSample295() {
try {
...
public native void testJNISample295();

public boolean equals(Sample295 obj) { /* BUG */
return true;
}
...
public void test_arraySample295() {
...
public void testRule2Sample295() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample295(Collection<Object> c) {
...
Sample295 other = (Sample295) o;
return (other.name.equals(""));
}

public void process_controlSample295() {
...
public int test_return_finallySample295(File file) {
try {
file.delete();
...
public void assignSample295() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample295() {
...
public void missing_defaultSample295(int x) {
switch (x) {
case 0:
...
public List<String> getASample295() {
return a;
}

public void weakSample295() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
