...
public class Sample177 extends HttpServlet {
...
String retNullSample177() {
    return null;
}

public BufferedInputStream getInputStreamSample177() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample177() {
    
    String x = retNullSample177();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample177() throws IOException {
BufferedInputStream i = getInputStreamSample177();
...
public void test_finalizeSample177() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample177() {
System.gc();
}

public void test_direct_management_of_connectionsSample177() {
try {
...
public native void testJNISample177();

public boolean equals(Sample177 obj) { /* BUG */
return true;
}
...
public void test_arraySample177() {
...
public void testRule2Sample177() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample177(Collection<Object> c) {
...
Sample177 other = (Sample177) o;
return (other.name.equals(""));
}

public void process_controlSample177() {
...
public int test_return_finallySample177(File file) {
try {
file.delete();
...
public void assignSample177() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample177() {
...
public void missing_defaultSample177(int x) {
switch (x) {
case 0:
...
public List<String> getASample177() {
return a;
}

public void weakSample177() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
