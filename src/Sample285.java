...
public class Sample285 extends HttpServlet {
...
String retNullSample285() {
    return null;
}

public BufferedInputStream getInputStreamSample285() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample285() {
    
    String x = retNullSample285();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample285() throws IOException {
BufferedInputStream i = getInputStreamSample285();
...
public void test_finalizeSample285() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample285() {
System.gc();
}

public void test_direct_management_of_connectionsSample285() {
try {
...
public native void testJNISample285();

public boolean equals(Sample285 obj) { /* BUG */
return true;
}
...
public void test_arraySample285() {
...
public void testRule2Sample285() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample285(Collection<Object> c) {
...
Sample285 other = (Sample285) o;
return (other.name.equals(""));
}

public void process_controlSample285() {
...
public int test_return_finallySample285(File file) {
try {
file.delete();
...
public void assignSample285() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample285() {
...
public void missing_defaultSample285(int x) {
switch (x) {
case 0:
...
public List<String> getASample285() {
return a;
}

public void weakSample285() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
