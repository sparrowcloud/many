...
public class Sample157 extends HttpServlet {
...
String retNullSample157() {
    return null;
}

public BufferedInputStream getInputStreamSample157() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample157() {
    
    String x = retNullSample157();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample157() throws IOException {
BufferedInputStream i = getInputStreamSample157();
...
public void test_finalizeSample157() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample157() {
System.gc();
}

public void test_direct_management_of_connectionsSample157() {
try {
...
public native void testJNISample157();

public boolean equals(Sample157 obj) { /* BUG */
return true;
}
...
public void test_arraySample157() {
...
public void testRule2Sample157() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample157(Collection<Object> c) {
...
Sample157 other = (Sample157) o;
return (other.name.equals(""));
}

public void process_controlSample157() {
...
public int test_return_finallySample157(File file) {
try {
file.delete();
...
public void assignSample157() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample157() {
...
public void missing_defaultSample157(int x) {
switch (x) {
case 0:
...
public List<String> getASample157() {
return a;
}

public void weakSample157() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
