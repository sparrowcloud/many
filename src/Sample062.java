...
public class Sample062 extends HttpServlet {
...
String retNullSample062() {
    return null;
}

public BufferedInputStream getInputStreamSample062() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample062() {
    
    String x = retNullSample062();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample062() throws IOException {
BufferedInputStream i = getInputStreamSample062();
...
public void test_finalizeSample062() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample062() {
System.gc();
}

public void test_direct_management_of_connectionsSample062() {
try {
...
public native void testJNISample062();

public boolean equals(Sample062 obj) { /* BUG */
return true;
}
...
public void test_arraySample062() {
...
public void testRule2Sample062() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample062(Collection<Object> c) {
...
Sample062 other = (Sample062) o;
return (other.name.equals(""));
}

public void process_controlSample062() {
...
public int test_return_finallySample062(File file) {
try {
file.delete();
...
public void assignSample062() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample062() {
...
public void missing_defaultSample062(int x) {
switch (x) {
case 0:
...
public List<String> getASample062() {
return a;
}

public void weakSample062() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
