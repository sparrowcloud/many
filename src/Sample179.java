...
public class Sample179 extends HttpServlet {
...
String retNullSample179() {
    return null;
}

public BufferedInputStream getInputStreamSample179() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample179() {
    
    String x = retNullSample179();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample179() throws IOException {
BufferedInputStream i = getInputStreamSample179();
...
public void test_finalizeSample179() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample179() {
System.gc();
}

public void test_direct_management_of_connectionsSample179() {
try {
...
public native void testJNISample179();

public boolean equals(Sample179 obj) { /* BUG */
return true;
}
...
public void test_arraySample179() {
...
public void testRule2Sample179() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample179(Collection<Object> c) {
...
Sample179 other = (Sample179) o;
return (other.name.equals(""));
}

public void process_controlSample179() {
...
public int test_return_finallySample179(File file) {
try {
file.delete();
...
public void assignSample179() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample179() {
...
public void missing_defaultSample179(int x) {
switch (x) {
case 0:
...
public List<String> getASample179() {
return a;
}

public void weakSample179() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
