...
public class Sample148 extends HttpServlet {
...
String retNullSample148() {
    return null;
}

public BufferedInputStream getInputStreamSample148() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample148() {
    
    String x = retNullSample148();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample148() throws IOException {
BufferedInputStream i = getInputStreamSample148();
...
public void test_finalizeSample148() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample148() {
System.gc();
}

public void test_direct_management_of_connectionsSample148() {
try {
...
public native void testJNISample148();

public boolean equals(Sample148 obj) { /* BUG */
return true;
}
...
public void test_arraySample148() {
...
public void testRule2Sample148() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample148(Collection<Object> c) {
...
Sample148 other = (Sample148) o;
return (other.name.equals(""));
}

public void process_controlSample148() {
...
public int test_return_finallySample148(File file) {
try {
file.delete();
...
public void assignSample148() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample148() {
...
public void missing_defaultSample148(int x) {
switch (x) {
case 0:
...
public List<String> getASample148() {
return a;
}

public void weakSample148() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
