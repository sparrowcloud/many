...
public class Sample215 extends HttpServlet {
...
String retNullSample215() {
    return null;
}

public BufferedInputStream getInputStreamSample215() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample215() {
    
    String x = retNullSample215();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample215() throws IOException {
BufferedInputStream i = getInputStreamSample215();
...
public void test_finalizeSample215() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample215() {
System.gc();
}

public void test_direct_management_of_connectionsSample215() {
try {
...
public native void testJNISample215();

public boolean equals(Sample215 obj) { /* BUG */
return true;
}
...
public void test_arraySample215() {
...
public void testRule2Sample215() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample215(Collection<Object> c) {
...
Sample215 other = (Sample215) o;
return (other.name.equals(""));
}

public void process_controlSample215() {
...
public int test_return_finallySample215(File file) {
try {
file.delete();
...
public void assignSample215() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample215() {
...
public void missing_defaultSample215(int x) {
switch (x) {
case 0:
...
public List<String> getASample215() {
return a;
}

public void weakSample215() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
