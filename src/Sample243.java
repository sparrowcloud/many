...
public class Sample243 extends HttpServlet {
...
String retNullSample243() {
    return null;
}

public BufferedInputStream getInputStreamSample243() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample243() {
    
    String x = retNullSample243();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample243() throws IOException {
BufferedInputStream i = getInputStreamSample243();
...
public void test_finalizeSample243() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample243() {
System.gc();
}

public void test_direct_management_of_connectionsSample243() {
try {
...
public native void testJNISample243();

public boolean equals(Sample243 obj) { /* BUG */
return true;
}
...
public void test_arraySample243() {
...
public void testRule2Sample243() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample243(Collection<Object> c) {
...
Sample243 other = (Sample243) o;
return (other.name.equals(""));
}

public void process_controlSample243() {
...
public int test_return_finallySample243(File file) {
try {
file.delete();
...
public void assignSample243() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample243() {
...
public void missing_defaultSample243(int x) {
switch (x) {
case 0:
...
public List<String> getASample243() {
return a;
}

public void weakSample243() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
