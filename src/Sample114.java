...
String retNullSample114() {
    return null;
}

public BufferedInputStream getInputStreamSample114() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample114() {
    
    String x = retNullSample114();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample114() throws IOException {
BufferedInputStream i = getInputStreamSample114();
...
public void test_finalizeSample114() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample114() {
System.gc();
}

public void test_direct_management_of_connectionsSample114() {
try {
...
public native void testJNISample114();

public boolean equals(Sample114 obj) { /* BUG */
return true;
}
...
public void test_arraySample114() {
...
public void testRule2Sample114() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample114(Collection<Object> c) {
...
Sample114 other = (Sample114) o;
return (other.name.equals(""));
}

public void process_controlSample114() {
...
public int test_return_finallySample114(File file) {
try {
file.delete();
...
public void assignSample114() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample114() {
...
public void missing_defaultSample114(int x) {
switch (x) {
case 0:
...
public List<String> getASample114() {
return a;
}

public void weakSample114() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
