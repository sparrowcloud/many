...
String retNullSample084() {
    return null;
}

public BufferedInputStream getInputStreamSample084() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample084() {
    
    String x = retNullSample084();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample084() throws IOException {
BufferedInputStream i = getInputStreamSample084();
...
public void test_finalizeSample084() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample084() {
System.gc();
}

public void test_direct_management_of_connectionsSample084() {
try {
...
public native void testJNISample084();

public boolean equals(Sample084 obj) { /* BUG */
return true;
}
...
public void test_arraySample084() {
...
public void testRule2Sample084() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample084(Collection<Object> c) {
...
Sample084 other = (Sample084) o;
return (other.name.equals(""));
}

public void process_controlSample084() {
...
public int test_return_finallySample084(File file) {
try {
file.delete();
...
public void assignSample084() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample084() {
...
public void missing_defaultSample084(int x) {
switch (x) {
case 0:
...
public List<String> getASample084() {
return a;
}

public void weakSample084() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
