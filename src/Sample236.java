...
public class Sample236 extends HttpServlet {
...
String retNullSample236() {
    return null;
}

public BufferedInputStream getInputStreamSample236() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample236() {
    
    String x = retNullSample236();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample236() throws IOException {
BufferedInputStream i = getInputStreamSample236();
...
public void test_finalizeSample236() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample236() {
System.gc();
}

public void test_direct_management_of_connectionsSample236() {
try {
...
public native void testJNISample236();

public boolean equals(Sample236 obj) { /* BUG */
return true;
}
...
public void test_arraySample236() {
...
public void testRule2Sample236() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample236(Collection<Object> c) {
...
Sample236 other = (Sample236) o;
return (other.name.equals(""));
}

public void process_controlSample236() {
...
public int test_return_finallySample236(File file) {
try {
file.delete();
...
public void assignSample236() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample236() {
...
public void missing_defaultSample236(int x) {
switch (x) {
case 0:
...
public List<String> getASample236() {
return a;
}

public void weakSample236() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
