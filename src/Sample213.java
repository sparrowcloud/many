...
public class Sample213 extends HttpServlet {
...
String retNullSample213() {
    return null;
}

public BufferedInputStream getInputStreamSample213() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample213() {
    
    String x = retNullSample213();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample213() throws IOException {
BufferedInputStream i = getInputStreamSample213();
...
public void test_finalizeSample213() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample213() {
System.gc();
}

public void test_direct_management_of_connectionsSample213() {
try {
...
public native void testJNISample213();

public boolean equals(Sample213 obj) { /* BUG */
return true;
}
...
public void test_arraySample213() {
...
public void testRule2Sample213() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample213(Collection<Object> c) {
...
Sample213 other = (Sample213) o;
return (other.name.equals(""));
}

public void process_controlSample213() {
...
public int test_return_finallySample213(File file) {
try {
file.delete();
...
public void assignSample213() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample213() {
...
public void missing_defaultSample213(int x) {
switch (x) {
case 0:
...
public List<String> getASample213() {
return a;
}

public void weakSample213() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
