...
public class Sample134 extends HttpServlet {
...
String retNullSample134() {
    return null;
}

public BufferedInputStream getInputStreamSample134() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample134() {
    
    String x = retNullSample134();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample134() throws IOException {
BufferedInputStream i = getInputStreamSample134();
...
public void test_finalizeSample134() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample134() {
System.gc();
}

public void test_direct_management_of_connectionsSample134() {
try {
...
public native void testJNISample134();

public boolean equals(Sample134 obj) { /* BUG */
return true;
}
...
public void test_arraySample134() {
...
public void testRule2Sample134() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample134(Collection<Object> c) {
...
Sample134 other = (Sample134) o;
return (other.name.equals(""));
}

public void process_controlSample134() {
...
public int test_return_finallySample134(File file) {
try {
file.delete();
...
public void assignSample134() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample134() {
...
public void missing_defaultSample134(int x) {
switch (x) {
case 0:
...
public List<String> getASample134() {
return a;
}

public void weakSample134() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
