...
public class Sample040 extends HttpServlet {
...
String retNullSample040() {
    return null;
}

public BufferedInputStream getInputStreamSample040() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample040() {
    
    String x = retNullSample040();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample040() throws IOException {
BufferedInputStream i = getInputStreamSample040();
...
public void test_finalizeSample040() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample040() {
System.gc();
}

public void test_direct_management_of_connectionsSample040() {
try {
...
public native void testJNISample040();

public boolean equals(Sample040 obj) { /* BUG */
return true;
}
...
public void test_arraySample040() {
...
public void testRule2Sample040() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample040(Collection<Object> c) {
...
Sample040 other = (Sample040) o;
return (other.name.equals(""));
}

public void process_controlSample040() {
...
public int test_return_finallySample040(File file) {
try {
file.delete();
...
public void assignSample040() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample040() {
...
public void missing_defaultSample040(int x) {
switch (x) {
case 0:
...
public List<String> getASample040() {
return a;
}

public void weakSample040() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
