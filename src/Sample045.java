...
public class Sample045 extends HttpServlet {
...
String retNullSample045() {
    return null;
}

public BufferedInputStream getInputStreamSample045() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample045() {
    
    String x = retNullSample045();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample045() throws IOException {
BufferedInputStream i = getInputStreamSample045();
...
public void test_finalizeSample045() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample045() {
System.gc();
}

public void test_direct_management_of_connectionsSample045() {
try {
...
public native void testJNISample045();

public boolean equals(Sample045 obj) { /* BUG */
return true;
}
...
public void test_arraySample045() {
...
public void testRule2Sample045() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample045(Collection<Object> c) {
...
Sample045 other = (Sample045) o;
return (other.name.equals(""));
}

public void process_controlSample045() {
...
public int test_return_finallySample045(File file) {
try {
file.delete();
...
public void assignSample045() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample045() {
...
public void missing_defaultSample045(int x) {
switch (x) {
case 0:
...
public List<String> getASample045() {
return a;
}

public void weakSample045() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
