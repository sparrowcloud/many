...
public class Sample046 extends HttpServlet {
...
String retNullSample046() {
    return null;
}

public BufferedInputStream getInputStreamSample046() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample046() {
    
    String x = retNullSample046();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample046() throws IOException {
BufferedInputStream i = getInputStreamSample046();
...
public void test_finalizeSample046() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample046() {
System.gc();
}

public void test_direct_management_of_connectionsSample046() {
try {
...
public native void testJNISample046();

public boolean equals(Sample046 obj) { /* BUG */
return true;
}
...
public void test_arraySample046() {
...
public void testRule2Sample046() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample046(Collection<Object> c) {
...
Sample046 other = (Sample046) o;
return (other.name.equals(""));
}

public void process_controlSample046() {
...
public int test_return_finallySample046(File file) {
try {
file.delete();
...
public void assignSample046() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample046() {
...
public void missing_defaultSample046(int x) {
switch (x) {
case 0:
...
public List<String> getASample046() {
return a;
}

public void weakSample046() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
