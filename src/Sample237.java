...
public class Sample237 extends HttpServlet {
...
String retNullSample237() {
    return null;
}

public BufferedInputStream getInputStreamSample237() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample237() {
    
    String x = retNullSample237();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample237() throws IOException {
BufferedInputStream i = getInputStreamSample237();
...
public void test_finalizeSample237() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample237() {
System.gc();
}

public void test_direct_management_of_connectionsSample237() {
try {
...
public native void testJNISample237();

public boolean equals(Sample237 obj) { /* BUG */
return true;
}
...
public void test_arraySample237() {
...
public void testRule2Sample237() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample237(Collection<Object> c) {
...
Sample237 other = (Sample237) o;
return (other.name.equals(""));
}

public void process_controlSample237() {
...
public int test_return_finallySample237(File file) {
try {
file.delete();
...
public void assignSample237() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample237() {
...
public void missing_defaultSample237(int x) {
switch (x) {
case 0:
...
public List<String> getASample237() {
return a;
}

public void weakSample237() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
