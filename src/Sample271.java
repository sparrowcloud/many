...
public class Sample271 extends HttpServlet {
...
String retNullSample271() {
    return null;
}

public BufferedInputStream getInputStreamSample271() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample271() {
    
    String x = retNullSample271();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample271() throws IOException {
BufferedInputStream i = getInputStreamSample271();
...
public void test_finalizeSample271() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample271() {
System.gc();
}

public void test_direct_management_of_connectionsSample271() {
try {
...
public native void testJNISample271();

public boolean equals(Sample271 obj) { /* BUG */
return true;
}
...
public void test_arraySample271() {
...
public void testRule2Sample271() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample271(Collection<Object> c) {
...
Sample271 other = (Sample271) o;
return (other.name.equals(""));
}

public void process_controlSample271() {
...
public int test_return_finallySample271(File file) {
try {
file.delete();
...
public void assignSample271() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample271() {
...
public void missing_defaultSample271(int x) {
switch (x) {
case 0:
...
public List<String> getASample271() {
return a;
}

public void weakSample271() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
