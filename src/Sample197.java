...
public class Sample197 extends HttpServlet {
...
String retNullSample197() {
    return null;
}

public BufferedInputStream getInputStreamSample197() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample197() {
    
    String x = retNullSample197();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample197() throws IOException {
BufferedInputStream i = getInputStreamSample197();
...
public void test_finalizeSample197() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample197() {
System.gc();
}

public void test_direct_management_of_connectionsSample197() {
try {
...
public native void testJNISample197();

public boolean equals(Sample197 obj) { /* BUG */
return true;
}
...
public void test_arraySample197() {
...
public void testRule2Sample197() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample197(Collection<Object> c) {
...
Sample197 other = (Sample197) o;
return (other.name.equals(""));
}

public void process_controlSample197() {
...
public int test_return_finallySample197(File file) {
try {
file.delete();
...
public void assignSample197() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample197() {
...
public void missing_defaultSample197(int x) {
switch (x) {
case 0:
...
public List<String> getASample197() {
return a;
}

public void weakSample197() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
