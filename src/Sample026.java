...
String retNullSample026() {
    return null;
}

public BufferedInputStream getInputStreamSample026() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample026() {
    
    String x = retNullSample026();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample026() throws IOException {
BufferedInputStream i = getInputStreamSample026();
...
public void test_finalizeSample026() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample026() {
System.gc();
}

public void test_direct_management_of_connectionsSample026() {
try {
...
public native void testJNISample026();

public boolean equals(Sample026 obj) { /* BUG */
return true;
}
...
public void test_arraySample026() {
...
public void testRule2Sample026() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample026(Collection<Object> c) {
...
Sample026 other = (Sample026) o;
return (other.name.equals(""));
}

public void process_controlSample026() {
...
public int test_return_finallySample026(File file) {
try {
file.delete();
...
public void assignSample026() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample026() {
...
public void missing_defaultSample026(int x) {
switch (x) {
case 0:
...
public List<String> getASample026() {
return a;
}

public void weakSample026() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
