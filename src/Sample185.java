...
public class Sample185 extends HttpServlet {
...
String retNullSample185() {
    return null;
}

public BufferedInputStream getInputStreamSample185() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample185() {
    
    String x = retNullSample185();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample185() throws IOException {
BufferedInputStream i = getInputStreamSample185();
...
public void test_finalizeSample185() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample185() {
System.gc();
}

public void test_direct_management_of_connectionsSample185() {
try {
...
public native void testJNISample185();

public boolean equals(Sample185 obj) { /* BUG */
return true;
}
...
public void test_arraySample185() {
...
public void testRule2Sample185() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample185(Collection<Object> c) {
...
Sample185 other = (Sample185) o;
return (other.name.equals(""));
}

public void process_controlSample185() {
...
public int test_return_finallySample185(File file) {
try {
file.delete();
...
public void assignSample185() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample185() {
...
public void missing_defaultSample185(int x) {
switch (x) {
case 0:
...
public List<String> getASample185() {
return a;
}

public void weakSample185() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
