...
public class Sample011 extends HttpServlet {
...
String retNullSample011() {
    return null;
}

public BufferedInputStream getInputStreamSample011() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample011() {
    
    String x = retNullSample011();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample011() throws IOException {
BufferedInputStream i = getInputStreamSample011();
...
public void test_finalizeSample011() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample011() {
System.gc();
}

public void test_direct_management_of_connectionsSample011() {
try {
...
public native void testJNISample011();

public boolean equals(Sample011 obj) { /* BUG */
return true;
}
...
public void test_arraySample011() {
...
public void testRule2Sample011() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample011(Collection<Object> c) {
...
Sample011 other = (Sample011) o;
return (other.name.equals(""));
}

public void process_controlSample011() {
...
public int test_return_finallySample011(File file) {
try {
file.delete();
...
public void assignSample011() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample011() {
...
public void missing_defaultSample011(int x) {
switch (x) {
case 0:
...
public List<String> getASample011() {
return a;
}

public void weakSample011() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
