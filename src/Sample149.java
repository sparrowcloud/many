...
public class Sample149 extends HttpServlet {
...
String retNullSample149() {
    return null;
}

public BufferedInputStream getInputStreamSample149() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample149() {
    
    String x = retNullSample149();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample149() throws IOException {
BufferedInputStream i = getInputStreamSample149();
...
public void test_finalizeSample149() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample149() {
System.gc();
}

public void test_direct_management_of_connectionsSample149() {
try {
...
public native void testJNISample149();

public boolean equals(Sample149 obj) { /* BUG */
return true;
}
...
public void test_arraySample149() {
...
public void testRule2Sample149() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample149(Collection<Object> c) {
...
Sample149 other = (Sample149) o;
return (other.name.equals(""));
}

public void process_controlSample149() {
...
public int test_return_finallySample149(File file) {
try {
file.delete();
...
public void assignSample149() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample149() {
...
public void missing_defaultSample149(int x) {
switch (x) {
case 0:
...
public List<String> getASample149() {
return a;
}

public void weakSample149() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
