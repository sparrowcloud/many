...
public class Sample286 extends HttpServlet {
...
String retNullSample286() {
    return null;
}

public BufferedInputStream getInputStreamSample286() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample286() {
    
    String x = retNullSample286();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample286() throws IOException {
BufferedInputStream i = getInputStreamSample286();
...
public void test_finalizeSample286() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample286() {
System.gc();
}

public void test_direct_management_of_connectionsSample286() {
try {
...
public native void testJNISample286();

public boolean equals(Sample286 obj) { /* BUG */
return true;
}
...
public void test_arraySample286() {
...
public void testRule2Sample286() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample286(Collection<Object> c) {
...
Sample286 other = (Sample286) o;
return (other.name.equals(""));
}

public void process_controlSample286() {
...
public int test_return_finallySample286(File file) {
try {
file.delete();
...
public void assignSample286() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample286() {
...
public void missing_defaultSample286(int x) {
switch (x) {
case 0:
...
public List<String> getASample286() {
return a;
}

public void weakSample286() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
