...
public class Sample244 extends HttpServlet {
...
String retNullSample244() {
    return null;
}

public BufferedInputStream getInputStreamSample244() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample244() {
    
    String x = retNullSample244();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample244() throws IOException {
BufferedInputStream i = getInputStreamSample244();
...
public void test_finalizeSample244() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample244() {
System.gc();
}

public void test_direct_management_of_connectionsSample244() {
try {
...
public native void testJNISample244();

public boolean equals(Sample244 obj) { /* BUG */
return true;
}
...
public void test_arraySample244() {
...
public void testRule2Sample244() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample244(Collection<Object> c) {
...
Sample244 other = (Sample244) o;
return (other.name.equals(""));
}

public void process_controlSample244() {
...
public int test_return_finallySample244(File file) {
try {
file.delete();
...
public void assignSample244() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample244() {
...
public void missing_defaultSample244(int x) {
switch (x) {
case 0:
...
public List<String> getASample244() {
return a;
}

public void weakSample244() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
