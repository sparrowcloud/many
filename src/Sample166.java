...
public class Sample166 extends HttpServlet {
...
String retNullSample166() {
    return null;
}

public BufferedInputStream getInputStreamSample166() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample166() {
    
    String x = retNullSample166();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample166() throws IOException {
BufferedInputStream i = getInputStreamSample166();
...
public void test_finalizeSample166() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample166() {
System.gc();
}

public void test_direct_management_of_connectionsSample166() {
try {
...
public native void testJNISample166();

public boolean equals(Sample166 obj) { /* BUG */
return true;
}
...
public void test_arraySample166() {
...
public void testRule2Sample166() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample166(Collection<Object> c) {
...
Sample166 other = (Sample166) o;
return (other.name.equals(""));
}

public void process_controlSample166() {
...
public int test_return_finallySample166(File file) {
try {
file.delete();
...
public void assignSample166() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample166() {
...
public void missing_defaultSample166(int x) {
switch (x) {
case 0:
...
public List<String> getASample166() {
return a;
}

public void weakSample166() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
