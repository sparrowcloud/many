...
public class Sample299 extends HttpServlet {
...
String retNullSample299() {
    return null;
}

public BufferedInputStream getInputStreamSample299() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample299() {
    
    String x = retNullSample299();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample299() throws IOException {
BufferedInputStream i = getInputStreamSample299();
...
public void test_finalizeSample299() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample299() {
System.gc();
}

public void test_direct_management_of_connectionsSample299() {
try {
...
public native void testJNISample299();

public boolean equals(Sample299 obj) { /* BUG */
return true;
}
...
public void test_arraySample299() {
...
public void testRule2Sample299() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample299(Collection<Object> c) {
...
Sample299 other = (Sample299) o;
return (other.name.equals(""));
}

public void process_controlSample299() {
...
public int test_return_finallySample299(File file) {
try {
file.delete();
...
public void assignSample299() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample299() {
...
public void missing_defaultSample299(int x) {
switch (x) {
case 0:
...
public List<String> getASample299() {
return a;
}

public void weakSample299() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
