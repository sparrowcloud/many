...
public class Sample080 extends HttpServlet {
...
String retNullSample080() {
    return null;
}

public BufferedInputStream getInputStreamSample080() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample080() {
    
    String x = retNullSample080();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample080() throws IOException {
BufferedInputStream i = getInputStreamSample080();
...
public void test_finalizeSample080() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample080() {
System.gc();
}

public void test_direct_management_of_connectionsSample080() {
try {
...
public native void testJNISample080();

public boolean equals(Sample080 obj) { /* BUG */
return true;
}
...
public void test_arraySample080() {
...
public void testRule2Sample080() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample080(Collection<Object> c) {
...
Sample080 other = (Sample080) o;
return (other.name.equals(""));
}

public void process_controlSample080() {
...
public int test_return_finallySample080(File file) {
try {
file.delete();
...
public void assignSample080() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample080() {
...
public void missing_defaultSample080(int x) {
switch (x) {
case 0:
...
public List<String> getASample080() {
return a;
}

public void weakSample080() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
