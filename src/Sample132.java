...
String retNullSample132() {
    return null;
}

public BufferedInputStream getInputStreamSample132() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample132() {
    
    String x = retNullSample132();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample132() throws IOException {
BufferedInputStream i = getInputStreamSample132();
...
public void test_finalizeSample132() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample132() {
System.gc();
}

public void test_direct_management_of_connectionsSample132() {
try {
...
public native void testJNISample132();

public boolean equals(Sample132 obj) { /* BUG */
return true;
}
...
public void test_arraySample132() {
...
public void testRule2Sample132() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample132(Collection<Object> c) {
...
Sample132 other = (Sample132) o;
return (other.name.equals(""));
}

public void process_controlSample132() {
...
public int test_return_finallySample132(File file) {
try {
file.delete();
...
public void assignSample132() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample132() {
...
public void missing_defaultSample132(int x) {
switch (x) {
case 0:
...
public List<String> getASample132() {
return a;
}

public void weakSample132() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
