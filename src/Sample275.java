...
public class Sample275 extends HttpServlet {
...
String retNullSample275() {
    return null;
}

public BufferedInputStream getInputStreamSample275() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample275() {
    
    String x = retNullSample275();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample275() throws IOException {
BufferedInputStream i = getInputStreamSample275();
...
public void test_finalizeSample275() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample275() {
System.gc();
}

public void test_direct_management_of_connectionsSample275() {
try {
...
public native void testJNISample275();

public boolean equals(Sample275 obj) { /* BUG */
return true;
}
...
public void test_arraySample275() {
...
public void testRule2Sample275() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample275(Collection<Object> c) {
...
Sample275 other = (Sample275) o;
return (other.name.equals(""));
}

public void process_controlSample275() {
...
public int test_return_finallySample275(File file) {
try {
file.delete();
...
public void assignSample275() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample275() {
...
public void missing_defaultSample275(int x) {
switch (x) {
case 0:
...
public List<String> getASample275() {
return a;
}

public void weakSample275() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
