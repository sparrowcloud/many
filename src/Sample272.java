...
public class Sample272 extends HttpServlet {
...
String retNullSample272() {
    return null;
}

public BufferedInputStream getInputStreamSample272() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample272() {
    
    String x = retNullSample272();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample272() throws IOException {
BufferedInputStream i = getInputStreamSample272();
...
public void test_finalizeSample272() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample272() {
System.gc();
}

public void test_direct_management_of_connectionsSample272() {
try {
...
public native void testJNISample272();

public boolean equals(Sample272 obj) { /* BUG */
return true;
}
...
public void test_arraySample272() {
...
public void testRule2Sample272() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample272(Collection<Object> c) {
...
Sample272 other = (Sample272) o;
return (other.name.equals(""));
}

public void process_controlSample272() {
...
public int test_return_finallySample272(File file) {
try {
file.delete();
...
public void assignSample272() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample272() {
...
public void missing_defaultSample272(int x) {
switch (x) {
case 0:
...
public List<String> getASample272() {
return a;
}

public void weakSample272() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
