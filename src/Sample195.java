...
public class Sample195 extends HttpServlet {
...
String retNullSample195() {
    return null;
}

public BufferedInputStream getInputStreamSample195() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample195() {
    
    String x = retNullSample195();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample195() throws IOException {
BufferedInputStream i = getInputStreamSample195();
...
public void test_finalizeSample195() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample195() {
System.gc();
}

public void test_direct_management_of_connectionsSample195() {
try {
...
public native void testJNISample195();

public boolean equals(Sample195 obj) { /* BUG */
return true;
}
...
public void test_arraySample195() {
...
public void testRule2Sample195() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample195(Collection<Object> c) {
...
Sample195 other = (Sample195) o;
return (other.name.equals(""));
}

public void process_controlSample195() {
...
public int test_return_finallySample195(File file) {
try {
file.delete();
...
public void assignSample195() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample195() {
...
public void missing_defaultSample195(int x) {
switch (x) {
case 0:
...
public List<String> getASample195() {
return a;
}

public void weakSample195() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
