...
String retNullSample103() {
    return null;
}

public BufferedInputStream getInputStreamSample103() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample103() {
    
    String x = retNullSample103();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample103() throws IOException {
BufferedInputStream i = getInputStreamSample103();
...
public void test_finalizeSample103() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample103() {
System.gc();
}

public void test_direct_management_of_connectionsSample103() {
try {
...
public native void testJNISample103();

public boolean equals(Sample103 obj) { /* BUG */
return true;
}
...
public void test_arraySample103() {
...
public void testRule2Sample103() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample103(Collection<Object> c) {
...
Sample103 other = (Sample103) o;
return (other.name.equals(""));
}

public void process_controlSample103() {
...
public int test_return_finallySample103(File file) {
try {
file.delete();
...
public void assignSample103() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample103() {
...
public void missing_defaultSample103(int x) {
switch (x) {
case 0:
...
public List<String> getASample103() {
return a;
}

public void weakSample103() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
