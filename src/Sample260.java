...
public class Sample260 extends HttpServlet {
...
String retNullSample260() {
    return null;
}

public BufferedInputStream getInputStreamSample260() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample260() {
    
    String x = retNullSample260();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample260() throws IOException {
BufferedInputStream i = getInputStreamSample260();
...
public void test_finalizeSample260() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample260() {
System.gc();
}

public void test_direct_management_of_connectionsSample260() {
try {
...
public native void testJNISample260();

public boolean equals(Sample260 obj) { /* BUG */
return true;
}
...
public void test_arraySample260() {
...
public void testRule2Sample260() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample260(Collection<Object> c) {
...
Sample260 other = (Sample260) o;
return (other.name.equals(""));
}

public void process_controlSample260() {
...
public int test_return_finallySample260(File file) {
try {
file.delete();
...
public void assignSample260() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample260() {
...
public void missing_defaultSample260(int x) {
switch (x) {
case 0:
...
public List<String> getASample260() {
return a;
}

public void weakSample260() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
