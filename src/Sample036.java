...
public class Sample036 extends HttpServlet {
...
String retNullSample036() {
    return null;
}

public BufferedInputStream getInputStreamSample036() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample036() {
    
    String x = retNullSample036();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample036() throws IOException {
BufferedInputStream i = getInputStreamSample036();
...
public void test_finalizeSample036() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample036() {
System.gc();
}

public void test_direct_management_of_connectionsSample036() {
try {
...
public native void testJNISample036();

public boolean equals(Sample036 obj) { /* BUG */
return true;
}
...
public void test_arraySample036() {
...
public void testRule2Sample036() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample036(Collection<Object> c) {
...
Sample036 other = (Sample036) o;
return (other.name.equals(""));
}

public void process_controlSample036() {
...
public int test_return_finallySample036(File file) {
try {
file.delete();
...
public void assignSample036() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample036() {
...
public void missing_defaultSample036(int x) {
switch (x) {
case 0:
...
public List<String> getASample036() {
return a;
}

public void weakSample036() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
