...
public class Sample029 extends HttpServlet {
...
String retNullSample029() {
    return null;
}

public BufferedInputStream getInputStreamSample029() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample029() {
    
    String x = retNullSample029();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample029() throws IOException {
BufferedInputStream i = getInputStreamSample029();
...
public void test_finalizeSample029() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample029() {
System.gc();
}

public void test_direct_management_of_connectionsSample029() {
try {
...
public native void testJNISample029();

public boolean equals(Sample029 obj) { /* BUG */
return true;
}
...
public void test_arraySample029() {
...
public void testRule2Sample029() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample029(Collection<Object> c) {
...
Sample029 other = (Sample029) o;
return (other.name.equals(""));
}

public void process_controlSample029() {
...
public int test_return_finallySample029(File file) {
try {
file.delete();
...
public void assignSample029() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample029() {
...
public void missing_defaultSample029(int x) {
switch (x) {
case 0:
...
public List<String> getASample029() {
return a;
}

public void weakSample029() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
