...
String retNullSample129() {
    return null;
}

public BufferedInputStream getInputStreamSample129() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample129() {
    
    String x = retNullSample129();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample129() throws IOException {
BufferedInputStream i = getInputStreamSample129();
...
public void test_finalizeSample129() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample129() {
System.gc();
}

public void test_direct_management_of_connectionsSample129() {
try {
...
public native void testJNISample129();

public boolean equals(Sample129 obj) { /* BUG */
return true;
}
...
public void test_arraySample129() {
...
public void testRule2Sample129() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample129(Collection<Object> c) {
...
Sample129 other = (Sample129) o;
return (other.name.equals(""));
}

public void process_controlSample129() {
...
public int test_return_finallySample129(File file) {
try {
file.delete();
...
public void assignSample129() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample129() {
...
public void missing_defaultSample129(int x) {
switch (x) {
case 0:
...
public List<String> getASample129() {
return a;
}

public void weakSample129() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
