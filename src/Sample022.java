...
public class Sample022 extends HttpServlet {
...
String retNullSample022() {
    return null;
}

public BufferedInputStream getInputStreamSample022() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample022() {
    
    String x = retNullSample022();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample022() throws IOException {
BufferedInputStream i = getInputStreamSample022();
...
public void test_finalizeSample022() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample022() {
System.gc();
}

public void test_direct_management_of_connectionsSample022() {
try {
...
public native void testJNISample022();

public boolean equals(Sample022 obj) { /* BUG */
return true;
}
...
public void test_arraySample022() {
...
public void testRule2Sample022() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample022(Collection<Object> c) {
...
Sample022 other = (Sample022) o;
return (other.name.equals(""));
}

public void process_controlSample022() {
...
public int test_return_finallySample022(File file) {
try {
file.delete();
...
public void assignSample022() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample022() {
...
public void missing_defaultSample022(int x) {
switch (x) {
case 0:
...
public List<String> getASample022() {
return a;
}

public void weakSample022() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
