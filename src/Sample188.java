...
public class Sample188 extends HttpServlet {
...
String retNullSample188() {
    return null;
}

public BufferedInputStream getInputStreamSample188() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample188() {
    
    String x = retNullSample188();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample188() throws IOException {
BufferedInputStream i = getInputStreamSample188();
...
public void test_finalizeSample188() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample188() {
System.gc();
}

public void test_direct_management_of_connectionsSample188() {
try {
...
public native void testJNISample188();

public boolean equals(Sample188 obj) { /* BUG */
return true;
}
...
public void test_arraySample188() {
...
public void testRule2Sample188() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample188(Collection<Object> c) {
...
Sample188 other = (Sample188) o;
return (other.name.equals(""));
}

public void process_controlSample188() {
...
public int test_return_finallySample188(File file) {
try {
file.delete();
...
public void assignSample188() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample188() {
...
public void missing_defaultSample188(int x) {
switch (x) {
case 0:
...
public List<String> getASample188() {
return a;
}

public void weakSample188() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
