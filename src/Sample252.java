...
public class Sample252 extends HttpServlet {
...
String retNullSample252() {
    return null;
}

public BufferedInputStream getInputStreamSample252() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample252() {
    
    String x = retNullSample252();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample252() throws IOException {
BufferedInputStream i = getInputStreamSample252();
...
public void test_finalizeSample252() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample252() {
System.gc();
}

public void test_direct_management_of_connectionsSample252() {
try {
...
public native void testJNISample252();

public boolean equals(Sample252 obj) { /* BUG */
return true;
}
...
public void test_arraySample252() {
...
public void testRule2Sample252() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample252(Collection<Object> c) {
...
Sample252 other = (Sample252) o;
return (other.name.equals(""));
}

public void process_controlSample252() {
...
public int test_return_finallySample252(File file) {
try {
file.delete();
...
public void assignSample252() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample252() {
...
public void missing_defaultSample252(int x) {
switch (x) {
case 0:
...
public List<String> getASample252() {
return a;
}

public void weakSample252() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
