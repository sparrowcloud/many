...
public class Sample073 extends HttpServlet {
...
String retNullSample073() {
    return null;
}

public BufferedInputStream getInputStreamSample073() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample073() {
    
    String x = retNullSample073();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample073() throws IOException {
BufferedInputStream i = getInputStreamSample073();
...
public void test_finalizeSample073() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample073() {
System.gc();
}

public void test_direct_management_of_connectionsSample073() {
try {
...
public native void testJNISample073();

public boolean equals(Sample073 obj) { /* BUG */
return true;
}
...
public void test_arraySample073() {
...
public void testRule2Sample073() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample073(Collection<Object> c) {
...
Sample073 other = (Sample073) o;
return (other.name.equals(""));
}

public void process_controlSample073() {
...
public int test_return_finallySample073(File file) {
try {
file.delete();
...
public void assignSample073() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample073() {
...
public void missing_defaultSample073(int x) {
switch (x) {
case 0:
...
public List<String> getASample073() {
return a;
}

public void weakSample073() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
