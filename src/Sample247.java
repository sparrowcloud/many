...
public class Sample247 extends HttpServlet {
...
String retNullSample247() {
    return null;
}

public BufferedInputStream getInputStreamSample247() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample247() {
    
    String x = retNullSample247();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample247() throws IOException {
BufferedInputStream i = getInputStreamSample247();
...
public void test_finalizeSample247() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample247() {
System.gc();
}

public void test_direct_management_of_connectionsSample247() {
try {
...
public native void testJNISample247();

public boolean equals(Sample247 obj) { /* BUG */
return true;
}
...
public void test_arraySample247() {
...
public void testRule2Sample247() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample247(Collection<Object> c) {
...
Sample247 other = (Sample247) o;
return (other.name.equals(""));
}

public void process_controlSample247() {
...
public int test_return_finallySample247(File file) {
try {
file.delete();
...
public void assignSample247() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample247() {
...
public void missing_defaultSample247(int x) {
switch (x) {
case 0:
...
public List<String> getASample247() {
return a;
}

public void weakSample247() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
