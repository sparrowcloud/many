...
public class Sample159 extends HttpServlet {
...
String retNullSample159() {
    return null;
}

public BufferedInputStream getInputStreamSample159() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample159() {
    
    String x = retNullSample159();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample159() throws IOException {
BufferedInputStream i = getInputStreamSample159();
...
public void test_finalizeSample159() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample159() {
System.gc();
}

public void test_direct_management_of_connectionsSample159() {
try {
...
public native void testJNISample159();

public boolean equals(Sample159 obj) { /* BUG */
return true;
}
...
public void test_arraySample159() {
...
public void testRule2Sample159() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample159(Collection<Object> c) {
...
Sample159 other = (Sample159) o;
return (other.name.equals(""));
}

public void process_controlSample159() {
...
public int test_return_finallySample159(File file) {
try {
file.delete();
...
public void assignSample159() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample159() {
...
public void missing_defaultSample159(int x) {
switch (x) {
case 0:
...
public List<String> getASample159() {
return a;
}

public void weakSample159() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
