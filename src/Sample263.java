...
public class Sample263 extends HttpServlet {
...
String retNullSample263() {
    return null;
}

public BufferedInputStream getInputStreamSample263() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample263() {
    
    String x = retNullSample263();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample263() throws IOException {
BufferedInputStream i = getInputStreamSample263();
...
public void test_finalizeSample263() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample263() {
System.gc();
}

public void test_direct_management_of_connectionsSample263() {
try {
...
public native void testJNISample263();

public boolean equals(Sample263 obj) { /* BUG */
return true;
}
...
public void test_arraySample263() {
...
public void testRule2Sample263() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample263(Collection<Object> c) {
...
Sample263 other = (Sample263) o;
return (other.name.equals(""));
}

public void process_controlSample263() {
...
public int test_return_finallySample263(File file) {
try {
file.delete();
...
public void assignSample263() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample263() {
...
public void missing_defaultSample263(int x) {
switch (x) {
case 0:
...
public List<String> getASample263() {
return a;
}

public void weakSample263() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
