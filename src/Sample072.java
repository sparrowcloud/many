...
public class Sample072{
    ...
    String retNullSample072() {
        return null;
    }

    public BufferedInputStream getInputStreamSample072() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample072() {

        String x = retNullSample072();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample072() throws IOException {
        BufferedInputStream i = getInputStreamSample072();
    ...
    public void test_finalizeSample072() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample072() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample072() {
        try {
    ...
    public native void testJNISample072();

    public boolean equals(Sample072 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample072() {
    ...
    public void testRule2Sample072() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample072(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample072 other = (Sample072) o;
        return (other.name.equals(""));
    }

    public void process_controlSample072() {
    ...
    public int test_return_finallySample072(File file) {
        try {
            file.delete();
    ...
    public void assignSample072() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample072() {
    ...
    public void missing_defaultSample072(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample072() {
        return a;
    }

    public void weakSample072() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
