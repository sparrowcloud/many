...
String retNullSample058() {
    return null;
}

public BufferedInputStream getInputStreamSample058() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample058() {
    
    String x = retNullSample058();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample058() throws IOException {
BufferedInputStream i = getInputStreamSample058();
...
public void test_finalizeSample058() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample058() {
System.gc();
}

public void test_direct_management_of_connectionsSample058() {
try {
...
public native void testJNISample058();

public boolean equals(Sample058 obj) { /* BUG */
return true;
}
...
public void test_arraySample058() {
...
public void testRule2Sample058() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample058(Collection<Object> c) {
...
Sample058 other = (Sample058) o;
return (other.name.equals(""));
}

public void process_controlSample058() {
...
public int test_return_finallySample058(File file) {
try {
file.delete();
...
public void assignSample058() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample058() {
...
public void missing_defaultSample058(int x) {
switch (x) {
case 0:
...
public List<String> getASample058() {
return a;
}

public void weakSample058() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
