...
public class Sample184 extends HttpServlet {
...
String retNullSample184() {
    return null;
}

public BufferedInputStream getInputStreamSample184() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample184() {
    
    String x = retNullSample184();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample184() throws IOException {
BufferedInputStream i = getInputStreamSample184();
...
public void test_finalizeSample184() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample184() {
System.gc();
}

public void test_direct_management_of_connectionsSample184() {
try {
...
public native void testJNISample184();

public boolean equals(Sample184 obj) { /* BUG */
return true;
}
...
public void test_arraySample184() {
...
public void testRule2Sample184() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample184(Collection<Object> c) {
...
Sample184 other = (Sample184) o;
return (other.name.equals(""));
}

public void process_controlSample184() {
...
public int test_return_finallySample184(File file) {
try {
file.delete();
...
public void assignSample184() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample184() {
...
public void missing_defaultSample184(int x) {
switch (x) {
case 0:
...
public List<String> getASample184() {
return a;
}

public void weakSample184() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
