...
public class Sample239 extends HttpServlet {
...
String retNullSample239() {
    return null;
}

public BufferedInputStream getInputStreamSample239() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample239() {
    
    String x = retNullSample239();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample239() throws IOException {
BufferedInputStream i = getInputStreamSample239();
...
public void test_finalizeSample239() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample239() {
System.gc();
}

public void test_direct_management_of_connectionsSample239() {
try {
...
public native void testJNISample239();

public boolean equals(Sample239 obj) { /* BUG */
return true;
}
...
public void test_arraySample239() {
...
public void testRule2Sample239() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample239(Collection<Object> c) {
...
Sample239 other = (Sample239) o;
return (other.name.equals(""));
}

public void process_controlSample239() {
...
public int test_return_finallySample239(File file) {
try {
file.delete();
...
public void assignSample239() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample239() {
...
public void missing_defaultSample239(int x) {
switch (x) {
case 0:
...
public List<String> getASample239() {
return a;
}

public void weakSample239() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
