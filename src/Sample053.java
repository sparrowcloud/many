...
public class Sample053 extends HttpServlet {
...
String retNullSample053() {
    return null;
}

public BufferedInputStream getInputStreamSample053() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample053() {
    
    String x = retNullSample053();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample053() throws IOException {
BufferedInputStream i = getInputStreamSample053();
...
public void test_finalizeSample053() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample053() {
System.gc();
}

public void test_direct_management_of_connectionsSample053() {
try {
...
public native void testJNISample053();

public boolean equals(Sample053 obj) { /* BUG */
return true;
}
...
public void test_arraySample053() {
...
public void testRule2Sample053() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample053(Collection<Object> c) {
...
Sample053 other = (Sample053) o;
return (other.name.equals(""));
}

public void process_controlSample053() {
...
public int test_return_finallySample053(File file) {
try {
file.delete();
...
public void assignSample053() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample053() {
...
public void missing_defaultSample053(int x) {
switch (x) {
case 0:
...
public List<String> getASample053() {
return a;
}

public void weakSample053() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
