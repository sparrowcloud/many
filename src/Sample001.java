...
public class Sample001{
    ...
    String retNullSample001() {
        return null;
    }

    public BufferedInputStream getInputStreamSample001() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample001() {

        String x = retNullSample001();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample001() throws IOException {
        BufferedInputStream i = getInputStreamSample001();
    ...
    public void test_finalizeSample001() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample001() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample001() {
        try {
    ...
    public native void testJNISample001();

    public boolean equals(Sample001 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample001() {
    ...
    public void testRule2Sample001() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample001(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample001 other = (Sample001) o;
        return (other.name.equals(""));
    }

    public void process_controlSample001() {
    ...
    public int test_return_finallySample001(File file) {
        try {
            file.delete();
    ...
    public void assignSample001() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample001() {
    ...
    public void missing_defaultSample001(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample001() {
        return a;
    }

    public void weakSample001() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
