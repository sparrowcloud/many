...
public class Sample043 extends HttpServlet {
...
String retNullSample043() {
    return null;
}

public BufferedInputStream getInputStreamSample043() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample043() {
    
    String x = retNullSample043();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample043() throws IOException {
BufferedInputStream i = getInputStreamSample043();
...
public void test_finalizeSample043() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample043() {
System.gc();
}

public void test_direct_management_of_connectionsSample043() {
try {
...
public native void testJNISample043();

public boolean equals(Sample043 obj) { /* BUG */
return true;
}
...
public void test_arraySample043() {
...
public void testRule2Sample043() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample043(Collection<Object> c) {
...
Sample043 other = (Sample043) o;
return (other.name.equals(""));
}

public void process_controlSample043() {
...
public int test_return_finallySample043(File file) {
try {
file.delete();
...
public void assignSample043() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample043() {
...
public void missing_defaultSample043(int x) {
switch (x) {
case 0:
...
public List<String> getASample043() {
return a;
}

public void weakSample043() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
