...
public class Sample060{
    ...
    String retNullSample060() {
        return null;
    }

    public BufferedInputStream getInputStreamSample060() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample060() {

        String x = retNullSample060();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample060() throws IOException {
        BufferedInputStream i = getInputStreamSample060();
    ...
    public void test_finalizeSample060() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample060() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample060() {
        try {
    ...
    public native void testJNISample060();

    public boolean equals(Sample060 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample060() {
    ...
    public void testRule2Sample060() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample060(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample060 other = (Sample060) o;
        return (other.name.equals(""));
    }

    public void process_controlSample060() {
    ...
    public int test_return_finallySample060(File file) {
        try {
            file.delete();
    ...
    public void assignSample060() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample060() {
    ...
    public void missing_defaultSample060(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample060() {
        return a;
    }

    public void weakSample060() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
