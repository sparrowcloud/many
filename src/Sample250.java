...
public class Sample250 extends HttpServlet {
...
String retNullSample250() {
    return null;
}

public BufferedInputStream getInputStreamSample250() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample250() {
    
    String x = retNullSample250();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample250() throws IOException {
BufferedInputStream i = getInputStreamSample250();
...
public void test_finalizeSample250() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample250() {
System.gc();
}

public void test_direct_management_of_connectionsSample250() {
try {
...
public native void testJNISample250();

public boolean equals(Sample250 obj) { /* BUG */
return true;
}
...
public void test_arraySample250() {
...
public void testRule2Sample250() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample250(Collection<Object> c) {
...
Sample250 other = (Sample250) o;
return (other.name.equals(""));
}

public void process_controlSample250() {
...
public int test_return_finallySample250(File file) {
try {
file.delete();
...
public void assignSample250() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample250() {
...
public void missing_defaultSample250(int x) {
switch (x) {
case 0:
...
public List<String> getASample250() {
return a;
}

public void weakSample250() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
