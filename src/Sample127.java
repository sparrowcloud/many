...
String retNullSample127() {
    return null;
}

public BufferedInputStream getInputStreamSample127() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample127() {
    
    String x = retNullSample127();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample127() throws IOException {
BufferedInputStream i = getInputStreamSample127();
...
public void test_finalizeSample127() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample127() {
System.gc();
}

public void test_direct_management_of_connectionsSample127() {
try {
...
public native void testJNISample127();

public boolean equals(Sample127 obj) { /* BUG */
return true;
}
...
public void test_arraySample127() {
...
public void testRule2Sample127() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample127(Collection<Object> c) {
...
Sample127 other = (Sample127) o;
return (other.name.equals(""));
}

public void process_controlSample127() {
...
public int test_return_finallySample127(File file) {
try {
file.delete();
...
public void assignSample127() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample127() {
...
public void missing_defaultSample127(int x) {
switch (x) {
case 0:
...
public List<String> getASample127() {
return a;
}

public void weakSample127() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
