...
public class Sample094 extends HttpServlet {
...
String retNullSample094() {
    return null;
}

public BufferedInputStream getInputStreamSample094() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample094() {
    
    String x = retNullSample094();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample094() throws IOException {
BufferedInputStream i = getInputStreamSample094();
...
public void test_finalizeSample094() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample094() {
System.gc();
}

public void test_direct_management_of_connectionsSample094() {
try {
...
public native void testJNISample094();

public boolean equals(Sample094 obj) { /* BUG */
return true;
}
...
public void test_arraySample094() {
...
public void testRule2Sample094() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample094(Collection<Object> c) {
...
Sample094 other = (Sample094) o;
return (other.name.equals(""));
}

public void process_controlSample094() {
...
public int test_return_finallySample094(File file) {
try {
file.delete();
...
public void assignSample094() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample094() {
...
public void missing_defaultSample094(int x) {
switch (x) {
case 0:
...
public List<String> getASample094() {
return a;
}

public void weakSample094() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
