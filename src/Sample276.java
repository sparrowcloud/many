...
public class Sample276 extends HttpServlet {
...
String retNullSample276() {
    return null;
}

public BufferedInputStream getInputStreamSample276() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample276() {
    
    String x = retNullSample276();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample276() throws IOException {
BufferedInputStream i = getInputStreamSample276();
...
public void test_finalizeSample276() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample276() {
System.gc();
}

public void test_direct_management_of_connectionsSample276() {
try {
...
public native void testJNISample276();

public boolean equals(Sample276 obj) { /* BUG */
return true;
}
...
public void test_arraySample276() {
...
public void testRule2Sample276() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample276(Collection<Object> c) {
...
Sample276 other = (Sample276) o;
return (other.name.equals(""));
}

public void process_controlSample276() {
...
public int test_return_finallySample276(File file) {
try {
file.delete();
...
public void assignSample276() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample276() {
...
public void missing_defaultSample276(int x) {
switch (x) {
case 0:
...
public List<String> getASample276() {
return a;
}

public void weakSample276() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
