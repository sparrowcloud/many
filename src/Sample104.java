...
public class Sample104 extends HttpServlet {
...
String retNullSample104() {
    return null;
}

public BufferedInputStream getInputStreamSample104() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample104() {
    
    String x = retNullSample104();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample104() throws IOException {
BufferedInputStream i = getInputStreamSample104();
...
public void test_finalizeSample104() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample104() {
System.gc();
}

public void test_direct_management_of_connectionsSample104() {
try {
...
public native void testJNISample104();

public boolean equals(Sample104 obj) { /* BUG */
return true;
}
...
public void test_arraySample104() {
...
public void testRule2Sample104() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample104(Collection<Object> c) {
...
Sample104 other = (Sample104) o;
return (other.name.equals(""));
}

public void process_controlSample104() {
...
public int test_return_finallySample104(File file) {
try {
file.delete();
...
public void assignSample104() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample104() {
...
public void missing_defaultSample104(int x) {
switch (x) {
case 0:
...
public List<String> getASample104() {
return a;
}

public void weakSample104() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
