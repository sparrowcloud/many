...
String retNullSample101() {
    return null;
}

public BufferedInputStream getInputStreamSample101() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample101() {
    
    String x = retNullSample101();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample101() throws IOException {
BufferedInputStream i = getInputStreamSample101();
...
public void test_finalizeSample101() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample101() {
System.gc();
}

public void test_direct_management_of_connectionsSample101() {
try {
...
public native void testJNISample101();

public boolean equals(Sample101 obj) { /* BUG */
return true;
}
...
public void test_arraySample101() {
...
public void testRule2Sample101() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample101(Collection<Object> c) {
...
Sample101 other = (Sample101) o;
return (other.name.equals(""));
}

public void process_controlSample101() {
...
public int test_return_finallySample101(File file) {
try {
file.delete();
...
public void assignSample101() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample101() {
...
public void missing_defaultSample101(int x) {
switch (x) {
case 0:
...
public List<String> getASample101() {
return a;
}

public void weakSample101() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
