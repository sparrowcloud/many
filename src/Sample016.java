...
String retNullSample016() {
    return null;
}

public BufferedInputStream getInputStreamSample016() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample016() {
    
    String x = retNullSample016();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample016() throws IOException {
BufferedInputStream i = getInputStreamSample016();
...
public void test_finalizeSample016() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample016() {
System.gc();
}

public void test_direct_management_of_connectionsSample016() {
try {
...
public native void testJNISample016();

public boolean equals(Sample016 obj) { /* BUG */
return true;
}
...
public void test_arraySample016() {
...
public void testRule2Sample016() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample016(Collection<Object> c) {
...
Sample016 other = (Sample016) o;
return (other.name.equals(""));
}

public void process_controlSample016() {
...
public int test_return_finallySample016(File file) {
try {
file.delete();
...
public void assignSample016() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample016() {
...
public void missing_defaultSample016(int x) {
switch (x) {
case 0:
...
public List<String> getASample016() {
return a;
}

public void weakSample016() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
