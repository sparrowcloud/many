...
public class Sample170 extends HttpServlet {
...
String retNullSample170() {
    return null;
}

public BufferedInputStream getInputStreamSample170() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample170() {
    
    String x = retNullSample170();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample170() throws IOException {
BufferedInputStream i = getInputStreamSample170();
...
public void test_finalizeSample170() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample170() {
System.gc();
}

public void test_direct_management_of_connectionsSample170() {
try {
...
public native void testJNISample170();

public boolean equals(Sample170 obj) { /* BUG */
return true;
}
...
public void test_arraySample170() {
...
public void testRule2Sample170() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample170(Collection<Object> c) {
...
Sample170 other = (Sample170) o;
return (other.name.equals(""));
}

public void process_controlSample170() {
...
public int test_return_finallySample170(File file) {
try {
file.delete();
...
public void assignSample170() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample170() {
...
public void missing_defaultSample170(int x) {
switch (x) {
case 0:
...
public List<String> getASample170() {
return a;
}

public void weakSample170() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
