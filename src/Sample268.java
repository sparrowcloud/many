...
public class Sample268 extends HttpServlet {
...
String retNullSample268() {
    return null;
}

public BufferedInputStream getInputStreamSample268() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample268() {
    
    String x = retNullSample268();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample268() throws IOException {
BufferedInputStream i = getInputStreamSample268();
...
public void test_finalizeSample268() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample268() {
System.gc();
}

public void test_direct_management_of_connectionsSample268() {
try {
...
public native void testJNISample268();

public boolean equals(Sample268 obj) { /* BUG */
return true;
}
...
public void test_arraySample268() {
...
public void testRule2Sample268() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample268(Collection<Object> c) {
...
Sample268 other = (Sample268) o;
return (other.name.equals(""));
}

public void process_controlSample268() {
...
public int test_return_finallySample268(File file) {
try {
file.delete();
...
public void assignSample268() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample268() {
...
public void missing_defaultSample268(int x) {
switch (x) {
case 0:
...
public List<String> getASample268() {
return a;
}

public void weakSample268() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
