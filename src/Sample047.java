...
public class Sample047 extends HttpServlet {
...
String retNullSample047() {
    return null;
}

public BufferedInputStream getInputStreamSample047() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample047() {
    
    String x = retNullSample047();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample047() throws IOException {
BufferedInputStream i = getInputStreamSample047();
...
public void test_finalizeSample047() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample047() {
System.gc();
}

public void test_direct_management_of_connectionsSample047() {
try {
...
public native void testJNISample047();

public boolean equals(Sample047 obj) { /* BUG */
return true;
}
...
public void test_arraySample047() {
...
public void testRule2Sample047() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample047(Collection<Object> c) {
...
Sample047 other = (Sample047) o;
return (other.name.equals(""));
}

public void process_controlSample047() {
...
public int test_return_finallySample047(File file) {
try {
file.delete();
...
public void assignSample047() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample047() {
...
public void missing_defaultSample047(int x) {
switch (x) {
case 0:
...
public List<String> getASample047() {
return a;
}

public void weakSample047() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
