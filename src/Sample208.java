...
public class Sample208 extends HttpServlet {
...
String retNullSample208() {
    return null;
}

public BufferedInputStream getInputStreamSample208() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample208() {
    
    String x = retNullSample208();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample208() throws IOException {
BufferedInputStream i = getInputStreamSample208();
...
public void test_finalizeSample208() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample208() {
System.gc();
}

public void test_direct_management_of_connectionsSample208() {
try {
...
public native void testJNISample208();

public boolean equals(Sample208 obj) { /* BUG */
return true;
}
...
public void test_arraySample208() {
...
public void testRule2Sample208() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample208(Collection<Object> c) {
...
Sample208 other = (Sample208) o;
return (other.name.equals(""));
}

public void process_controlSample208() {
...
public int test_return_finallySample208(File file) {
try {
file.delete();
...
public void assignSample208() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample208() {
...
public void missing_defaultSample208(int x) {
switch (x) {
case 0:
...
public List<String> getASample208() {
return a;
}

public void weakSample208() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
