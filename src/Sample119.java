...
public class Sample119 extends HttpServlet {
...
String retNullSample119() {
    return null;
}

public BufferedInputStream getInputStreamSample119() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample119() {
    
    String x = retNullSample119();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample119() throws IOException {
BufferedInputStream i = getInputStreamSample119();
...
public void test_finalizeSample119() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample119() {
System.gc();
}

public void test_direct_management_of_connectionsSample119() {
try {
...
public native void testJNISample119();

public boolean equals(Sample119 obj) { /* BUG */
return true;
}
...
public void test_arraySample119() {
...
public void testRule2Sample119() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample119(Collection<Object> c) {
...
Sample119 other = (Sample119) o;
return (other.name.equals(""));
}

public void process_controlSample119() {
...
public int test_return_finallySample119(File file) {
try {
file.delete();
...
public void assignSample119() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample119() {
...
public void missing_defaultSample119(int x) {
switch (x) {
case 0:
...
public List<String> getASample119() {
return a;
}

public void weakSample119() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
