...
public class Sample147 extends HttpServlet {
...
String retNullSample147() {
    return null;
}

public BufferedInputStream getInputStreamSample147() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample147() {
    
    String x = retNullSample147();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample147() throws IOException {
BufferedInputStream i = getInputStreamSample147();
...
public void test_finalizeSample147() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample147() {
System.gc();
}

public void test_direct_management_of_connectionsSample147() {
try {
...
public native void testJNISample147();

public boolean equals(Sample147 obj) { /* BUG */
return true;
}
...
public void test_arraySample147() {
...
public void testRule2Sample147() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample147(Collection<Object> c) {
...
Sample147 other = (Sample147) o;
return (other.name.equals(""));
}

public void process_controlSample147() {
...
public int test_return_finallySample147(File file) {
try {
file.delete();
...
public void assignSample147() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample147() {
...
public void missing_defaultSample147(int x) {
switch (x) {
case 0:
...
public List<String> getASample147() {
return a;
}

public void weakSample147() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
