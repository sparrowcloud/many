...
public class Sample211 extends HttpServlet {
...
String retNullSample211() {
    return null;
}

public BufferedInputStream getInputStreamSample211() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample211() {
    
    String x = retNullSample211();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample211() throws IOException {
BufferedInputStream i = getInputStreamSample211();
...
public void test_finalizeSample211() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample211() {
System.gc();
}

public void test_direct_management_of_connectionsSample211() {
try {
...
public native void testJNISample211();

public boolean equals(Sample211 obj) { /* BUG */
return true;
}
...
public void test_arraySample211() {
...
public void testRule2Sample211() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample211(Collection<Object> c) {
...
Sample211 other = (Sample211) o;
return (other.name.equals(""));
}

public void process_controlSample211() {
...
public int test_return_finallySample211(File file) {
try {
file.delete();
...
public void assignSample211() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample211() {
...
public void missing_defaultSample211(int x) {
switch (x) {
case 0:
...
public List<String> getASample211() {
return a;
}

public void weakSample211() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
