...
public class Sample199 extends HttpServlet {
...
String retNullSample199() {
    return null;
}

public BufferedInputStream getInputStreamSample199() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample199() {
    
    String x = retNullSample199();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample199() throws IOException {
BufferedInputStream i = getInputStreamSample199();
...
public void test_finalizeSample199() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample199() {
System.gc();
}

public void test_direct_management_of_connectionsSample199() {
try {
...
public native void testJNISample199();

public boolean equals(Sample199 obj) { /* BUG */
return true;
}
...
public void test_arraySample199() {
...
public void testRule2Sample199() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample199(Collection<Object> c) {
...
Sample199 other = (Sample199) o;
return (other.name.equals(""));
}

public void process_controlSample199() {
...
public int test_return_finallySample199(File file) {
try {
file.delete();
...
public void assignSample199() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample199() {
...
public void missing_defaultSample199(int x) {
switch (x) {
case 0:
...
public List<String> getASample199() {
return a;
}

public void weakSample199() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
