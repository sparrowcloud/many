...
public class Sample144 extends HttpServlet {
...
String retNullSample144() {
    return null;
}

public BufferedInputStream getInputStreamSample144() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample144() {
    
    String x = retNullSample144();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample144() throws IOException {
BufferedInputStream i = getInputStreamSample144();
...
public void test_finalizeSample144() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample144() {
System.gc();
}

public void test_direct_management_of_connectionsSample144() {
try {
...
public native void testJNISample144();

public boolean equals(Sample144 obj) { /* BUG */
return true;
}
...
public void test_arraySample144() {
...
public void testRule2Sample144() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample144(Collection<Object> c) {
...
Sample144 other = (Sample144) o;
return (other.name.equals(""));
}

public void process_controlSample144() {
...
public int test_return_finallySample144(File file) {
try {
file.delete();
...
public void assignSample144() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample144() {
...
public void missing_defaultSample144(int x) {
switch (x) {
case 0:
...
public List<String> getASample144() {
return a;
}

public void weakSample144() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
