...
public class Sample076 extends HttpServlet {
...
String retNullSample076() {
    return null;
}

public BufferedInputStream getInputStreamSample076() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample076() {
    
    String x = retNullSample076();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample076() throws IOException {
BufferedInputStream i = getInputStreamSample076();
...
public void test_finalizeSample076() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample076() {
System.gc();
}

public void test_direct_management_of_connectionsSample076() {
try {
...
public native void testJNISample076();

public boolean equals(Sample076 obj) { /* BUG */
return true;
}
...
public void test_arraySample076() {
...
public void testRule2Sample076() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample076(Collection<Object> c) {
...
Sample076 other = (Sample076) o;
return (other.name.equals(""));
}

public void process_controlSample076() {
...
public int test_return_finallySample076(File file) {
try {
file.delete();
...
public void assignSample076() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample076() {
...
public void missing_defaultSample076(int x) {
switch (x) {
case 0:
...
public List<String> getASample076() {
return a;
}

public void weakSample076() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
