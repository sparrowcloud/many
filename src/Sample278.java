...
public class Sample278 extends HttpServlet {
...
String retNullSample278() {
    return null;
}

public BufferedInputStream getInputStreamSample278() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample278() {
    
    String x = retNullSample278();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample278() throws IOException {
BufferedInputStream i = getInputStreamSample278();
...
public void test_finalizeSample278() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample278() {
System.gc();
}

public void test_direct_management_of_connectionsSample278() {
try {
...
public native void testJNISample278();

public boolean equals(Sample278 obj) { /* BUG */
return true;
}
...
public void test_arraySample278() {
...
public void testRule2Sample278() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample278(Collection<Object> c) {
...
Sample278 other = (Sample278) o;
return (other.name.equals(""));
}

public void process_controlSample278() {
...
public int test_return_finallySample278(File file) {
try {
file.delete();
...
public void assignSample278() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample278() {
...
public void missing_defaultSample278(int x) {
switch (x) {
case 0:
...
public List<String> getASample278() {
return a;
}

public void weakSample278() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
