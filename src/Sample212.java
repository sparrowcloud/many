...
public class Sample212 extends HttpServlet {
...
String retNullSample212() {
    return null;
}

public BufferedInputStream getInputStreamSample212() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample212() {
    
    String x = retNullSample212();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample212() throws IOException {
BufferedInputStream i = getInputStreamSample212();
...
public void test_finalizeSample212() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample212() {
System.gc();
}

public void test_direct_management_of_connectionsSample212() {
try {
...
public native void testJNISample212();

public boolean equals(Sample212 obj) { /* BUG */
return true;
}
...
public void test_arraySample212() {
...
public void testRule2Sample212() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample212(Collection<Object> c) {
...
Sample212 other = (Sample212) o;
return (other.name.equals(""));
}

public void process_controlSample212() {
...
public int test_return_finallySample212(File file) {
try {
file.delete();
...
public void assignSample212() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample212() {
...
public void missing_defaultSample212(int x) {
switch (x) {
case 0:
...
public List<String> getASample212() {
return a;
}

public void weakSample212() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
