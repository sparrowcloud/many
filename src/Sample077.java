...
public class Sample077{
    ...
    String retNullSample077() {
        return null;
    }

    public BufferedInputStream getInputStreamSample077() {
        String pass = null;
        int x = 10;
        int i = 0;
    ...
    void nullDeSample077() {

        String x = retNullSample077();
        String y = "zxcv";
        String z = "z";
    ...
    public void test_resource_leakSample077() throws IOException {
        BufferedInputStream i = getInputStreamSample077();
    ...
    public void test_finalizeSample077() throws Throwable {
        try {
            finalize(); /* BUG */
        } catch (Exception e) {
    ...
    public void test_gcSample077() {
        System.gc();
    }

    public void test_direct_management_of_connectionsSample077() {
        try {
    ...
    public native void testJNISample077();

    public boolean equals(Sample077 obj) { /* BUG */
        return true;
    }
    ...
    public void test_arraySample077() {
    ...
    public void testRule2Sample077() {
        int[] arr = { 1, 2, 3 };
        int[] brr = { 4, 5, 6 };
    ...
    public void bad_nextSample077(Collection<Object> c) {
    ...
    public boolean equals(Object o) { /* BUG */
        Sample077 other = (Sample077) o;
        return (other.name.equals(""));
    }

    public void process_controlSample077() {
    ...
    public int test_return_finallySample077(File file) {
        try {
            file.delete();
    ...
    public void assignSample077() {
        if (x == null) {
            x = "not null";
        }
    }

    public void messedloopSample077() {
    ...
    public void missing_defaultSample077(int x) {
        switch (x) {
        case 0:
    ...
    public List<String> getASample077() {
        return a;
    }

    public void weakSample077() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
        // algorithm (DES).
