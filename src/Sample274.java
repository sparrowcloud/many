...
public class Sample274 extends HttpServlet {
...
String retNullSample274() {
    return null;
}

public BufferedInputStream getInputStreamSample274() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample274() {
    
    String x = retNullSample274();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample274() throws IOException {
BufferedInputStream i = getInputStreamSample274();
...
public void test_finalizeSample274() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample274() {
System.gc();
}

public void test_direct_management_of_connectionsSample274() {
try {
...
public native void testJNISample274();

public boolean equals(Sample274 obj) { /* BUG */
return true;
}
...
public void test_arraySample274() {
...
public void testRule2Sample274() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample274(Collection<Object> c) {
...
Sample274 other = (Sample274) o;
return (other.name.equals(""));
}

public void process_controlSample274() {
...
public int test_return_finallySample274(File file) {
try {
file.delete();
...
public void assignSample274() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample274() {
...
public void missing_defaultSample274(int x) {
switch (x) {
case 0:
...
public List<String> getASample274() {
return a;
}

public void weakSample274() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
