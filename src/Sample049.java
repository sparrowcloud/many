...
public class Sample049 extends HttpServlet {
...
String retNullSample049() {
    return null;
}

public BufferedInputStream getInputStreamSample049() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample049() {
    
    String x = retNullSample049();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample049() throws IOException {
BufferedInputStream i = getInputStreamSample049();
...
public void test_finalizeSample049() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample049() {
System.gc();
}

public void test_direct_management_of_connectionsSample049() {
try {
...
public native void testJNISample049();

public boolean equals(Sample049 obj) { /* BUG */
return true;
}
...
public void test_arraySample049() {
...
public void testRule2Sample049() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample049(Collection<Object> c) {
...
Sample049 other = (Sample049) o;
return (other.name.equals(""));
}

public void process_controlSample049() {
...
public int test_return_finallySample049(File file) {
try {
file.delete();
...
public void assignSample049() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample049() {
...
public void missing_defaultSample049(int x) {
switch (x) {
case 0:
...
public List<String> getASample049() {
return a;
}

public void weakSample049() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
