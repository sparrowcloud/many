...
public class Sample235 extends HttpServlet {
...
String retNullSample235() {
    return null;
}

public BufferedInputStream getInputStreamSample235() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample235() {
    
    String x = retNullSample235();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample235() throws IOException {
BufferedInputStream i = getInputStreamSample235();
...
public void test_finalizeSample235() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample235() {
System.gc();
}

public void test_direct_management_of_connectionsSample235() {
try {
...
public native void testJNISample235();

public boolean equals(Sample235 obj) { /* BUG */
return true;
}
...
public void test_arraySample235() {
...
public void testRule2Sample235() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample235(Collection<Object> c) {
...
Sample235 other = (Sample235) o;
return (other.name.equals(""));
}

public void process_controlSample235() {
...
public int test_return_finallySample235(File file) {
try {
file.delete();
...
public void assignSample235() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample235() {
...
public void missing_defaultSample235(int x) {
switch (x) {
case 0:
...
public List<String> getASample235() {
return a;
}

public void weakSample235() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
