...
public class Sample109 extends HttpServlet {
...
String retNullSample109() {
    return null;
}

public BufferedInputStream getInputStreamSample109() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample109() {
    
    String x = retNullSample109();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample109() throws IOException {
BufferedInputStream i = getInputStreamSample109();
...
public void test_finalizeSample109() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample109() {
System.gc();
}

public void test_direct_management_of_connectionsSample109() {
try {
...
public native void testJNISample109();

public boolean equals(Sample109 obj) { /* BUG */
return true;
}
...
public void test_arraySample109() {
...
public void testRule2Sample109() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample109(Collection<Object> c) {
...
Sample109 other = (Sample109) o;
return (other.name.equals(""));
}

public void process_controlSample109() {
...
public int test_return_finallySample109(File file) {
try {
file.delete();
...
public void assignSample109() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample109() {
...
public void missing_defaultSample109(int x) {
switch (x) {
case 0:
...
public List<String> getASample109() {
return a;
}

public void weakSample109() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
