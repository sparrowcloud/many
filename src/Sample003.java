...
String retNullSample003() {
    return null;
}

public BufferedInputStream getInputStreamSample003() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample003() {
    
    String x = retNullSample003();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample003() throws IOException {
BufferedInputStream i = getInputStreamSample003();
...
public void test_finalizeSample003() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample003() {
System.gc();
}

public void test_direct_management_of_connectionsSample003() {
try {
...
public native void testJNISample003();

public boolean equals(Sample003 obj) { /* BUG */
return true;
}
...
public void test_arraySample003() {
...
public void testRule2Sample003() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample003(Collection<Object> c) {
...
Sample003 other = (Sample003) o;
return (other.name.equals(""));
}

public void process_controlSample003() {
...
public int test_return_finallySample003(File file) {
try {
file.delete();
...
public void assignSample003() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample003() {
...
public void missing_defaultSample003(int x) {
switch (x) {
case 0:
...
public List<String> getASample003() {
return a;
}

public void weakSample003() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
