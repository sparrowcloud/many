...
String retNullSample015() {
    return null;
}

public BufferedInputStream getInputStreamSample015() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample015() {
    
    String x = retNullSample015();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample015() throws IOException {
BufferedInputStream i = getInputStreamSample015();
...
public void test_finalizeSample015() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample015() {
System.gc();
}

public void test_direct_management_of_connectionsSample015() {
try {
...
public native void testJNISample015();

public boolean equals(Sample015 obj) { /* BUG */
return true;
}
...
public void test_arraySample015() {
...
public void testRule2Sample015() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample015(Collection<Object> c) {
...
Sample015 other = (Sample015) o;
return (other.name.equals(""));
}

public void process_controlSample015() {
...
public int test_return_finallySample015(File file) {
try {
file.delete();
...
public void assignSample015() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample015() {
...
public void missing_defaultSample015(int x) {
switch (x) {
case 0:
...
public List<String> getASample015() {
return a;
}

public void weakSample015() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
