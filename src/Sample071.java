...
String retNullSample071() {
    return null;
}

public BufferedInputStream getInputStreamSample071() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample071() {
    
    String x = retNullSample071();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample071() throws IOException {
BufferedInputStream i = getInputStreamSample071();
...
public void test_finalizeSample071() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample071() {
System.gc();
}

public void test_direct_management_of_connectionsSample071() {
try {
...
public native void testJNISample071();

public boolean equals(Sample071 obj) { /* BUG */
return true;
}
...
public void test_arraySample071() {
...
public void testRule2Sample071() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample071(Collection<Object> c) {
...
Sample071 other = (Sample071) o;
return (other.name.equals(""));
}

public void process_controlSample071() {
...
public int test_return_finallySample071(File file) {
try {
file.delete();
...
public void assignSample071() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample071() {
...
public void missing_defaultSample071(int x) {
switch (x) {
case 0:
...
public List<String> getASample071() {
return a;
}

public void weakSample071() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
