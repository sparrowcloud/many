...
public class Sample180 extends HttpServlet {
...
String retNullSample180() {
    return null;
}

public BufferedInputStream getInputStreamSample180() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample180() {
    
    String x = retNullSample180();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample180() throws IOException {
BufferedInputStream i = getInputStreamSample180();
...
public void test_finalizeSample180() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample180() {
System.gc();
}

public void test_direct_management_of_connectionsSample180() {
try {
...
public native void testJNISample180();

public boolean equals(Sample180 obj) { /* BUG */
return true;
}
...
public void test_arraySample180() {
...
public void testRule2Sample180() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample180(Collection<Object> c) {
...
Sample180 other = (Sample180) o;
return (other.name.equals(""));
}

public void process_controlSample180() {
...
public int test_return_finallySample180(File file) {
try {
file.delete();
...
public void assignSample180() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample180() {
...
public void missing_defaultSample180(int x) {
switch (x) {
case 0:
...
public List<String> getASample180() {
return a;
}

public void weakSample180() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
