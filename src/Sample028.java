...
String retNullSample028() {
    return null;
}

public BufferedInputStream getInputStreamSample028() {
    String pass = null;
    int x = 10;
    int i = 0;
...
void nullDeSample028() {
    
    String x = retNullSample028();
    String y = "zxcv";
    String z = "z";
...
public void test_resource_leakSample028() throws IOException {
BufferedInputStream i = getInputStreamSample028();
...
public void test_finalizeSample028() throws Throwable {
try {
finalize(); /* BUG */
} catch (Exception e) {
...
public void test_gcSample028() {
System.gc();
}

public void test_direct_management_of_connectionsSample028() {
try {
...
public native void testJNISample028();

public boolean equals(Sample028 obj) { /* BUG */
return true;
}
...
public void test_arraySample028() {
...
public void testRule2Sample028() {
int[] arr = { 1, 2, 3 };
int[] brr = { 4, 5, 6 };
...
public void bad_nextSample028(Collection<Object> c) {
...
Sample028 other = (Sample028) o;
return (other.name.equals(""));
}

public void process_controlSample028() {
...
public int test_return_finallySample028(File file) {
try {
file.delete();
...
public void assignSample028() {
if (x == null) {
x = "not null";
}
}

public void messedloopSample028() {
...
public void missing_defaultSample028(int x) {
switch (x) {
case 0:
...
public List<String> getASample028() {
return a;
}

public void weakSample028() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException {
            // algorithm (DES).
